<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierMaster.aspx.cs" Inherits="SMEPayroll.Inventory.SupplierMaster" %>
...
<body style="margin-left: auto">
    <form id="form1" runat="server">
        ...
        <div>
                        ...
                        <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                            ...
                            <MasterTableView DataSourceID="SqlDataSource1"   DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <radG:GridBoundColumn ShowFilterIcon="False"  AllowFiltering=true AutoPostBackOnFilter="true" EditFormColumnIndex="0" DataField="SUPPLIERNAME" HeaderText="SUPPLIERNAME"
                                        SortExpression="SUPPLIERNAME" UniqueName="SUPPLIERNAME" Display="True"
                                       DataType="System.String" >
                                    </radG:GridBoundColumn>
                                  
                                    <radG:GridBoundColumn ShowFilterIcon="False"  AllowFiltering=true AutoPostBackOnFilter="true" CurrentFilterFunction="contains" EditFormColumnIndex="2" DataField="SUPPLIERADDRESS" HeaderText="SUPPLIERADDRESS"
                                        SortExpression="SUPPLIERADDRESS" UniqueName="SUPPLIERADDRESS"  Display="True"
                                       DataType="System.String" >
                                    </radG:GridBoundColumn>
                                  
                                    <radG:GridBoundColumn ShowFilterIcon="False"  AllowFiltering=true AutoPostBackOnFilter="true" EditFormColumnIndex="0" DataField="SupAuthPersonName" HeaderText="SupAuthPersonName"
                                        SortExpression="SupAuthPersonName" UniqueName="SupAuthPersonName"  Display="True"
                                       DataType="System.String" >
                                    </radG:GridBoundColumn>
                                  
                                    <radG:GridBoundColumn ShowFilterIcon="False"  AllowFiltering=true AutoPostBackOnFilter="true" EditFormColumnIndex="2" DataField="SupAuthPersonPhone" HeaderText="SupAuthPersonPhone"
                                        SortExpression="SupAuthPersonPhone"  UniqueName="SupAuthPersonPhone"  Display="True"
                                       DataType="System.String" >
                                    </radG:GridBoundColumn>
            ...
            <center>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommandType="StoredProcedure" InsertCommand="Sp_InsertSupplierMaster"
                    SelectCommand="Sp_GetSupplierMaster" SelectCommandType="StoredProcedure" 
                    UpdateCommand="Sp_UpdateSupplierMaster" UpdateCommandType="StoredProcedure">
                    <SelectParameters>
                    ...
                    <UpdateParameters>
                        ...
                        <asp:Parameter Name="SupAuthPersonName" Type="String" />
                        <asp:Parameter Name="SupAuthPersonPhone" Type="String" />
                        <asp:SessionParameter Name="CompId" SessionField="Compid" Type="Int32" />
                    </UpdateParameters>
                    <InsertParameters>
                        <asp:Parameter Name="SupplierName" Type="String" />
