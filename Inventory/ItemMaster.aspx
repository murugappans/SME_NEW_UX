<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ItemMaster.aspx.cs" Inherits="SMEPayroll.Inventory.ItemMaster" %>
        ...
        <div>
                ...
                <tr>
                    <td colspan="2" valign="top" align="left">
                        <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                            ...
                            OnItemCommand="RadGrid1_ItemCommand" ClientSettings-AllowDragToGroup="FALSE"
                            ...
                            <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="id">
                                ...
                                <Columns>
                                    ...
                                    <radG:GridBoundColumn ShowFilterIcon="False" CurrentFilterFunction="contains" Display="False"
                                        ReadOnly="True" DataField="id" DataType="System.Int32" UniqueName="id" Visible="true"
                                        SortExpression="id" HeaderText="Id">
                                    </radG:GridBoundColumn>
                                    <radG:GridBoundColumn ShowFilterIcon="False" CurrentFilterFunction="contains" Display="False"
                                        ReadOnly="True" DataField="ItemCategoryId" DataType="System.String" UniqueName="ItemCategoryId"
                                        Visible="true" SortExpression="Item CategoryId" HeaderText="Item Category">
                                    </radG:GridBoundColumn>
                                    <radG:GridBoundColumn ShowFilterIcon="False" AllowFiltering="true" AutoPostBackOnFilter="true"
                                        CurrentFilterFunction="contains" DataField="ItemCatName" HeaderText="Item categoryName"
                                        SortExpression="Item CatName" UniqueName="ItemCatName" Display="True" Visible="True"
                                        DataType="System.String">
                                    </radG:GridBoundColumn>
                                    <radG:GridBoundColumn ShowFilterIcon="False" AllowFiltering="true" AutoPostBackOnFilter="true"
                                        EditFormColumnIndex="0" DataField="ItemDesc" HeaderText="ItemDescription" SortExpression="ItemDesc"
                                        UniqueName="ItemDesc" Display="True" DataType="System.String">
                                    </radG:GridBoundColumn>
            ...
            <center>
                <asp:XmlDataSource ID="xmldtRelation" runat="server" DataFile="~/XML/xmldata.xml"
                    XPath="SMEPayroll/UOM/Unit"></asp:XmlDataSource>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="Sp_InsertItemCategoryMaster"
                    InsertCommandType="StoredProcedure" SelectCommand="Sp_GetItemMaster" SelectCommandType="StoredProcedure"
                    UpdateCommand="Sp_UpdateItemCategoryMaster" UpdateCommandType="StoredProcedure">
                    <SelectParameters>
                        <asp:SessionParameter Name="CompId" SessionField="Compid" Type="Int32" />
                    </SelectParameters>
                    <UpdateParameters>
                        <asp:Parameter Name="id" Type="Int32" />
                        <asp:Parameter Name="ItemCatName" Type="String" />
