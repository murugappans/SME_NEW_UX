<%@ Page Language="C#" AutoEventWireup="true" Codebehind="variables.aspx.cs" Inherits="SMEPayroll.Invoice.variables" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Manage Variables </b></font>
                            </td>
                        </tr>
        ...
        <div class="exampleWrapper">
            ...
            <table cellpadding="1" class="tbl" cellspacing="0" bgcolor="<% =sBorderColor %>"
                ...
                <tr>
                    <td>
                        <radG:RadGrid ID="RadGrid1" OnDeleteCommand="RadGrid1_DeleteCommand" runat="server"
                            ...
                            GridLines="None" Skin="Outlook" Width="100%" OnItemInserted="RadGrid1_ItemInserted"
                            OnItemUpdated="RadGrid1_ItemUpdated">
                            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Bottom" DataKeyNames="Vid"
                                ...
                                <Columns>
                                    ...
                                    <radG:GridBoundColumn DataField="Vid" DataType="System.Int32" HeaderText="ID" Visible="false"
                                        ReadOnly="True" SortExpression="id" UniqueName="id">
                                        <ItemStyle Width="100px" />
                                    </radG:GridBoundColumn>
                                    <radG:GridBoundColumn DataField="VarName" HeaderText="Variable Name" SortExpression="VarName"
                                        UniqueName="VarName">
                                    </radG:GridBoundColumn>
                                    <radG:GridDropDownColumn DataField="VariableId" EditFormColumnIndex="0" DataSourceID="SqlDataSource_VarPref" HeaderStyle-HorizontalAlign="center"
                                                HeaderText="Type" ListTextField="Type" ListValueField="VarId" UniqueName="DropCol" ItemStyle-HorizontalAlign="center">
                                    </radG:GridDropDownColumn>
                                    
                                    
                                     <radG:GridTemplateColumn HeaderText="Daily/One-Time" UniqueName="DailyOneTime" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center" >  
                                         <ItemTemplate>  
                                            <%#Eval("DailyOneTime")%>  
                                        </ItemTemplate>   
                                        <EditItemTemplate>  
                                            <radG:RadComboBox ID="RadComboBox1" AppendDataBoundItems="true" Height="200px" runat="server"  
                                                DataTextField="DailyOneTime" DataValueField="DailyOneTime"   
                                                SelectedValue='<%# Bind("DailyOneTime")%>'>   
                                                <Items>  
                                                    <radG:RadComboBoxItem Text="Daily" Value="Daily" /> 
                                                    <radG:RadComboBoxItem Text="Monthly" Value="OneTime" />  
                                                </Items>  
                                            </radG:RadComboBox>  
                                        </EditItemTemplate>  
                                ...
                                <CommandItemSettings AddNewRecordText="Add New Variable" />
                            </MasterTableView>
