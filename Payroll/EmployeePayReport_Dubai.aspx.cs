...
{
    public partial class EmployeePayReport_Dubai : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                lblGrossPay.Text = Utility.ToDouble(dr["GrossWithAddition"].ToString()).ToString("#0.00");
                double cpgross = 0.00;
                if (Request.QueryString["CPF1"] != "")
                {
                    cpgross = Convert.ToDouble(Request.QueryString["CPF1"]);
                }
                lblGrosspayCPF.Text = cpgross.ToString();
