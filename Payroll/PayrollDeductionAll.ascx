<%@ Control Language="C#" AutoEventWireup="true" Codebehind="PayrollDeductionAll.ascx.cs"
    Inherits="SMEPayroll.Management.PayrollDeductionAll" %>
...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td style="height: 32px; text-align: right">
            <tt class="bodytxt">*Deductions for Year:&nbsp;</tt></td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None"
        ErrorMessage="Deductions  Required!" InitialValue="Select" ControlToValidate="drpAdditionYear"></asp:RequiredFieldValidator>
