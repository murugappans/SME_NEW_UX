<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emp_BulkAdd.aspx.cs" Inherits="SMEPayroll.Payroll.Emp_BulkAdd2" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Multi Addition</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
...
//                }
                            ...
                            <div class="search-box clearfix padding-tb-10">
                                                <div class="col-md-12 form-inline">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Multi Addition</label>
                                                        <asp:DropDownList ID="Drpclear" CssClass="textfields form-control input-sm"
                                                            runat="server">
                                                            <asp:ListItem Value="None" Text="None"></asp:ListItem>
                                                            <asp:ListItem Value="clearimport" Text="Clear All Imported Records"></asp:ListItem>
                                                            <%-- <asp:ListItem Value="clearall" Text="Clear All Additions" ></asp:ListItem>--%>
                                                        </asp:DropDownList>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>&nbsp;</label>
                            ...
                            <div class="heading-box clearfix padding-tb-10">
                                    ...
                                    <table width="100%" id="TabId" runat="server" visible="false" ><tr><td>
