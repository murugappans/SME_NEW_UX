<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paydetailreport1.aspx.cs" Inherits="SMEPayroll.Payroll.paydetailreport1" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="ApprovePayroll.aspx"><span>Approve Payroll</span></a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>Paydetail Report</span>
                        </li>
                    </ul>
