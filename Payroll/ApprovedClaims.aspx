<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovedClaims.aspx.cs"
    Inherits="SMEPayroll.Payroll.ApprovedClaims" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">View Approved Claims</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                ...
                                <MasterTableView DataSourceID="SqlDataSource2" AllowAutomaticDeletes="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="ProcessDate" HeaderText="Approved Date" ReadOnly="True" SortExpression="ProcessDate"
