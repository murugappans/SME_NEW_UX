...
{
    public partial class RejectedClaimsExt : System.Web.UI.Page
    {
        ...
        private DataSet CreateDataSet()
        {
            ...
            string sqlApprovedClaims = @"SELECT " +
                ...
                " WHERE e.trx_type = a.id and e.emp_code = b.emp_code and claimstatus='Rejected' and e.emp_code=" + DropDownList1.SelectedValue + " and year(trx_period)=" + cmbYear.SelectedValue + " and upper(a.optionselection) like '%CLAIM%'";
