...
{
    public partial class payslipRemarks : System.Web.UI.Page
    {
        string compid = "";
        SqlParameter[] parms;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                RadGrid1.ExportSettings.FileName = "Payslip_Remarks";
            ...
            //    RadGrid1.DataSource = GenpayrollDetails;
            //    RadGrid1.DataBind();
            //}
            ...
            if (e.CommandName == "UpdateAll")
            {
                ...
                foreach (GridItem item in RadGrid1.MasterTableView.Items)
                {
                    ...
                    if (returnval > 0)
                    {
                            ...
                            ViewState["actionMessage"] = "Success|Payslip Remarks Entered/Updated Successfully for the selected employees.";
                    }
                    else
                    {
                        //lblerror.ForeColor = System.Drawing.Color.Red;
                        //lblerror.Text = "Select Employee Payslip Remarks Entered";
                            ViewState["actionMessage"] = "Warning|Select Employee Payslip Remarks Entered.";
        ...
        protected void binddata()
        {
            ...
            string sSQL = "SP_GetEmployeeRemarks";
