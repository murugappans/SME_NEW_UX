<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDeductionTypes.aspx.cs" Inherits="SMEPayroll.Payroll.SetupDeductionTypes" %>
...
<head id="Head1" runat="server">
    <title>Setup Deductions Types</title>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                     <ul class="page-breadcrumb">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="Emp_BulkDed.aspx">Multi Deductions</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>Setup Deduction Types</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Setup Deduction Types</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadGrid ID="gvDeduction_Types" runat="server" GridLines="Both" DataSourceID="sqlSelectDeductionType"
                                            ...
                                            <MasterTableView AllowAutomaticUpdates="True" AllowSorting="FALSE" AllowFilteringByColumn="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <radG:GridBoundColumn ReadOnly="True" DataField="desc" DataType="System.String"
                                                        UniqueName="desc" Visible="true" HeaderText="Deductions Types">
                                                    </radG:GridBoundColumn>
                                                    <telerik:GridTemplateColumn Display="true" UniqueName="Column3" DataField="Used">
                                                        <ItemTemplate>
                                                            <%--     <asp:CheckBox runat="server" ID="checkbox_select" Checked='<%#bool.Parse(Eval("Used").ToString())%>' />--%>
                            ...
                            <div class="text-center padding-tb-10">
                                <asp:Button ID="Button6" runat="server" Text="Select Deductions Types" class="textfields btn btn-sm red" 
                                            OnClick="Update_Click" />
                            </div>

                            <asp:SqlDataSource ID="sqlSelectDeductionType" runat="server"
                                SelectCommand=" SELECT ID,[desc],[used]             
                        FROM   Deductions_Types              
                        WHERE  ((Company_ID = @company_id)OR (upper(isShared)='YES' AND Company_ID!=-1 ))   and (Active=1 or Active is null)  
                        ORDER  BY [desc]   ">
                                <SelectParameters>
