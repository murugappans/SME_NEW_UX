<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ApprovedClaimsExt.aspx.cs"
    Inherits="SMEPayroll.Payroll.ApprovedClaimsExt" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>View Approved Claims</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
        ...
        <table cellpadding="1" cellspacing="0" bgcolor="<% =sBorderColor %>" width="100%"
            border="0">
              <tr>
                <td>
                        <telerik:RadGrid ID="radGridApproved" Skin="Outlook"  
                               ...
                               <MasterTableView ExpandCollapseColumn-ButtonType="ImageButton" ExpandCollapseColumn-CollapseImageUrl="../help/images/exp.gif"
                                        ExpandCollapseColumn-ExpandImageUrl="../help/images/col.gif" HierarchyDefaultExpanded="true" >
                                    <Columns> 
                                        <telerik:GridClientSelectColumn  Reorderable="False" DataTextField="ClientSelectColumn"    UniqueName="ClientSelectColumn" >
                                         ...
                                         <telerik:GridButtonColumn ButtonType="ImageButton"   ImageUrl="../Frames/Images/STATUSBAR/OK1.gif"   ></telerik:GridButtonColumn>
                                    </Columns>                                
                               </MasterTableView>                                
                        </telerik:RadGrid>
                </td>
