...
<div class="RadGrid radGrid-single">
        <table width="100%" id="Table1" class="table-style-2" Border="1" runat="server" />
</div>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#Table1 td").removeAttr("class");
            $("#Table1 td").removeAttr("style");
        });
