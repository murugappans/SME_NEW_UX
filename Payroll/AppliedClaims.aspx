<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppliedClaims.aspx.cs"
    Inherits="SMEPayroll.Payroll.AppliedClaims" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
    ...
    <div class="page-container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box padding-tb-10 clearfix">
                                <div class="form-inline col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DropDownList1" class="textfields form-control input-sm" AutoPostBack="false" runat="server"
                            ...
                            <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" runat="server" DataSourceID="SqlDataSource2" GridLines="None" AllowSorting="true"
                                Skin="Outlook" Width="99%" OnItemDataBound="RadGrid1_ItemDataBound" OnUpdateCommand="RadGrid1_UpdateCommand" OnItemCommand="RadGrid1_ItemCommand" EnableHeaderContextMenu="true">
                                <MasterTableView DataSourceID="SqlDataSource2" AllowAutomaticDeletes="True" AutoGenerateColumns="False"
                                    DataKeyNames="trx_id,emp_code,emp_name">
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="emp_name" UniqueName="emp_name" SortExpression="emp_name"
                                        ...
                                        <radG:GridBoundColumn DataField="trx_amount" UniqueName="trx_amount" SortExpression="trx_amount"
                                            HeaderText="Amount">
                                        </radG:GridBoundColumn>
                                        <radG:GridBoundColumn UniqueName="Currency" HeaderText="Currency" DataField="Currency" Display="true" AllowFiltering="false">
                                        </radG:GridBoundColumn>

                                        <radG:GridTemplateColumn HeaderText="Application Date" SortExpression="created_on" UniqueName="created_on" DataType="System.DateTime" >
                                            <ItemTemplate>
                                               
                                                <asp:Label ID="Label1" Text='<%#  (Convert.ToDateTime(DataBinder.Eval(Container,"DataItem.created_on"))).ToString("dd/MM/yyyy") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TextBox1" Text='<%# DataBinder.Eval(Container,"DataItem.created_on")%>'
                                                    runat="server"></asp:TextBox>
                                            </EditItemTemplate>
                                        </radG:GridTemplateColumn>
                                <radG:GridTemplateColumn HeaderText="Approved Date"  SortExpression="trx_period" UniqueName="trx_period" DataType="System.DateTime"   >
                                            <ItemTemplate>

                                            <asp:Label ID="lblperiod" Text='<%#  (Convert.ToDateTime(DataBinder.Eval(Container,"DataItem.trx_period"))).ToString("dd/MM/yyyy") %>'
                                                    runat="server"></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        <asp:TextBox ID="txtperiod" Text='<%# DataBinder.Eval(Container,"DataItem.trx_period")%>'
                                                    runat="server"></asp:TextBox>
                                            </EditItemTemplate>
                                        </radG:GridTemplateColumn>
                                        ...
                                        <radG:GridEditCommandColumn UpdateText="Update" EditText="Edit" CancelText="Cancel"
                                            ButtonType="ImageButton" InsertImageUrl="../frames/images/toolbar/edit.gif" HeaderText="Edit" Visible="false">
        ...
        e.[trx_id],  a.[id],a.[desc] ,e.[trx_amount],trx_period,created_on,            
convert(char(2),datepart(mm,e.[trx_period]))+'/'+convert(char(4),datepart(yy,e.[trx_period]))trx_periodold, e.[emp_code],               
b.emp_name+' '+b.emp_lname 'emp_name',(select DeptName from department where id=b.dept_id) Department,e.remarks,isnull(e.recpath,'') recpath,status,claimstatus,(select top 1  c.Currency from   Currency c where c.Id =e.CurrencyID)Currency FROM [emp_additions] e, additions_types a, employee b              
WHERE e.trx_type = a.id
and e.emp_code = b.emp_code and claimstatus is not null and claimstatus not in('Open') and e.emp_code =@emp_code  and upper(a.optionselection) like '%CLAIM%' and year(modified_on) = @year"
