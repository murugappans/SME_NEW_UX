<%@ Page Language="C#" AutoEventWireup="true" Codebehind="RejectedClaimsExt.aspx.cs"
    Inherits="SMEPayroll.Payroll.RejectedClaimsExt" %>
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Rejected Claims</b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
                               ...
                               <MasterTableView  ExpandCollapseColumn-ButtonType="ImageButton" ExpandCollapseColumn-CollapseImageUrl="../help/images/exp.gif"
                                    ...
                                    <Columns> 
                                        <telerik:GridClientSelectColumn  Reorderable="False" DataTextField="ClientSelectColumn"    UniqueName="ClientSelectColumn" >
                                         ...
                                         <telerik:GridButtonColumn ButtonType="ImageButton"   ImageUrl="../Frames/Images/STATUSBAR/alert1.gif"   ></telerik:GridButtonColumn>
                                    </Columns>                                
                               </MasterTableView>                                
                        </telerik:RadGrid>
                </td>
