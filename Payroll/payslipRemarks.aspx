            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Manage Payslip Remarks</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Payslip Remarks</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="row">
                    ...
                    <div class="padding-tb-10 text-right">
                        <asp:LinkButton ID="ImageButton2" class="btn btn-export" OnClick="btnExportExcel_click" runat="server" Visible="false">
                    ...
                    <radG:RadGrid ID="RadGrid1" AllowMultiRowEdit="True" OnItemCommand="RadGrid1_ItemCommand" AllowFilteringByColumn="true"
                        ...
                        GridLines="both" AllowMultiRowSelection="true">
                        <MasterTableView CommandItemDisplay="bottom" DataKeyNames="emp_code,Remarks"
                            ...
                            <Columns>
                                ...
                                <radG:GridBoundColumn DataField="Time_Card_No" Visible="true" ShowFilterIcon="false" FilterControlAltText="cleanstring" DataType="System.String"
                                    HeaderText="Time_Card_No" ItemStyle-HorizontalAlign="Left" SortExpression="Time_Card_No"
                                    UniqueName="Time_Card_No" AllowFiltering="true" AutoPostBackOnFilter="true">
                                </radG:GridBoundColumn>
                                <radG:GridBoundColumn DataField="EMPNAME" HeaderText="Employee Name" ShowFilterIcon="false" FilterControlAltText="alphabetsonly" SortExpression="EMPNAME"
                                    UniqueName="EMPNAME" ItemStyle-HorizontalAlign="Left" AutoPostBackOnFilter="true"
                                    CurrentFilterFunction="contains">
                                </radG:GridBoundColumn>
                                <radG:GridTemplateColumn ShowFilterIcon="false" ItemStyle-HorizontalAlign="Left" DataField="Remarks" UniqueName="Remarks"
                                    HeaderText="Employee Remarks" AllowFiltering="false">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemarks" CssClass="form-control input-sm custom-maxlength" MaxLength="250" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.remarks")%>'></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle />
                                </radG:GridTemplateColumn>
                            ...
                            <CommandItemTemplate>
                                <div style="text-align: center">
                                    <asp:Button runat="server" ID="UpdateAll" class="textfields btn red"
                                        Text="Update Payslip Remarks For Selected" CommandName="UpdateAll" />
                                </div>
                            </CommandItemTemplate>
                        </MasterTableView>
