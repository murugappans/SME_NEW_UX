    ...
    alert(response);
                            ...
                            <uc3:GridToolBar ID="GridToolBar" runat="server" Width="100%" Visible="true" />
                                    ...
                                    <radG:RadGrid ID="RadGrid1" AllowPaging="true" PageSize="100" runat="server"
                                        ...
                                        Font-Size="11"
                                        Font-Names="Tahoma"
                                        HeaderStyle-Wrap="false" ShowGroupPanel="true" ClientSettings-AllowDragToGroup="true" >
                                        <MasterTableView DataKeyNames="FullName,Emp_Code,Basic,Netpay,TotalAdditions,TotalDeductions,TotalAdditionsWONH,paidfullday,paidhalfday,unpaidfullday,unpaidhalfday,
                                            ...
                                            CPF ,EmpCPFtype ,PRAge ,CPFCeiling ,FundType , FundAmount,UnPaidLeaves,TotalUnPaid,ActualBasic,Pay_Mode,EmployeeGiro,EmployerGiro,GiroBank,FundGrossAmount,GrossWithAddition, CPFCeiling, SDLFundGrossAmount, CMOW,LYOW,CYOW,CPFAWCIL,EST_AWCIL,ACTCIL,AWCM,AWB4CM,AWCM_AWB4CM,AWSUBJCPF,time_card_no,SDF_REQUIRED, PayProcessFH,Daily_Rate,DaysWorkedRate,CPFGross1,WrkgDaysInRoll,ActWrkgDaysSpan"
                                        ...
                                        <ExportSettings ExportOnlyData="true" OpenInNewWindow="true" IgnorePaging="true" FileName="mydata">
                                            <Pdf Author ="muru" Creator ="Telerik" PaperSize ="A4"
                                                 PageTitle="Reports" Title="Reports" Keywords="sme" Subject="test subject" />
                                        </ExportSettings>
                                            ...
                                            <div id="collapse_3_1" class="panel-collapse collapse">
                                                <div class="panel-body border-top-none no-padding">
                                                    <div class="note-custom note">
                                                        Please make sure that you have settled all the leaves, additions, deductions for above listed employees.Once the payroll is approved, ALL Transactions will be locked for security reasons (For Example: Leaves,Additions,Deductions)
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        function validateformsubmit() {
            ...
            if ($("#chkDateSelection").prop('checked')==false)
                _message = "Please select Payment Date.";
