...
namespace SMEPayroll.Payroll
{
    public partial class GenPayroll : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                RadGrid1.ExportSettings.FileName = "Employee_GeneratePayroll_List";//murugan
                ...
                if (item is GridItem)
                {
                    ...
                    if (chkBox.Checked == true)
                    {
                        ...
                        try
                        {
                            ...
                            _actionMessage = "Success|Payroll has been generated!!";
                        ...
                        catch (Exception ex)
                        {
                            ...
                            _actionMessage = "Warning|Some Error Occured";//+ex.Message.ToString()
                            ViewState["actionMessage"] = _actionMessage;
                        }
                    }
