    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Unlock Payroll</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box clearfix padding-tb-10">
                                                <div class="form-inline col-sm-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Dept</label>
                                                        <asp:DropDownList CssClass="textfields form-control input-sm" OnDataBound="deptID_databound"
                                        ...
                                        <MasterTableView DataKeyNames="trx_id,emp_id,basic_pay,Additions,Deductions" TableLayout="Auto" PagerStyle-Mode="Advanced">
                                            <Columns>
                                                ...
                                                <radG:GridBoundColumn DataField="emp_id" Display="false" HeaderText="Employee Code"
                                                    SortExpression="emp_id" ReadOnly="True" UniqueName="emp_id" DataType="System.Int32" ShowFilterIcon ="false" AutoPostBackOnFilter="true" AllowFiltering="true">
                                                ...
                                                <radG:GridBoundColumn DataField="DeptName" HeaderText="Department" SortExpression="DeptName" AutoPostBackOnFilter="true"
                                                    UniqueName="DeptName" ShowFilterIcon="False" CurrentFilterFunction="contains" FilterControlAltText="cleanstring" DataType="system.String">
                                                <HeaderStyle Width="200px" />
                                                    <ItemStyle Width="200px" />
                                                </radG:GridBoundColumn>
                                            ...
                                            <td>
                                                <div class="clearfix padding-tb-10">
                                                    <div class="col-md-12 text-center">
                                                        <asp:Button ID="Button2" runat="server" Text="Unlock Payroll" class="textfields btn red" OnClick="Button2_Click" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
