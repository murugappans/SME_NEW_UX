<%@ Page Language="C#" AutoEventWireup="true" Codebehind="PayRollDeductionsAll.aspx.cs"
    Inherits="SMEPayroll.Payroll.PayRollDeductionsAll" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Deductions for All</b></font>
                            </td>
                        </tr>
        ...
        <radG:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="true" OnItemDataBound="RadGrid1_ItemDataBound"
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="trx_id" DataSourceID="SqlDataSource2"
                ...
                <EditFormSettings UserControlName="PayrollDeductionAll.ascx" EditFormType="WebUserControl">
                </EditFormSettings>
                <CommandItemSettings AddNewRecordText="Add New Deductions" />
            </MasterTableView>
        </radG:RadGrid>
