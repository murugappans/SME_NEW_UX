<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovePayroll.aspx.cs" Inherits="SMEPayroll.Payroll.ApprovePayroll" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <!-- ToolBar End -->
                             ...
                             <div class="search-box padding-tb-10 clearfix">
                                                ...
                                                <div class="col-md-3 text-right">
                                                    ...
                                                    <asp:Label ID="lblLoading" runat="server" Text="" Visible = "false"></asp:Label>
                                                </div>
                                            </div>
                                    ...
                                    <radG:RadGrid ID="RadGrid1" runat="server" Skin="Outlook" Width="100%"
                                        ...
                                        PageSize="100" OnPageIndexChanged="RadGrid1_PageIndexChanged" AllowFilteringByColumn="True" EnableHeaderContextMenu="true"
                            ...
                            NH_e,OT1_e,OT2_e,DeptName,Time_Card_No"
                                            ...
                                            <Columns>
                                                ...
                                                <radG:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" HeaderText="" HeaderStyle-Wrap="false" Display="false">
                                                    <ItemTemplate>
                                                ...
                                                <radG:GridClientSelectColumn UniqueName="GridClientSelectColumn"  HeaderStyle-Wrap="false">
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                    <ItemStyle  HorizontalAlign="Center" />
                                                </radG:GridClientSelectColumn>
                                                <radG:GridBoundColumn DataField="emp_id" Display="false" HeaderText="Employee Code"
                                                    SortExpression="emp_id" ReadOnly="True" UniqueName="emp_id" ShowFilterIcon="false">
                                                ...
                                                <radG:GridBoundColumn DataField="DeptName" HeaderText="Department" SortExpression="DeptName"
                                                    UniqueName="DeptName" ShowFilterIcon="false" ItemStyle-Wrap="false" HeaderStyle-Wrap="false" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                <HeaderStyle Width="200px"  />
                                                </radG:GridBoundColumn>
                    ...
                    <radG:GridBoundColumn AllowFiltering="false" Display="false" DataField="unpaid_leaves_amount" HeaderText="unpaid_leaves_amount"
                        SortExpression="unpaid_leaves_amount" UniqueName="unpaid_leaves_amount">
                                                ...
                                                <radG:GridBoundColumn AllowFiltering="false" DataField="basic_pay" HeaderText="Basic Pay"
                                                    SortExpression="basic_pay" UniqueName="basic_pay">
