<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apendix_A_2015.aspx.cs" Inherits="IRAS.Apendix_A_2015" %>
...
<body style="margin-left: auto">
    <form id="employeeform" runat="server" method="post">
      ...
      <%--  <div class="exampleWrapper">--%>
            <telerik:RadTabStrip ID="tbsEmp1" runat="server" SelectedIndex="0" MultiPageID="tbsEmp121"
            ...
            <telerik:RadMultiPage  SelectedIndex="0" runat="server" ID="tbsEmp12" Width="99%" Height="100%" CssClass="multiPage">
              ...
              <telerik:RadPageView runat="server" ID="tbsIR8AApendix_OLD" Height="640px">
                    <tr>
                        <telerik:telerikjaxPanel ID="telerikjaxPanel1" runat="server">
                            <table class="tbl" border="0">
                                <tr valign="top">
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="table-layout: auto; width: 100%;">
                                                            ...
                                                            <td valign="top">
                                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                                    ...
                                                                    <tr class="trstandtop">
                                                                        ...
                                                                        <td>
                                                                            <input type="text" class="textfields" id="txtNoOfDays"  readonly="true" runat="server" style="width: 110px" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="trstandtop">
                                                                        <td>
                        ...
                        </telerik:telerikjaxPanel>
                    </tr>
                    <tr>
                        <telerik:telerikjaxPanel CssClass="tbl" ID="telerikjaxPanel3" runat="server">
                            <table class="tbl" border="0">
                                <tr valign="top">
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="table-layout: auto; width: 100%;">
                    ...
                    <tr>
                        <telerik:telerikjaxPanel CssClass="tbl" ID="tbsIR8AApendixA" runat="server">
                            <table class="tbl" border="0">
                                <tr valign="top">
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="table-layout: auto; width: 100%;">
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel" Width="100%">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="telerikrid2" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            ...
                                                            <MasterTableView ShowGroupFooter="true" DataKeyNames="ID" CommandItemDisplay="none">
                                                                ...
                                                                <Columns>
                                                                    <%--  <telerik:GridTemplateColumn   HeaderStyle-Font-Bold="true" HeaderText="Add" HeaderStyle-HorizontalAlign="Center" UniqueName="Add">   
                                                                                                                              <ItemTemplate >                                        
                                                                    ...
                                                                    <telerik:GridBoundColumn DataField="Ir8AYear" DataType="System.Int32" HeaderStyle-ForeColor="black"
                                                                        HeaderText="Ir8AYear" HeaderStyle-HorizontalAlign="Center" UniqueName="Ir8AYear"
                                                                        Display="False">
                                                                    </telerik:GridBoundColumn>
                                                                    <telerik:GridBoundColumn DataField="ID" DataType="System.Int32" HeaderStyle-ForeColor="black"
                                                                        HeaderText="ID" HeaderStyle-HorizontalAlign="Center" UniqueName="ID" Display="False">
                                                                    </telerik:GridBoundColumn>
                                                                    <telerik:GridBoundColumn DataField="Item1" DataType="System.Int32" HeaderStyle-ForeColor="black"
                                                                        HeaderStyle-HorizontalAlign="Center" UniqueName="Item1" Display="False">
                                                                    </telerik:GridBoundColumn>
                                                                    <telerik:GridTemplateColumn HeaderText="Item" DataType="System.Int32" HeaderStyle-Font-Bold="true"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="NoofSunits" DataType="System.Int32" UniqueName="NoofSunits"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Rates" DataType="System.Int32" UniqueName="Rates"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Amount" DataType="System.Int32" UniqueName="Amount"
                                                                    ...
                                                                    <telerik:GridBoundColumn DataField="emp_id" DataType="System.Int32" HeaderStyle-ForeColor="black"
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel1" Width="100%">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="radHa" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            AllowSorting="true" Skin="Outlook" MasterTableView-AllowAutomaticUpdates="true"
                                                            MasterTableView-AutoGenerateColumns="false" MasterTableView-AllowAutomaticInserts="true"
                                                            MasterTableView-AllowMultiColumnSorting="true" GroupHeaderItemStyle-HorizontalAlign="left"
                                                            ClientSettings-EnableRowHoverStyle="true" ClientSettings-AllowColumnsReorder="true"
                                                            ...
                                                            <MasterTableView ShowGroupFooter="true" DataKeyNames="ID" CommandItemDisplay="none">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="NoofSunits"  UniqueName="NoofSunits"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Rates"  UniqueName="Rates"
                                                                        HeaderText="Rates" HeaderStyle-HorizontalAlign="Center" AllowFiltering="false"
                                                                        Groupable="false" HeaderStyle-ForeColor="black" HeaderStyle-Font-Bold="true">
                                                                        <itemtemplate>
                                                                                                                                <div>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="NoofDays"  UniqueName="NoofDays"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Amount"  UniqueName="Amount"
                                                                        HeaderText="Amount" HeaderStyle-HorizontalAlign="Center" AllowFiltering="false"
                                                                        Groupable="false" HeaderStyle-ForeColor="black" HeaderStyle-Font-Bold="true">
                                                                        <itemtemplate>
                                                                                                                                <div>
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel" Width="100%" runat="server">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="radSctA" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            AllowSorting="true" Skin="Outlook" MasterTableView-AllowAutomaticUpdates="true"
                                                            MasterTableView-AutoGenerateColumns="false" MasterTableView-AllowAutomaticInserts="true"
                                                            MasterTableView-AllowMultiColumnSorting="true" GroupHeaderItemStyle-HorizontalAlign="left"
                                                            ClientSettings-EnableRowHoverStyle="true" ClientSettings-AllowColumnsReorder="true"
                                                            ...
                                                            <MasterTableView ShowGroupFooter="true" DataKeyNames="ID" CommandItemDisplay="none">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ComapnyReg" UniqueName="ComapnyReg" HeaderText="Reg No(UEN)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="CompanyName" UniqueName="CompanyName" HeaderText="Company Name"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Indicate Type OfPlanGranted (ESOP)/(ESOW)" HeaderStyle-HorizontalAlign="Center"
                                                                        UniqueName="Type">
                                                                        <itemtemplate>  
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Date Of Grant" HeaderStyle-HorizontalAlign="Center"
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Date Of Exercise of ESOP" HeaderStyle-HorizontalAlign="Center"
                                                                        UniqueName="DateEsop">
                                                                        <itemtemplate>  
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Exprice" UniqueName="Exprice" HeaderText="Exercise Price Of ESOP"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="OpenMValue" UniqueName="OpenMValue" HeaderText="Open Market Value Per Share"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="OpenValueRef" UniqueName="OpenValueRef" HeaderText="Open Market Value Per Share As At Date Reflected"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="NoofShares" UniqueName="NoofShares" HeaderText="Number Of Shared Acquired"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISSME" UniqueName="ERISSME" HeaderText="*ERIS(SMEs)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISALL" UniqueName="ERISALL" HeaderText="**ERIS(All Corporations)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISSTARTUP" UniqueName="ERISSTARTUP" HeaderText="***ERIS(Start-ups)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="GrossAmtNotQua" UniqueName="GrossAmtNotQua" HeaderText="****Gross Amount Not Qualifying For"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="GrossAmtEspo" UniqueName="GrossAmtEspo" HeaderText="****Gross Amount Gain From ESOP"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridBoundColumn DataField="DateGrant" HeaderStyle-ForeColor="black" HeaderText="DateGrant"
                                                                        HeaderStyle-HorizontalAlign="Center" UniqueName="DateGrant1" Display="false">
                                                                    </telerik:GridBoundColumn>
                                                                    <telerik:GridBoundColumn DataField="DateEsop" HeaderStyle-ForeColor="black" HeaderText="DateEsop"
                                                                        HeaderStyle-HorizontalAlign="Center" UniqueName="DateEsop1" Display="false">
                                                                    </telerik:GridBoundColumn>
                                                                    <telerik:GridBoundColumn DataField="PlanType" HeaderStyle-ForeColor="black" HeaderText="PlanType1"
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel1" Width="100%" runat="server">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="radSctB" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            AllowSorting="true" Skin="Outlook" MasterTableView-AllowAutomaticUpdates="true"
                                                            MasterTableView-AutoGenerateColumns="false" MasterTableView-AllowAutomaticInserts="true"
                                                            MasterTableView-AllowMultiColumnSorting="true" GroupHeaderItemStyle-HorizontalAlign="left"
                                                            ClientSettings-EnableRowHoverStyle="true" ClientSettings-AllowColumnsReorder="true"
                                                            ...
                                                            <MasterTableView ShowGroupFooter="true" DataKeyNames="ID" CommandItemDisplay="none">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ComapnyReg" UniqueName="ComapnyReg" HeaderText="Reg No(UEN) (a)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                               
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.ComapnyReg")%>' ID="txtComapnyReg"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="CompanyName" UniqueName="CompanyName" HeaderText="Company Name (b)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Indicate Type OfPlanGranted (ESOP)/(ESOW) (c1)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Date Of Grant (c2)" HeaderStyle-HorizontalAlign="Center"
                                                                        UniqueName="DateGrant">
                                                                        <itemtemplate>  
                                                                                                                              <asp:DropDownList ID="drpDGrant" runat="server" CssClass="bodytxt" >   
                                                                                                                              </asp:DropDownList>                                        
                                                                    ...
                                                                    <telerik:GridTemplateColumn HeaderText="Date Of Exercise of ESOP (d)" HeaderStyle-HorizontalAlign="Center"
                                                                        UniqueName="DateEsop">
                                                                        <itemtemplate>  
                                                                                                                              <asp:DropDownList ID="drpDEsop" runat="server" CssClass="bodytxt" >   
                                                                                                                              </asp:DropDownList>                                        
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="Exprice" UniqueName="Exprice" HeaderText="Exercise Price Of ESOP (e)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.Exprice")%>' ID="txtExprice" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="OpenMValue" UniqueName="OpenMValue" HeaderText="Open Market Value Per Share (f)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OpenMValue")%>' ID="txtOpenMValue" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="OpenValueRef" UniqueName="OpenValueRef" HeaderText="Open Market Value Per Share As At Date Reflected (g)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OpenValueRef")%>' ID="txtOpenValueRef" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="NoofShares" UniqueName="NoofShares" HeaderText="Number Of Shared Acquired (h)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.NoofShares")%>' ID="txtNoofShares" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISSME" UniqueName="ERISSME" HeaderText="*ERIS(SMEs) (i)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.ERISSME")%>' ID="txtERISSME" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISALL" UniqueName="ERISALL" HeaderText="**ERIS(All Corporations) (j)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="ERISSTARTUP" UniqueName="ERISSTARTUP" HeaderText="***ERIS(Start-ups) (k)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="GrossAmtNotQua" UniqueName="GrossAmtNotQua" HeaderText="****Gross Amount Not Qualifying For (l)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.GrossAmtNotQua")%>' ID="txtGrossAmtNotQua" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                                                    ...
                                                                    <telerik:GridTemplateColumn DataField="GrossAmtEspo" UniqueName="GrossAmtEspo" HeaderText="****Gross Amount Gain From ESOP (m)"
                                                                        HeaderStyle-HorizontalAlign="Center" AllowFiltering="false" Groupable="false"
                                                                        HeaderStyle-ForeColor="blue" HeaderStyle-Font-Bold="false">
                                                                        <itemtemplate>                                                                                                                                
                                                                                                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.GrossAmtEspo")%>' ID="txtGrossAmtEspo" onkeypress="return isNumericKeyStrokeDecimalPercent(event)"
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel12" Width="100%" runat="server">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="radSctC" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            AllowSorting="true" Skin="Outlook" MasterTableView-AllowAutomaticUpdates="true"
                                                            MasterTableView-AutoGenerateColumns="false" MasterTableView-AllowAutomaticInserts="true"
                                                            MasterTableView-AllowMultiColumnSorting="true" GroupHeaderItemStyle-HorizontalAlign="left"
                                                            ClientSettings-EnableRowHoverStyle="true" ClientSettings-AllowColumnsReorder="true"
                                    ...
                                    <telerik:RadPanelItem Value="ctrlPanel13" Width="100%" runat="server">
                                        <ItemTemplate>
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <telerik:telerikrid ID="radSctD" runat="server" Width="100%" AllowFilteringByColumn="false"
                                                            AllowSorting="true" Skin="Outlook" MasterTableView-AllowAutomaticUpdates="true"
                                                            MasterTableView-AutoGenerateColumns="false" MasterTableView-AllowAutomaticInserts="true"
                                                            MasterTableView-AllowMultiColumnSorting="true" GroupHeaderItemStyle-HorizontalAlign="left"
                                                            ClientSettings-EnableRowHoverStyle="true" ClientSettings-AllowColumnsReorder="true"
                ...
                <telerik:telerikjaxPanel ID="telerikjaxPanel2" runat="server" Height="100%" Width="100%" BorderColor="White" BackColor="White">
            ...
            <p>
                ...
                <telerik:RadNumericTextBox runat="server" ID="resistenceVlaue" Width="54px" 
                ...
                <tbody>
                    <tr>
                        ...
                        <td width="102" valign="top" style="height: 24px">
                            <p>
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="noofdaystextbox" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 271px; height: 35px;">
                         <p>
                                Annual value of Premises/Rent paid byemployer :<telerik:RadNumericTextBox runat="server" ID="_AVOrRentByEmployerx1" Width="103px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true"   MinValue="0" Value="0"
                        ...
                        <td width="270" colspan="2" valign="top" style="height: 35px">
                            <p>
                                Rent paid by employee :<telerik:RadNumericTextBox runat="server" ID="_RentByEmployee" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td width="630" colspan="3" valign="top">
                            <p>
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="employee_sharing" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <p>
                <strong>&nbsp; &nbsp; &nbsp;&nbsp; 2. Value of Furniture &amp; Fittings/Driver/Gardener (Total of 2a to 2k): &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $</strong>&nbsp;<telerik:RadNumericTextBox runat="server" ID="_total_2a_2k" Width="103px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true"   MinValue="0" Value="0"
            ...
            <table border="1" cellspacing="0" cellpadding="0" align="center" width="90%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="120" colspan="6" valign="top" style="height: 19px">
                         <telerik:RadNumericTextBox runat="server" ID="no_furniture" Width="75" 
                    ...
                    <tr>
                        ...
                        <td width="60" colspan="3" valign="top" style="height: 24px">
                          <telerik:RadNumericTextBox runat="server" ID="no_refrigerator" Width="75" EmptyMessage="TV"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MaxValue="10"  MinValue="0" Value="0"
                        Type="Number"   >
                    ...
                    <telerik:RadNumericTextBox runat="server" ID="no_dvd" Width="75"
                    ...
                    <tr>
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="_NoOfWashingMachines" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="54" colspan="3" valign="top" style="height: 19px">
                         ...
                         <telerik:RadNumericTextBox runat="server" ID="no_of_dryer" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="42" colspan="2" valign="top" style="height: 19px">
                         ...
                         <telerik:RadNumericTextBox runat="server" ID="no_of_diswash1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_unitcentral" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_dining" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_sitting" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="_no_of_additional" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        Type="Number"  >
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_airpurifier" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_tvplasma1" Width="54px" 
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_radio1" Width="54px" 
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_hifi" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="24" valign="top" style="height: 62px">
                        <telerik:RadNumericTextBox runat="server" ID="no_of_guitar" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_surveillance" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_computer" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                ...
                <ClientEvents  OnValueChanging="setvalueof_computer"/>     
                        ...
                        <td width="72" colspan="4" valign="top"><telerik:RadNumericTextBox runat="server" ID="no_of_organ" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <telerik:RadNumericTextBox runat="server" ID="no_of_swimmingpool" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="240" colspan="7" valign="top">
                            <p align="center"><telerik:RadNumericTextBox runat="server" ID="publicudilities_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_publicudilities"/>    
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="telephone_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_telephone"/>   
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="pager_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_pager"/>   
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="suitcase_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_suitcase"/>   
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="golfbag_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_golfbag"/>   
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="camera_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_camera"/>   
                            ...
                            KeepTrailingZerosOnFocus="True" />
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="sarvent_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="240" colspan="7" valign="top">
                            <p align="center">
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="driver_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="240" colspan="7" valign="top">
                            <p align="center">
                                $35.00 p.m. or the actual wages,whichever is lesser
                                <telerik:RadNumericTextBox runat="server" ID="gardener_value" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td colspan="8" valign="top">
                            <p align="left">
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $<telerik:RadNumericTextBox runat="server" ID="tk_21" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <ClientEvents  OnValueChanging="setvalueof_other_benifits"/>   
                                <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                            KeepTrailingZerosOnFocus="True" />
                            </telerik:RadNumericTextBox></p></td>
                        <td valign="top" style="width: 71px">
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="90%" align="center">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="24" valign="top" style="height: 42px"><telerik:RadNumericTextBox runat="server" ID="no_of_self" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="24" valign="top" style="height: 42px"><telerik:RadNumericTextBox runat="server" ID="no_of_spouse" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td valign="top" style="height: 42px; width: 17px;"><telerik:RadNumericTextBox runat="server" ID="no_of_childrenabove20" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td valign="top" style="height: 42px; width: 10px;"><telerik:RadNumericTextBox runat="server" ID="days_self" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td colspan="3" valign="top" style="height: 42px;"><telerik:RadNumericTextBox runat="server" ID="days_spouse" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td colspan="2" valign="top" style="height: 42px; width: 53px;"><telerik:RadNumericTextBox runat="server" ID="days_childrenabove20" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="72" colspan="3" valign="top" style="height: 31px"><telerik:RadNumericTextBox runat="server" ID="no_of_chilbelow3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="90" colspan="6" valign="top" style="height: 31px"><telerik:RadNumericTextBox runat="server" ID="days_childbelow3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="72" colspan="3" valign="top" style="height: 31px"><telerik:RadNumericTextBox runat="server" ID="no_of_childabove7" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="90" colspan="6" valign="top" style="height: 31px"><telerik:RadNumericTextBox runat="server" ID="days_childabove7" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td width="72" colspan="3" valign="top"><telerik:RadNumericTextBox runat="server" ID="no_of_child8" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td width="90" colspan="6" valign="top"><telerik:RadNumericTextBox runat="server" ID="days_childabove8" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td colspan="18" style="height: 21px" valign="top">
                            <p>
                                ...
                                <telerik:RadNumericTextBox runat="server" ID="PERSENTBASICPAY" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="1" style="height: 32px; width: 137px;" valign="top">
                            ...
                            <telerik:RadNumericTextBox runat="server" ID="no_of_selfpassages" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td colspan="4" valign="top" style="height: 32px">
                            <p>
                                Spouse:&nbsp;<telerik:RadNumericTextBox runat="server" ID="no_of_passspouse" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td colspan="3" valign="top" style="height: 32px">
                            <p>
                                Children: <telerik:RadNumericTextBox runat="server" ID="no_of_passeschildrn" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                        ...
                        <td valign="top" style="width: 22px; height: 32px;">
                            <p>
                                <strong><telerik:RadNumericTextBox runat="server" ID="Costof_leavepassages" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                                               
                        Type="Number"  >
                                    <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                            KeepTrailingZerosOnFocus="True" />
                                </telerik:RadNumericTextBox></strong>&nbsp;</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="interestpayment" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="height: 31px">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="lifeinsurance" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                                               
                        Type="Number"  >
                                    <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                            KeepTrailingZerosOnFocus="True" />
                                </telerik:RadNumericTextBox></strong>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="subsidial_holydays" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="height: 31px">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="educational" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="longserviceavard" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="socialclubsfee" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="gainfromassets" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="height: 31px">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="fullcostofmotor" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center">
                                <strong><telerik:RadNumericTextBox runat="server" ID="carbenefits" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top">
                            <p align="center"><telerik:RadNumericTextBox runat="server" ID="non_manetarybenifits" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <p>
                ...
                <telerik:RadPageView ID="APPENDIX_B" runat="server" Height="100%" Width="100%" BackColor="White">
                 ...
                 <telerik:telerikjaxPanel ID="telerikjaxPanel4" runat="server" Height="100%" Width="100%" BorderColor="White" BackColor="White">
...
<table border="1" cellspacing="0" cellpadding="2" width="100%" align="center" >
    <tbody>
        ...
        <tr>
            ...
            <td valign="top" style="height: 25px; width: 59px;"><telerik:RadNumericTextBox runat="server" ID="sa_e1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 25px;"><telerik:RadNumericTextBox runat="server" ID="sa_g1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 25px"><telerik:RadNumericTextBox runat="server" ID="sa_h1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="height: 19px; width: 59px;"><telerik:RadNumericTextBox runat="server" ID="sa_e2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 19px"><telerik:RadNumericTextBox runat="server" ID="sa_g2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 19px"><telerik:RadNumericTextBox runat="server" ID="sa_h2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px; height: 45px;"><telerik:RadNumericTextBox runat="server" ID="sa_e3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 45px;"><telerik:RadNumericTextBox runat="server" ID="sa_g3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 45px"><telerik:RadNumericTextBox runat="server" ID="sa_h3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px; height: 20px;"><telerik:RadNumericTextBox runat="server" ID="sb_e1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top" style="height: 20px"><telerik:RadNumericTextBox runat="server" ID="sb_f1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 20px;"><telerik:RadNumericTextBox runat="server" ID="sb_g1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 20px"><telerik:RadNumericTextBox runat="server" ID="sb_h1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px; height: 21px;"><telerik:RadNumericTextBox runat="server" ID="sb_e2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top" style="height: 21px"><telerik:RadNumericTextBox runat="server" ID="sb_f2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 21px;"><telerik:RadNumericTextBox runat="server" ID="sb_g2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 21px"><telerik:RadNumericTextBox runat="server" ID="sb_h2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px; height: 1px;"><telerik:RadNumericTextBox runat="server" ID="sb_e3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top" style="height: 1px"><telerik:RadNumericTextBox runat="server" ID="sb_f3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 1px;"><telerik:RadNumericTextBox runat="server" ID="sb_g3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 1px"><telerik:RadNumericTextBox runat="server" ID="sb_h3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px"><telerik:RadNumericTextBox runat="server" ID="sc_e1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top"><telerik:RadNumericTextBox runat="server" ID="sc_f1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px"><telerik:RadNumericTextBox runat="server" ID="sc_g1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top"><telerik:RadNumericTextBox runat="server" ID="sc_h1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px"><telerik:RadNumericTextBox runat="server" ID="sc_e2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top"><telerik:RadNumericTextBox runat="server" ID="sc_f2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px"><telerik:RadNumericTextBox runat="server" ID="sc_g2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top"><telerik:RadNumericTextBox runat="server" ID="sc_h2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px; height: 44px;"><telerik:RadNumericTextBox runat="server" ID="sc_e3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top" style="height: 44px"><telerik:RadNumericTextBox runat="server" ID="sc_f3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 44px;"><telerik:RadNumericTextBox runat="server" ID="sc_g3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 44px"><telerik:RadNumericTextBox runat="server" ID="sc_h3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px"><telerik:RadNumericTextBox runat="server" ID="sd_e1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top"><telerik:RadNumericTextBox runat="server" ID="sd_f1" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px"><telerik:RadNumericTextBox runat="server" ID="sd_g1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top"><telerik:RadNumericTextBox runat="server" ID="sd_h1" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="width: 59px"><telerik:RadNumericTextBox runat="server" ID="sd_e2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top"><telerik:RadNumericTextBox runat="server" ID="sd_f2" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px"><telerik:RadNumericTextBox runat="server" ID="sd_g2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top"><telerik:RadNumericTextBox runat="server" ID="sd_h2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <tr>
            ...
            <td valign="top" style="height: 19px; width: 59px;"><telerik:RadNumericTextBox runat="server" ID="sd_e3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="72" valign="top" style="height: 19px"><telerik:RadNumericTextBox runat="server" ID="sd_f3" Width="70px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td valign="top" style="width: 72px; height: 19px"><telerik:RadNumericTextBox runat="server" ID="sd_g3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <td width="56" valign="top" style="height: 19px"><telerik:RadNumericTextBox runat="server" ID="sd_h3" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
        ...
        <telerik:telerikjaxManager ID="telerikjaxManager1" runat="server">
            <AjaxSettings>
            ...
            <AjaxSettings>
                <telerik:AjaxSetting AjaxControlID="telerikjaxManager1">
                    <UpdatedControls>
                        <telerik:AjaxUpdatedControl ControlID="telerikrid2" />
                    </UpdatedControls>
                </telerik:AjaxSetting>
            </AjaxSettings>
            <AjaxSettings>
