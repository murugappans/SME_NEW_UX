...
var _23={PopupControl:this.GetCalendar(),CancelOpen:false,CancelCalendarSynchronize:false};
if(this.RaiseEvent("OnPopupOpening",_23)==false||_23.CancelOpen){
return;
}
_22=!_23.CancelCalendarSynchronize;
this.popup().Opener=this;
this.popup().Show(x,y,this.GetPopupContainer());
if(_22==true){
var _24=this.DateInput.GetDate();
if(this.IsEmpty()){
this.FocusCalendar();
}else{
this.SetCalendarDate(_24);
}
}
},IsEmpty:function(){
...
var _25={PopupControl:this.GetCalendar(),CancelClose:false};
if(this.RaiseEvent("OnPopupClosing",_25)==false||_25.CancelClose){
return false;
}
this.popup().Hide();
...
},SetDate:function(_26){
this.ProgramaticSelectionInProgress=true;
this.DateInput.SetDate(_26);
},GetDate:function(){
return this.DateInput.GetDate();
},GetElementDimensions:function(_27){
var _28=_27.style.left;
var _29=_27.style.display;
_27.style.left="-10000px";
_27.style.display="";
var _2a=_27.offsetHeight;
var _2b=_27.offsetWidth;
_27.style.left=_28;
_27.style.display=_29;
return {width:_2b,height:_2a};
},CalendarDateSelected:function(_2c){
...
var _2d=this.GetJavaScriptDate(_2c.Date);
this.CalendarSelectionInProgress=true;
this.SetInputDate(_2d);
}
...
this.CheckPostBackCondition(_2c);
},CheckPostBackCondition:function(_2e){
if(_2e.IsSelected&&this.DateInput.AutoPostBack){
this.DoPostBack();
}
},DoPostBack:function(){
var _2f=this;
window.setTimeout(function(){
_2f.DateInput.RaisePostBackEvent();
},0);
},SetInputDate:function(_30){
this.DateInput.SetDate(_30);
},GetJavaScriptDate:function(_31){
var _32=new Date();
_32.setFullYear(_31[0],_31[1]-1,_31[2]);
return _32;
},OnDateInputDateChanged:function(_33,_34){
this.SetValidatorDate(_34.NewDate);
if(!this.IsPopupVisible()){
return;
}
if(this.IsEmpty()){
...
this.SetCalendarDate(_34.NewDate);
}
}
},FocusCalendar:function(){
this.Calendar.UnselectDates(this.Calendar.GetSelectedDates());
var _35=[this.FocusedDate.getFullYear(),this.FocusedDate.getMonth()+1,this.FocusedDate.getDate()];
this.Calendar.NavigateToDate(_35);
},SetValidatorDate:function(_36){
var _37="";
if(_36!=null){
var _38=(_36.getMonth()+1).toString();
if(_38.length==1){
_38="0"+_38;
}
var day=_36.getDate().toString();
if(day.length==1){
day="0"+day;
}
_37=_36.getFullYear()+"-"+_38+"-"+day;
}
this.ValidationInput.value=_37;
},GetElementPosition:function(el){
return RadCalendarUtils.GetElementPosition(el);
},SetCalendarDate:function(_3b){
var _3c=[_3b.getFullYear(),_3b.getMonth()+1,_3b.getDate()];
this.SetCalendar();
var _3d=(this.Calendar.FocusedDate[1]!=_3c[1])||(this.Calendar.FocusedDate[0]!=_3c[0]);
this.InputSelectionInProgress=true;
this.Calendar.UnselectDates(this.Calendar.GetSelectedDates());
this.Calendar.SelectDate(_3c,_3d);
this.InputSelectionInProgress=false;
},GetMinDate:function(){
return this.MinDate;
},SetMinDate:function(_3e){
var _3f=false;
if(this.IsEmpty()){
_3f=true;
}
this.MinDate=_3e;
this.DateInput.SetMinDate(_3e);
if(_3f||(this.GetDate()<this.MinDate)){
this.DateInput.Clear();
}
var _40=[_3e.getFullYear(),(_3e.getMonth()+1),_3e.getDate()];
this.GetCalendar().SetRangeMinDate(_40);
},GetMaxDate:function(){
return this.MaxDate;
},SetMaxDate:function(_41){
this.MaxDate=_41;
this.DateInput.SetMaxDate(_41);
if(this.GetDate()>this.MaxDate){
this.SetDate(this.MaxDate);
}
var _42=[_41.getFullYear(),(_41.getMonth()+1),_41.getDate()];
this.GetCalendar().SetRangeMaxDate(_42);
}};;if(typeof (window["RadCalendarNamespace"])=="undefined"){
window["RadCalendarNamespace"]={};
}
