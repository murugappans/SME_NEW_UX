  ...
  if(document.employeeform.cmbpensionoutsing.value=='No')
                  ...
                  if(document.employeeform.cmbexcessvolcpfemp.value=='1')
                 {
                   if ((document.employeeform.txtexcessvolcpfemp.value=='') && !(document.employeeform.txtexcessvolcpfemp.value=='0'))
                    ...
                    //
                     if(document.employeeform.cmbcessprov.value=='1')
                 {
...
<body style="margin-left: auto">
    <form id="employeeform" runat="server" method="post">
        ...
        <input type="hidden" id="Hidden1" name="Hidden1" runat="server" />
                ...
                <Tabs>
                   ...
                   <telerik:RadTab  runat="server" AccessKey="E" Text="APPENDIX A"
                     ...
                     <telerik:RadTab  runat="server" AccessKey="F" Text="APPENDIX B"
                        PageViewID="APPENDIX_B" Enabled="false">
                   </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tdstand" colspan="1">
                                                                    <select id="cmbIR8A_year" runat="server" class="textfields" style="width: 116px"  disabled="true">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtstockoption" runat="server" style="width: 110px" readonly />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
                                                            ...
                                                            <tr class="trstandbottom">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtbenefitskind" disabled="disabled" runat="server" readonly
                                                                        style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                            ...
                                                            <tr>
                                                               ...
                                                               <tr class="trstandbottom">
                                                                ...
                                                                <td>
                                                                  Full Amount Of contributions-</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                     <input type="text" class="textfields" id="nameoverseaspension" runat="server" style="width: 160px" />
                                                                </td>
                                                               <td>
                                                                     <input type="text" class="textfields" id="fullamount" runat="server" style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
                                                                    Are Contribution mandatory:
                                                                </td>
                                                                <td>
                                                                   Were contribution charged by singapore permanent establisment</td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <select id="contributionmandatory" runat="server" name="contributionmandatory" class="textfields"
                                                                        style="width: 116px">
                                                                       <option value="0">No</option>
                                                                        <option value="1">Yes</option>
                                                                    </select>
                                                               ...
                                                               <td>
                                                                    <select id="detuctionclaimed" runat="server" name="detuctionclaimed" class="textfields"
                                                                        style="width: 116px">
                                                                       <option value="0">No</option>
                                                                        <option value="1">Yes</option>
                                                                    </select>
                                                            ...
                                                            <tr class="trstandtop">
                                                                ...
                                                                <td>
                                                                    <radCln:RadDatePicker Calendar-ShowRowHeaders="false" ID="dtcessdate" MinDate="01-01-1900"
                                                                        runat="server">
                                                                        <DateInput Skin="" DisplayDateFormat="dd/MM/yyyy" runat="server">
                                                                        </DateInput>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                   <input type="text" class="textfields" id="remissionamount" runat="server"
                                                                        style="width: 110px" /> 
                                                                </td>
                                                                <td>
                                                                        <input type="text" class="textfields" id="exemptincome" runat="server"
                                                                        style="width: 110px" />                 
                                                                </td>
                                                            </tr>
                                                        </table>
            ...
            <h2 align="center">
                Value of Benefits-in-Kind for the Year Ended 31 Dec 2016
            </h2>
            <p align="center">
                <strong>(Fill in this form if applicable and give it to your employee by 1 Mar 2017
            ...
            <table border="1" cellspacing="0" cellpadding="0" align="center" width="90%">
                <tbody>
                    <tr>
                        ...
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" ReadOnly="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td width="630" colspan="2" valign="top">
                            <p>
                                Number of employee(s) sharing the premises (exclude family members who are not employees):</p></td>
                               <td> <radG:RadNumericTextBox runat="server" ID="employee_sharing" Width="54px" 
            ...
            <p>
                <strong>&nbsp; &nbsp; &nbsp;&nbsp; 2. Accomodation and related benifits provided by
                    Employer for the emloyee &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;            </p>
            <table border="1" cellspacing="0" cellpadding="0" align="center" width="90%">
                <tbody>
                    <tr>
                        <td valign="top" style="width: 408px; height: 40px;">
                            &nbsp; a.Annual Value(AV) of Premises</td>
                        <td  colspan="6" valign="top" style="height: 40px">
                       
                        </td>
                        <td valign="top" style="width: 71px; height: 40px;">
                            <p>
                                &nbsp;<radG:RadNumericTextBox runat="server" ID="ta_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 19px;">
                            <p align="left">
                                &nbsp; b.Value of Furniture&amp; fittings&nbsp;</p>
                        </td>
                        <td  colspan="6" valign="top" style="height: 19px">
                           
                        </td>
                        <td valign="top" style="width: 71px; height: 19px;">
                       <radG:RadNumericTextBox runat="server" ID="tb_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 24px;">
                            <p align="left">
                                &nbsp; c. Rent Paid to landlord including rental of Frniture &amp; fittings&nbsp;
                                (Mandatory if 2a and 2b are not Completed)
                                </p>
                        </td>
                        <td  colspan="6" valign="top" style="height: 24px">
                            
                        </td>
                        <td valign="top" style="width: 71px; height: 24px;"><radG:RadNumericTextBox runat="server" ID="tc_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 19px;">
                            <p align="left">
                                &nbsp;d.Taxable Value of&nbsp; Place of&nbsp; Residence(2a+2b) or 2c</p>
                        </td>
                        <td  colspan="6" valign="top" style="height: 19px; width: 47px;">
                            
                        </td>
                        <td valign="top" style="width: 71px; height: 19px;"><radG:RadNumericTextBox runat="server" ID="td_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0" ReadOnly="true"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 42px;">
                            <p align="left">
                                &nbsp;e.Total Rent Paid by employee for place of Residence</p>
                        </td>
                        <td valign="top"  colspan="6" style="width: 47px; height: 42px;">
                        
                        </td>
                        <td valign="top" style="width: 71px; height: 42px;">
                            <radG:RadNumericTextBox runat="server" ID="te_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 62px;">
                            <p align="left">
                                &nbsp;f. Total Taxable Value Of&nbsp; Place of Residence(2d-2e)&nbsp;</p>
                        </td>
                        <td valign="top" colspan="6" style="width: 47px; height: 62px;">
                           
                        </td>
                        <td valign="top"  colspan="6" style="width: 71px; height: 62px;">
                            &nbsp;<radG:RadNumericTextBox runat="server" ID="tf_2" Width="54px"  ReadOnly="true"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px">
                            <p align="left">
                                &nbsp;g. Utilities/Telephone/Pager/Suitase/Golf Bag &amp; accssories/ Camera/Electronic
                                gadgts</p>
                        </td>
                        <td  colspan="6" valign="top">
                      
                        </td>
                        <td valign="top" style="width: 71px"><radG:RadNumericTextBox runat="server" ID="tg_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 14px;">
                            <p align="left">
                                &nbsp;h.Driver</p>
                        </td>
                        ...
                        <td valign="top" style="width: 71px; height: 14px;"><radG:RadNumericTextBox runat="server" ID="th_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 31px;">
                            <p align="left">
                                &nbsp;i.Servant/Gardener</p>
                        </td>
                        <td width="240" colspan="6" valign="top" style="height: 31px">
                           
                        </td>
                        <td valign="top" style="width: 71px; height: 31px;"><radG:RadNumericTextBox runat="server" ID="ti_2" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="width: 408px; height: 9px;">
                            <p align="left">
                                &nbsp;j. Taxable value of Utilities and Housekeeping costs(2g+2h+2i)</p>
                        </td>
                        <td  colspan="6" valign="top" style="height: 9px">
                        </td>
                        <td valign="top" style="width: 71px; height: 9px;"><radG:RadNumericTextBox runat="server" ID="tj_2" Width="75" ReadOnly="true"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" value="0"
                        Type="Number" >
            ...
            <p align="left">
                <strong>&nbsp; &nbsp; </strong>
                <strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 3.Hotel Accommodation provided- See Paragraph 14 of the Explanatory Notes
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <table border="1" cellspacing="0" cellpadding="0" width="90%" align="center">
                <tbody>
                    <tr>
                        <td colspan="6" valign="top" style="width: 1216px">
                            a.Actual Hotel accommodation/Serviced Appartment with in the hotel</td>
                        <td  colspan="15" valign="top">
                       
                        </td>
                        <td colspan="1">
                            <p align="left"><radG:RadNumericTextBox runat="server" ID="ta_3" Width="75"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" value="0"
                        Type="Number" >
                            <ClientEvents  OnValueChanging="setvalueof_dvd"/>
                            <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                    ...
                    <tr>
                        <td colspan="6" valign="top" style="height: 32px; width: 1216px;">
                            <p align="left">
                                b.Amount Paid by the employee</p>
                        </td>
                      
                        <td colspan="15" valign="top" style="height: 32px;"></td>
                        <td colspan="1" style="height: 32px"><radG:RadNumericTextBox runat="server" ID="tb_3" Width="75"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" Value="0"
                        Type="Number" >
                            <ClientEvents  OnValueChanging="setvalueof_dvd"/>
                            <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                    ...
                    <tr>
                        <td colspan="6" valign="top" style="height: 32px; width: 1216px;">
                            <p align="left">
                              c.Taxable Value Of Hotel Accommodation(3a-3b)</p>
                        </td>
                        <td valign="top" style="height: 32px" colspan="15"></td>
                        <td colspan="1" style="height: 32px"><radG:RadNumericTextBox runat="server" ID="tc_3" Width="75"
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" value="0" ReadOnly="true"
                        Type="Number" >
                            <ClientEvents  OnValueChanging="setvalueof_dvd"/>
                            <NumberFormat AllowRounding="False" DecimalDigits="2" KeepNotRoundedValue="True"
                            KeepTrailingZerosOnFocus="True" />
                    ...
                    <tr>
                        <td colspan="20" style="height: 21px" valign="top">
                   ...
                   <%-- <tr>
                        <td colspan="18" valign="top">
                            (<strong>See paragraph 15 of the Explanatory Notes</strong>)Pioneer/export/pioneer
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" align="right">
                           <radG:RadNumericTextBox runat="server" ID="interestpayment" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" colspan="18" style="height: 31px">
                            <p>
                                <strong>&nbsp;c</strong>
                                Life insurance premiums paid by the employer :<strong></strong>
                            </p>
                        </td>
                        <td colspan="4" valign="top" style="height: 31px" align="right">
                           <radG:RadNumericTextBox runat="server" ID="lifeinsurance" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" align="right">
                            <radG:RadNumericTextBox runat="server" ID="subsidial_holydays" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="height: 31px" align="right">
                           <radG:RadNumericTextBox runat="server" ID="educational" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" align="right">
                           <radG:RadNumericTextBox runat="server" ID="longserviceavard" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0"  Value="0" 
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" align="right">
                           <radG:RadNumericTextBox runat="server" ID="socialclubsfee" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" colspan="18" style="height: 13px">
                            <p>
                                <strong>&nbsp;h</strong>
                        ...
                        <td colspan="4" valign="top" style="height: 13px" align="right">
                            <radG:RadNumericTextBox runat="server" ID="gainfromassets" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" style="height: 31px" align="right">
                           <radG:RadNumericTextBox runat="server" ID="fullcostofmotor" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" colspan="18">
                            <p>
                                <strong>&nbsp;j</strong>
                                Car benefits <strong>(See paragraph 16 of the Explanatory Notes)</strong>
                            </p>
                        </td>
                        <td colspan="4" valign="top" align="right">
                           <radG:RadNumericTextBox runat="server" ID="carbenefits" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        ...
                        <td colspan="4" valign="top" align="right">
                            <radG:RadNumericTextBox runat="server" ID="non_manetarybenifits" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
                    ...
                    <tr>
                        <td valign="top" style="height: 61px" colspan="18">
                            <p>
                                <strong></strong>
                            </p>
                            <h3>
                                &nbsp;&nbsp;
                                TOTAL VALUE OF BENEFITS-IN-KIND (ITEMS 2 TO 4) TO BE REFLECTED IN ITEM d9 OF &nbsp; FORM
                                IR8A
                            </h3>
                        </td>
                        <td colspan="4" valign="top" style="height: 61px" align="right">
                            
                                    <radG:RadNumericTextBox runat="server" ID="totalvalueofbenifits" Width="54px" 
                        Skin="Vista" AllowOutOfRangeAutoCorrect="true" MinValue="0" Value="0"
            ...
            <p>
                <strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; IR8A(A/1/</strong> <strong>2017) </strong><strong>There are penalties for failing
