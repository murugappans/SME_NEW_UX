<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manageir21info.aspx.cs" Inherits="IRAS.Manageir21info" %>
                ...
                <td>
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                           ...
                           <font class="colheading">&nbsp;&nbsp;&nbsp;<b></b></font>
                              <asp:CheckBox  runat="server" ID="addressUpdate" AutoPostBack="true" onClick="Confirm();" OnCheckedChanged="checkboxclick" Visible ="false" />
                            ...
                            <td background="Frames/Images/toolbar/backs.jpg" align="center" colspan="1">
                             ...
                             <asp:DropDownList ID="cmbaddress" class="textfields" runat="server" Width="116px" Enabled="false" Visible ="false">
                            ...
                            <td background="Frames/Images/toolbar/backs.jpg" align="center" colspan="1">
                                <asp:Button ID="btnUpdateIrAs" OnClick="btnUpdateIras_Click" Text="Generate" runat="server" Visible ="false" />
                            </td>
                    ...
                    <radG:RadGrid ID="RadGrid1" runat="server" GridLines="None" AutoGenerateColumns="False"
                        ...
                        <MasterTableView DataKeyNames="emp_code">
                            ...
                            <Columns>
                                ...
                                <radG:GridTemplateColumn HeaderText="Update IR21 Details" AllowFiltering="False" UniqueName="ir8a">
                                    <ItemTemplate>
                                        <tt class="bodytxt">
                                            <asp:Button ID="btnIr8a" Text="IR21" Enabled="true" runat="server" />
                                    </ItemTemplate>
