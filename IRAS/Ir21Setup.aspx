<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Ir21Setup.aspx.cs" Inherits="IRAS.Ir21Setup"
            ...
            <telerik:RadTabStrip ID="tbsEmp" runat="server" SelectedIndex="0" MultiPageID="tbsEmp12"
                ...
                <Tabs>
                   ...
                   <telerik:RadTab  runat="server" AccessKey="E" Text="APPENDIX A"
                    ...
                    <telerik:RadTab  runat="server"  Text="IR21 Info"
                        PageViewID="tbsIR21">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <telerik:RadPageView runat="server" ID="tbsIR21" Height="400px">
                    <table class="tbl" border="0">
                        <tr valign="top">
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" style="table-layout: auto; width: 100%;">
                                                    ...
                                                    <td valign="top">
                                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="tdstand" colspan="1">
                                                                    <select id="cmbIR8A_year_21" runat="server" class="textfields" style="width: 116px">
                                                                        <option value="2007">2007</option>
                                                                        <option value="2008">2008</option>
                                                                        <option value="2009">2009</option>
                                                                        <option value="2010">2010</option>
                                                            ...
                                                            <tr class="trstandtop">
                                                                <td>
                                                                    <select id="cmbtaxbornbyemployer_21" runat="server" name="cmbtaxbornbyemployer_21" class="textfields"
                                                                        style="width: 116px" onchange="javascript:EnableDisableandValue('cmbtaxbornbyemployer_21','txttaxbornbyempamt_21');javascript:EnableDisableandValue('cmbtaxbornbyemployer_21','cmbtaxbornbyemployerFPHN_21')">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <select id="cmbtaxbornbyemployerFPHN_21" runat="server" class="textfields" style="width: 350px" 
                                                                        onchange="javascript:EnableDisableandValueNew('cmbtaxbornbyemployerFPHN_21','txttaxbornbyempamt_21');">
                                                                        <option value="">Select</option>
                                                                        <option value="F">F - Tax fully borne by employer on employment income only</option>
                                                                        <option value="P">P - Tax partially borne by employer on certain employment income items</option>
                                                                        <option value="H">H - A fixed amount of income tax liability borne by Employee</option>
                                                                ...
                                                                <td>
                                                                    <input type="text" class="textfields" id="txttaxbornbyempamt_21" runat="server" style="width: 110px" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txttaxbornbyempoyeeamt_21" runat="server"
                                                                        style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select id="cmbstockoption_21" runat="server" name="cmbstockoption_21" class="textfields"
                                                                        style="width: 116px" onchange="javascript:EnableDisableandValue('cmbstockoption_21','txtstockoption_21','APPENDIX_B_21');">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtstockoption_21" runat="server" style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
                                                            ...
                                                            <tr class="trstandbottom">
                                                                <td>
                                                                    <select id="cmbbenefitskind_21" runat="server" name="cmbbenefitskind_21" class="textfields"
                                                                        style="width: 116px" onchange="javascript:EnableDisableandValue('cmbbenefitskind_21','txtbenefitskind_21','APPENDIX_A_21');">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtbenefitskind_21" disabled="disabled" runat="server"
                                                                        style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select id="cmbretireben_21" runat="server" name="cmbretireben_21" class="textfields" onchange="javascript:EnableDisableandValue('cmbretireben_21','txtretirebenfundname_21,txtbretireben_21');"
                                                                        style="width: 116px">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <input maxlength="200" type="text" class="textfields" id="txtretirebenfundname_21" runat="server"
                                                                        style="width: 110px" />
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtbretireben_21" runat="server" style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select id="cmbpensionoutsing_21" runat="server" name="cmbpensionoutsing_21" class="textfields"
                                                                        style="width: 116px" onchange="javascript:EnableDisableandValue('cmbpensionoutsing_21','txtpensionoutsing_21');">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtpensionoutsing_21" runat="server" style="width: 110px" />
                                                                </td>
                                                            </tr>
                                                            <tr class="trstandbottom">
                                                                <td>
                                                            ...
                                                            <tr class="trstandtop">
                                                                <td>
                                                                    <select id="cmbexcessvolcpfemp_21" runat="server" name="cmbexcessvolcpfemp_21" class="textfields"
                                                                        style="width: 116px" onchange="javascript:EnableDisableandValue('cmbexcessvolcpfemp_21','txtexcessvolcpfemp_21');">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="textfields" id="txtexcessvolcpfemp_21" runat="server" style="width: 110px" />
                                                                </td>
                                                                <td>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="trstandtop">
                                                                <td>
                                                                    <select id="cmbcessprov_21" runat="server" name="cmbcessprov_21" class="textfields" onchange="javascript:EnableDisableandValue('cmbcessprov_21','dtcessdate,dtcommdate_21');"
                                                                        style="width: 116px">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <radCln:RadDatePicker Calendar-ShowRowHeaders="false" ID="dtcessdate_21" MinDate="01-01-1900"
                                                                        runat="server">
                                                                        <DateInput Skin="" DisplayDateFormat="dd/MM/yyyy">
                                                                        </DateInput>
                                                                    </radCln:RadDatePicker>
                                                                ...
                                                                <td>
                                                                    <radCln:RadDatePicker Calendar-ShowRowHeaders="false" ID="dtcommdate_21" MinDate="01-01-1900"
                                                                        runat="server">
                                                                        <DateInput Skin="" DisplayDateFormat="dd/MM/yyyy">
                                                                        </DateInput>
                                                                    </radCln:RadDatePicker>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select id="staxondirector_21" runat="server" name="staxondirector_21" class="textfields"
                                                                        style="width: 116px">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="cmbaddress_21" class="textfields" runat="server" Width="116px">
                                                                        <asp:ListItem Value="N" Text="No Address"></asp:ListItem>
                                                                        <asp:ListItem Value="L" Text="Local Residential address"></asp:ListItem>
                                                                        <asp:ListItem Value="F" Text="Foreign Address"></asp:ListItem>
                                                                        <asp:ListItem Value="C" Text="C/O Address"></asp:ListItem>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <select id="OptInsurance_21" runat="server" name="staxondirector_21" class="textfields"
                                                                        style="width: 116px">
                                                                        <option>No</option>
                                                                        <option>Yes</option>
                                                                    </select>
                                                                ...
                                                                <td>
                                                                        <input type="text" class="textfields" id="txtInsurance_21" runat="server"
                                                                        style="width: 110px" />                 
                                                                </td>
                                                            </tr>
                                                        </table>
