                ...
                <div class="tab-content">
                    <div class="tab-pane active page-quick-sidebar-chat" id="quick_sidebar_tab_1">
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items media-list-style2 media-list-style3">
                                <li class="media">

                                    <div class="media-status">
                                        <span class="label label-sm">Demo Company Pte Ltd</span>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-building"></i>Company Name</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">SantyKKumar</span>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-user"></i>Client Name</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">Super Admin</span>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-users"></i>User Group</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">DPTAdmin</span>
                                    </div>
                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-user"></i>User Name</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">04/07/2017</span>
                                    </div>

                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-calendar"></i>License Expirey</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">1000 - 39=961</span>
                                    </div>

                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-certificate"></i>License Detail</h4>
                                    </div>
                                </li>
                                <li class="media">
                                    <div class="media-status">
                                        <span class="label label-sm">December 31,2016</span>
                                    </div>

                                    <div class="media-body">
                                        <h4 class="media-heading"><i class="fa fa-calendar"></i>License Renewal</h4>
                                    </div>
                                </li>
                            </ul>
