<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RejectedLeaves.aspx.cs"
    Inherits="SMEPayroll.Leaves.RejectedLeaves" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">View Rejected Leave</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                        ...
                        <form id="form1" runat="server">
                                ...
                                <div class="form-inline col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="DropDownList1" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource1"
                                            DataTextField="emp_name" DataValueField="emp_code" CssClass="textfields form-control input-sm">
                            ...
                            <div>
                                ...
                                <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                    Skin="Outlook" Width="100%" EnableHeaderContextFilterMenu="true" OnItemDataBound="RadGrid1_ItemDataBound">
                                    <MasterTableView DataSourceID="SqlDataSource2" AutoGenerateColumns="False" DataKeyNames="trx_id">
                                        ...
                                        <Columns>
                                            ...
                                            <radG:GridBoundColumn ReadOnly="True" DataField="trx_id" DataType="System.Int32"
                                                UniqueName="trx_id" SortExpression="trx_id" HeaderText="trx_id" Visible="False">
                                            </radG:GridBoundColumn>
                                            <radG:GridBoundColumn DataField="Application Date" DataType="System.DateTime" UniqueName="ApplicationDate"
                                                SortExpression="Application Date" HeaderText="Application Date">
                                            </radG:GridBoundColumn>
                                            <radG:GridBoundColumn DataField="leave_type" DataType="System.Int32" UniqueName="leave_type"
                                                Visible="false" SortExpression="Leave Type" HeaderText="Leave Type">
                                            </radG:GridBoundColumn>
                                            ...
                                            <radG:GridBoundColumn DataField="start_date" DataType="System.DateTime" UniqueName="start_date"
                                                SortExpression="Duration  From" HeaderText="Duartion From">
                                            </radG:GridBoundColumn>
                                            <radG:GridBoundColumn DataField="end_date" DataType="System.DateTime" UniqueName="end_date"
                                                SortExpression="To" HeaderText="To">
                                            </radG:GridBoundColumn>
                                            <radG:GridBoundColumn DataField="Status" UniqueName="Status" SortExpression="Status"
                                                HeaderText="Status">
                                            </radG:GridBoundColumn>
                                            ...
                                            <radG:GridBoundColumn DataField="Session" UniqueName="Session" SortExpression="Session"
                                                HeaderText="Session">
                                            </radG:GridBoundColumn>
                                            ...
                                            <radG:GridBoundColumn DataField="Approver" DataType="System.DateTime" UniqueName="Approver"
                                                SortExpression="Rejected By" HeaderText="Rejected By">
                                            </radG:GridBoundColumn>
                                            ...
                                            <radG:GridTemplateColumn HeaderText="Attached Document" AllowFiltering="false">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HyperLink ID="h1" runat="server" Target="_blank" Text='<%# Eval("Path")%>'></asp:HyperLink>
                                                </ItemTemplate>
                                            </radG:GridTemplateColumn>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" DeleteCommand="DELETE FROM [emp_leaves] WHERE [trx_id] = @trx_id"
                                    InsertCommand="INSERT INTO [emp_leaves] ([emp_id], [leave_type], [start_date], [end_date], [approver], [Application Date]) VALUES (@emp_id, @leave_type, @start_date, @end_date, @approver, @Application Date)"
                                    SelectCommand="SELECT [Path],[trx_id], [emp_id], [leave_type],b.type,a.remarks,convert(varchar(15),[start_date],103)'start_date', convert(varchar(15),[end_date],103)'end_date',timesession  as Session,paid_leaves,unpaid_leaves,(paid_leaves + unpaid_leaves)'sumLeaves', [status], convert(varchar(15),getdate(),103)'Application Date', [approver]  FROM [emp_leaves] a,leave_types b WHERE leave_type=b.id and ([emp_id] = 0) and year(start_date)=0 and ([status]='Rejected') Order by 5"
                                    UpdateCommand="UPDATE [emp_leaves] SET [emp_id] = @emp_id, [leave_type] = @leave_type, [start_date] = @start_date, [end_date] = @end_date, [approver] = @approver, [Application Date] = @Application Date WHERE [trx_id] = @trx_id">
                                    <DeleteParameters>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" DeleteCommand="DELETE FROM [employee] WHERE [emp_code] = @emp_code"
                                    InsertCommand="INSERT INTO [employee] ([emp_name], [emp_code]) VALUES (@emp_name, @emp_code)"
                                    SelectCommand="select -1 emp_code, '-select--' [emp_name] UNION SELECT [emp_code],isNull([emp_name],'')+' '+isnull([emp_lname],'')[emp_name]  FROM [employee] where termination_date is null and company_id=@company_id order by emp_name"
