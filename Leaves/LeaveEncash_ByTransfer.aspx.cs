...
{
    public partial class LeaveEncash_ByTransfer : System.Web.UI.Page
    {
        ...
        private void isFormulaAssigned()
        {
            ...
            string strEmpSelect = @" select * from( Select DISTINCT e.emp_code, e.emp_name ,el.leave_year,el.Leaves_Allowed from employee as e " +
                           ...
                           + cmbEmpgroup.SelectedValue.ToString() + ")A where not EXISTS (select * from Encashment b where a.emp_code=b.EmpCode)";
            ...
            {
                Response.Redirect("../Leaves/FormulaAssign.aspx?compid=" + compid + "&year=" + Convert.ToInt32(cmbYear.SelectedValue) + "&month=" + month + "&group=" + cmbEmpgroup.SelectedValue.ToString() + "&encashtype=2");
            }
        ...
        protected void Hybrid_Leave_Binding()
        {
            ...
            int payrolltype = 1;
            if (Convert.ToInt32(cmbMonth.SelectedValue) > 168)
                payrolltype = 2;
            ...
            strEmpSelect = " Select DISTINCT e.emp_code, e.emp_name ,el.leave_year,el.Leaves_Allowed from employee as e " +
                           " INNER JOIN EmployeeLeavesAllowed el on e.emp_code=el.emp_id " +
                           " where e.payrolltype=" + payrolltype + " and  e.Company_Id = " + compid + " and e.termination_date is null and el.leave_year=" + Convert.ToInt32(cmbYear.SelectedValue) + " and Leave_Type=8 AND termination_date is null and e.emp_group_id= " + cmbEmpgroup.SelectedValue.ToString();
            ...
            for (int i = 0; i < ds_Emp.Tables[0].Rows.Count; i++)
            {
                ...
                try
                {
                    ...
                    if (actualleaveEncash > 0.0)
                    {
                        ...
                        parmeras[12] = new SqlParameter("@encashtype", 2);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            if (typeid == 0)
            {
                //ShowMessageBox("Please Add Addition Type of LEAVE ENCASH");
                _actionMessage = "Warning|Please Add Addition Type of LEAVE ENCASH";
            ...
            //ShowMessageBox("Leave Encashment Successful");
             _actionMessage = "Success|Leave Encashment Successful.";
            ViewState["actionMessage"] = _actionMessage;
        ...
        private void imgbtnsave_Click(string empcode, double nofoleaveEncash, double amount, int addtype)
        {
            ...
            if (conLock > 0)
            {
               ...
               // HttpContext.Current.Response.Write("<Script type='text/javascript'>alert('Payroll has been locked for Selected Month.')</Script>");
                ViewState["actionMessage"] = "Warning|Payroll has been locked for Selected Month..";
