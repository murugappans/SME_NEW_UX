<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveEncash_ByTermination.aspx.cs"
    Inherits="SMEPayroll.Leaves.LeaveEncash_ByTermination" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Encash Leave By Termination</li>
                        <li>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Encash Leave By Termination</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box padding-tb-10 clearfix">
                                <div class="form-inline col-sm-12">
                                    ...
                                    <%-- <tt class="bodytxt">
                                    <asp:Label ID="Label1" Text="Encash Leaves :" runat="server"></asp:Label></tt>--%>
                            ...
                            <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" runat="server" AllowMultiRowSelection="true"
                                ...
                                <MasterTableView AllowPaging="true" AutoGenerateColumns="False" DataKeyNames="emp_code">
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="LeaveAvailble" HeaderText="Leave Available" ReadOnly="True"
                                            SortExpression="LeaveAvailble" UniqueName="LeaveAvailble">
                                            <HeaderStyle Width="170px" />
                                            <ItemStyle Width="170px" />
                                        </radG:GridBoundColumn>
                                        <radG:GridTemplateColumn ItemStyle-HorizontalAlign="Left" DataField="LeaveEncash" UniqueName="LeaveEncash"
                                            HeaderText="Leave Encash">
                                            <ItemTemplate>
                                                <asp:TextBox ID="LeaveEncash" CssClass="form-control input-sm" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.LeaveEncash")%>'></asp:TextBox>
                                            </ItemTemplate>
                                            <HeaderStyle Width="170px" />
                                            <ItemStyle Width="170px" />
                                        </radG:GridTemplateColumn>
                                    ...
                                    ReadOnly="True" SortExpression="LeaveEncash" UniqueName="LeaveEncash">
                                        ...
                                        <radG:GridBoundColumn DataField="LeavesAfterTranfer" HeaderText="Leaves After Encash"
            ...
            <SelectParameters>
                ...
                <asp:SessionParameter Name="compid" SessionField="Compid" Type="Int32" />
                            ...
                            <%--By jammu office  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cmbEmpgroup"
                                Display="None" ErrorMessage="Employee Group Name is not selected!" InitialValue=""></asp:RequiredFieldValidator> By jammu office--%>
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
          ...
          function validateform() {
              ...
              //else if ($.trim($("#txtfwd").val()) === "")
              // _message = "Please Enter No of Leaves.";
              if (_message != "") {
