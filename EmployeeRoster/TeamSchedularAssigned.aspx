<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamSchedularAssigned.aspx.cs" Inherits="SMEPayroll.EmployeeRoster.TeamSchedularAssigned" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Team Scheduler Assigned</span>
                        </li>
                    </ul>
                                            ...
                                            <MasterTableView AllowAutomaticUpdates="True" DataSourceID="SqlDataSource2" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <radG:GridBoundColumn DataField="Emp_Name" DataType="System.String" AllowFiltering="true" AutoPostBackOnFilter="true" UniqueName="Emp_Name"
                                                        Visible="true" SortExpression="Emp_Name" HeaderText="Employee Name" FilterControlAltText="cleanstring">
                                            ...
                                            <MasterTableView CommandItemDisplay="None" AllowAutomaticUpdates="True" DataSourceID="SqlDataSource1"
                                                ...
                                                <Columns>
                                                    ...
                                                    <radG:GridBoundColumn DataField="Emp_Name" DataType="System.String" UniqueName="Emp_Name"
                                                        Visible="true" SortExpression="Emp_Name" HeaderText="Employee Name" AllowFiltering="true" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                        ...
                        <td valign="top">
                            ...
                            &nbsp;</td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        SelectCommand="Select Emp_Code, (Emp_Name+' '+Emp_LName) Emp_Name,'Assigned' = Case  When EC.Team_ID is null Then CAST(0 AS bit) Else CAST(1 AS bit) End,EA.Time_Card_No From Employee EA Left Outer Join (Select EA.Emp_ID,EA.Team_ID From TeamSchedulerAssigned EA Inner Join Employee EM On EA.Emp_ID = EM.Emp_Code Where   EM.termination_date IS NULL AND EM.Company_ID=@company_id And EA.Team_ID=@RosterID  And EM.[StatusID]=1) EC On EA.Emp_Code = EC.Emp_ID Where EA.[StatusID]=1  And EA.Company_ID=@company_id And EC.Team_ID is null And @RosterID > -1 And (EA.Time_Card_No is not null  And EA.Time_Card_No !='') And EA.Emp_Code not in(Select Distinct EA.Emp_ID From TeamSchedulerAssigned EA  Where EA.Team_ID!=@RosterID) and EA.Emp_Code in(Select Distinct Ew.Emp_ID From [EmployeeAssignedToWorkersList] Ew)  Order By EA.Emp_name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="Select EA.ID,EA.Team_ID,EA.Emp_ID,(Emp_Name+' '+Emp_LName) Emp_Name,EM.Time_Card_No From TeamSchedulerAssigned EA  Inner Join Employee EM On EA.Emp_ID = EM.Emp_Code Where EA.Team_ID=@RosterID And EM.StatusID=1  AND  EM.termination_date IS  NULL Order By Emp_Name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                            <asp:ControlParameter ControlID="ddlRoster" Name="RosterID" PropertyName="SelectedValue"
                                                Type="Int32" />
...
<uc_js:bundle_js runat="server" ID="bundle_js" />
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
            ...
            var _inputs = $('#RadGrid1 thead tr td,#RadGrid2 thead tr td').find('input[type=text]');
        ...
        $(document).ready(function () {
            $('#buttonAdd').click(function () {
                ...
                if ($("#RadGrid2_ctl00 tbody tr.rgNoRecords").length == 1) {
                    var _message = "No record to be assigned";
                    WarningNotification(_message);
                    return false;
                }

                if ($("#RadGrid2_ctl00 tbody tr td").find('input[type=checkbox]:checked').length < 1) {
                    var _message = "Atleast one record must be selected from grid.";
            ...
            $('#buttonDel').click(function () {
                ...
                if ($("#RadGrid1_ctl00 tbody tr.rgNoRecords").length == 1) {
                    var _message = "No record to be un-assigned";
                    WarningNotification(_message);
                    return false;
                }
