...
{
    public partial class TeamSchedularAssigned : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sSQL = "Select ID, Team_Name From TeamScheduler Where Company_ID={0}";
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                //    else
                //    {
                string sSQL = "DELETE FROM [TeamSchedulerAssigned] WHERE [ID] =" + id;
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (strMessage.Length == 0)
            {
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    string sSQL = "sp_Team_Schedular_Assigned";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        //lblMsg.ForeColor = System.Drawing.Color.Green;
                        //lblMsg.Text = "Employee " + strActionMsg + " To Roster Successfully.";
                        _actionMessage = "success|Employee"+ strActionMsg + " To Roster Successfully.";
                        ViewState["actionMessage"] = _actionMessage;
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    ...
                    else
                    {
                        ...
                        _actionMessage = "Warning|Unable to"+ strActionMsg + " Employees to Roster.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                }
                else
