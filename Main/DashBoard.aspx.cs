    ...
    public partial class DashBoard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Senthil Updated
                ...
                {
                   // sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'License No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 10 And termination_date is null and EY.company_id =" + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=10 and Company_Id='" + compid + "' ) Order by [days] Asc";
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'License No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 10 And termination_date is null and EY.company_id =" + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=10 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=10 and company_id=4) ) Order by [days] Asc";
                }
                else
                {
                    //sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'License No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 10 And termination_date is null and EY.company_id =" + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=10 and Company_Id='" + compid + "' ) Order by [days] desc";
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'License No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 10 And termination_date is null and EY.company_id =" + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=10 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=10 and company_id=4) ) Order by [days] desc";
                }
            ...
            if (dcount1.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount1.Tables[0].Rows.Count);
            }
            ...
            //}
                ...
                if (ValidateAscOrDesc("3") == "Asc")
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'FIN/WP No', Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 3 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=3 and Company_Id='" + compid + "' ) and  EC.ID = (SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=3 and company_id=4) )  Order by [days] Asc";
                }
                else
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'FIN/WP No', Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 3 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=3 and Company_Id='" + compid + "' ) and  EC.ID = (SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=3 and company_id=4) ) Order by [days] desc";
                }
            ...
            RadGrid1.DataBind();
            //--murugan
            sSQL = "Select  EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'FIN/WP No', Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 3 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=3 and Company_Id='" + compid + "' ) and  EC.ID = (SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=3 and company_id=4) )";
           ...
           // sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'PP No',Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 3 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=4 and Company_Id='" + compid + "' )  Order by 5";
            ...
            //}
                ...
                if (ValidateAscOrDesc("4") == "Asc")
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'PP No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 4 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=4 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in(select id  from [CertificateCategory] where ColID=4 and company_id=4))  Order by  [Days] Asc";
                }
                else
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'PP No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 4 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=4 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=4 and company_id=4))  Order by  [Days] desc";
                }
            ...
            if (dcount2.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount2.Tables[0].Rows.Count);
            }
            //Employee Birthday
           ...
           // sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Insu No',Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.COLID where CertificateCategoryID =1 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=7 and Company_Id='" + compid + "') Order by 5";
            ...
            //}
                ...
                if (ValidateAscOrDesc("6") == "Asc")
                {
                    ...
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Insurance No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where CC.ID =6 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=6 and Company_Id='" + compid + "') and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=6 and company_id=4) ) Order by  ExpiryDate Asc";
                    //sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Insu No',Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.COLID where CertificateCategoryID =1 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=6 and Company_Id='" + compid + "') Order by  ExpiryDate Asc";
                }
                else
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Insurance No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where CC.ColID =6 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=6 and Company_Id='" + compid + "') and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=6 and company_id=4) ) Order by  ExpiryDate desc";
                }
            ...
            //--murugan
            sSQL = "Select   EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Insurance No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where CC.ColID =6 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=6 and Company_Id='" + compid + "') and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=6 and company_id=4) )";
            DataSet dcount3;
            ...
            if (dcount3.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount3.Tables[0].Rows.Count);
            }
            ...
            //}
                ...
                if (ValidateAscOrDesc("5") == "Asc")
                {
                    ...
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'CSOC No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where CC.ColID =5 And termination_date is null and EY.company_id= " + compid + " and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=5  and Company_Id='" + compid + "') and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=5 and company_id=4) )  Order by  [Days] Asc";
                    //sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'CSOC No',Emp_type [Type], Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.COLID where CertificateCategoryID =2 And termination_date is null and CC.company_id= " + compid + " and ABS(datediff(dd, getdate(), ExpiryDate))<=(select [Days] from [Remainder_Day] where Sno=5  and Company_Id='" + compid + "')   Order by  [Days] Asc";
                }
                else
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'CSOC No', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.COLID where CC.ColID =5 And termination_date is null and EY.company_id= " + compid + " and ABS(datediff(dd, getdate(), ExpiryDate))<=(select [Days] from [Remainder_Day] where Sno=5  and Company_Id='" + compid + "') and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=5 and company_id=4) )  Order by  [Days] Desc";
                }
            ...
            if (dcount4.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount4.Tables[0].Rows.Count);
            }
            ...
            if (dcount5.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount5.Tables[0].Rows.Count);
            }
            ...
            if (dcount6.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount6.Tables[0].Rows.Count);
            }
            ...
            if (dss.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dss.Tables[0].Rows.Count);
            }
            ...
            if (dcount8.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount8.Tables[0].Rows.Count);
            }
            ...
            //}
                ...
                if (ValidateAscOrDesc("9") == "Asc")
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Certificate No',Emp_type 'Type', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 9 And termination_date is null and EY.company_id= '" + compid + "' and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=9 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=9 and company_id=4) ) Order by [days] Asc";
                }
                else
                {
                    sSQL = "Select Top 5 EY.time_card_no as TimeCardNo, isnull(emp_name,'')+' '+isnull(emp_lname,'') Name,CertificateNumber 'Certificate No',Emp_type 'Type', Convert(varchar(15),ExpiryDate,103) 'Exp Date',datediff(dd, getdate(), ExpiryDate) [Days] from EmployeeCertificate EC  Inner Join Employee EY On EC.Emp_ID=EY.Emp_Code Inner Join CertificateCategory CC ON  EC.CertificateCategoryID = CC.ID where COLID = 9 And termination_date is null and EY.company_id= '" + compid + "' and datediff(dd, getdate(), ExpiryDate)<=(select [Days] from [Remainder_Day] where Sno=9 and Company_Id='" + compid + "' ) and  EC.ID=(SELECT MAX(ID) from EmployeeCertificate WHERE EMP_ID=EC.Emp_ID and [CertificateCategoryID] in (select id  from [CertificateCategory] where ColID=9 and company_id=4) ) Order by [days] desc";
                }
            ...
            if (dcount9.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount9.Tables[0].Rows.Count);
            }
            //Senthil End
            // Year Of Service 
            ...
            if (dcount10.Tables[0].Rows.Count >= 0)
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount10.Tables[0].Rows.Count);
            }
            //***************DataBase Backup ***************
            sSQL = "";
            ...
            if (dcount.Tables[0].Rows[0][0].ToString() != "0")
            {
                ...
                label.Text = "Count : " + Convert.ToString(dcount.Tables[0].Rows[0][0]);
            }
        ...
        void RadGrid11_ItemCreated(object sender, GridItemEventArgs e)
        {
            ...
            //    Label label = (Label)Radtoolbar3.FindItemByText("Count").FindControl("Label11");
            //    label.Text = "Count : " + Convert.ToString(count);
            //    if (count == 0)
            //    {
