    ...
    return {
        init: function() {
            ...
            ! function() {
                ...
                function() {
                    if (0 != $("#m_chart_bandwidth3").length) {
                        var e = document.getElementById("m_chart_bandwidth3").getContext("2d"),
                            t = e.createLinearGradient(0, 0, 0, 240);
                        t.addColorStop(0, Chart.helpers.color("#d97474").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#ffefce").alpha(.3).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                ...
                function() {
                    if (0 != $("#m_chart_bandwidth4").length) {
                        var e = document.getElementById("m_chart_bandwidth4").getContext("2d"),
                            t = e.createLinearGradient(0, 0, 0, 240);
                        t.addColorStop(0, Chart.helpers.color("#a4e0fb").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#a4e0fb").alpha(.3).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                ...
                function() {
                    if (0 !== $("#m_calendar").length) {
                        ...
                        $("#m_calendar").fullCalendar({
                            ...
                            eventLimit: !0,
                            navLinks: !0,
                            defaultDate: Date.now(), //moment("2018-08-15"),
                            events: _events,
                            //events: [{
                            //    title: "Prabjeet Passport Expiry",
                            ...
                            //    start: moment("2018-08-29T13:30:00"),
                            //    end: moment("2018-08-29T17:30:00"),
                            ...
                            //}, {
                            //    title: "Prabjeet Singh",
                            //    start: moment("2018-08-01"),
                            //    description: "40th Birthday Prabjeet Singh",
                            //    className: "m-fc-event--danger m-fc-event--solid-focus"
                            //}, {
                            //    title: "Reporting",
                            //    description: "Lorem ipsum dolor incid idunt ut labore",
                            //    start: moment("2018-08-03T13:30:00"),
                            //    end: moment("2018-08-04T17:30:00"),
                            //    className: "m-fc-event--accent"
                            //}, {
                            //    title: "Prabjeet Annual Leave",
                            //    start: moment("2018-08-05"),
                            ...
                            //}, {
                            //    title: "Dinner",
                            //    start: moment("2018-08-12"),
                            //    description: "Lorem ipsum dolor sit amet, conse ctetur"
                            //}, {
                            //    id: 999,
                            //    title: "Repeating Event",
                            //    start: moment("2018-08-15T16:00:00"),
                            ...
                            //    start: moment("2018-08-18T19:00:00")
                            //}, {
                            //    title: "Conference",
                            //    start: moment("2018-08-20T13:00:00"),
                            //    end: moment("2018-08-21T19:00:00"),
                            //    description: "Lorem ipsum dolor eius mod tempor labore",
                            //    className: "m-fc-event--accent"
                            //}, {
                            //    title: "Meeting",
                            //    start: moment("2018-08-11"),
                            //    description: "Lorem ipsum dolor eiu idunt ut labore"
                            //}, {
                            //    title: "Lunch",
                            //    start: moment("2018-08-18"),
                            //    className: "m-fc-event--info m-fc-event--solid-accent",
                            //    description: "Lorem ipsum dolor sit amet, ut labore"
                            //}, {
                            //    title: "Meeting",
                            //    start: moment("2018-08-24"),
...
function GetEmployeeList() {
    var _url = 'Home.aspx/GetEmployees';
    $.ajax({
        type: "POST",
        url: _url,
        async: false,
        ...
        success: function (data) {
            ...
            countTotalemployee = data.countTotalemployee
            Totalemp = data.Totalemp;
            newemp = data.newemp;
            terminatedemp = data.terminatedemp;
            terminatedempprevyear = data.terminatedempprevyear
            ...
            $('#lblterminatedempprevyear').text(terminatedempprevyear);
            $('#lblterminated').text(terminatedemp);
            $('#spCountbday').text(data.countBday);
            $('#spcountemponleave').text(data.countemponleave);
            $('#spcountEmpEndProb').text(data.countEmpEndProb);
            $('#spcountEmpCompletionYear').text(data.countEmpCompletionYear);
            $('#currentyear').text(year);
            $('#currentyear2').text(year);
            $('#currentyear3').text(year);

            var PerTotalActive = (Totalemp / countTotalemployee) * 100;
            var PerTerminated = (terminatedemp / countTotalemployee) * 100;
            var PerNewHired = (newemp / countTotalemployee) * 100;
            var num = ((Totalemp - prevyearactiveemp) / prevyearactiveemp) * 100;
            var strarrw;
            if (num < 0)
                strarrw = '<i class="la la-arrow-down m--font-danger"></i>';
            else
                strarrw = '<i class="la la-arrow-up m--font-success">';
            var Activediff = (Math.round((num * 1000) / 10) / 100).toFixed(2) ;
            Activediff = Activediff + '% ' + strarrw;
            num = ((newemp - newempprevyear) / newempprevyear) * 100;
            if (num < 0)
                strarrw = '<i class="la la-arrow-down m--font-danger"></i>';
            else
                strarrw = '<i class="la la-arrow-up m--font-success">';
            var Hireddiff = (Math.round((num * 1000) / 10) / 100).toFixed(2) ;
            Hireddiff = Hireddiff + '% ' + strarrw;
            num = ((terminatedemp - terminatedempprevyear) / terminatedempprevyear) * 100;
            if (num < 0)
                strarrw = '<i class="la la-arrow-down m--font-danger"></i>';
            else
                strarrw = '<i class="la la-arrow-up m--font-success">';
            var Terminateddiff = (Math.round((num * 1000) / 10) / 100).toFixed(2) ;
            Terminateddiff = Terminateddiff + '% ' + strarrw;
            $("#dvAllactiveEmployess").width(PerTotalActive + '%')
            $("#dvTerminatedEmployee").width(PerTerminated + '%')
            $("#dvNewHiredEmployee").width(PerNewHired + '%')
            $("#spActiveDiff").html(Activediff)
            $("#spHiredDiff").html(Hireddiff)
            $("#spTermintedDiff").html(Terminateddiff)
...
function addRemoveClassToheaders(_this) {
    $('#m_calendar').find('.fc-header-toolbar .fc-center .fc-button').removeClass('fc-state-active');
