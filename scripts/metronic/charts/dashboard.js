...
var Dashboard = function() {
    ...
    var bandwidthChart4 = function () {
        if ($('#m_chart_bandwidth4').length == 0) {
            return;
        }

        var ctx = document.getElementById("m_chart_bandwidth4").getContext("2d");

        var gradient = ctx.createLinearGradient(0, 0, 0, 240);
        gradient.addColorStop(0, Chart.helpers.color('#a4e0fb').alpha(1).rgbString());
        gradient.addColorStop(1, Chart.helpers.color('#a4e0fb').alpha(0.3).rgbString());
