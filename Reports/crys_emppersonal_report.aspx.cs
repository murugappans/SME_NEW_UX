...
{
    public partial class crys_emppersonal_report : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PrintReport.aspx?QS=EMPPERSONALREPORT~empcode|" + cmbEmp.Value + "~compid|" + compid);
        }
    }
}