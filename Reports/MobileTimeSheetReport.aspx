<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MobileTimeSheetReport.aspx.cs" Inherits="SMEPayroll.Reports.MobileTimeSheetReport" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Mobile Timesheet Report</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Mobile Timesheet Report</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="search-box padding-tb-10 clearfix no-margin">
                                <div class="form-inline col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="textfields form-control input-sm" ID="reportId" DataTextField="ReportName"
                                            DataValueField="ID" runat="server">
                                            <asp:ListItem Value="1" Text="Late Report"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Absent Report"></asp:ListItem>
                                            <asp:ListItem Value="3" Text="UserStatus Report"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $("#btnExportWord,#btnExportExcel,#btnExportPdf").click(function () {
                if ($('#RadGrid2_ctl00 tbody tr').length < 1)
                    return false;
            });
