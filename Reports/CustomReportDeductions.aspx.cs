...
{
    public partial class CustomReportDeductions : System.Web.UI.Page
    {
        static int s = 0;
        string compid;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sql = "select id, description from dbo.ViewDeductions  WHERE ID in (" + Session["SesSql"].ToString() + ")";
