...
{
    public partial class crys_empjobdetails_report : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PrintReport.aspx?QS=empjobreport~empcode|" + cmbEmp.Value + "~compid|" + compid);
        }
    }
}
