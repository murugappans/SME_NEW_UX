...
{
    public partial class crys_empcertdetails_report : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PrintReport.aspx?QS=empcertsreport~empcode|" + cmbEmp.Value + "~compid|" + compid);
        }
    }
}