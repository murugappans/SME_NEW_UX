...
{
    public partial class crys_empsaldetails_report : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string sSQL = "select emp_code, emp_name+' '+emp_lname 'emp_name' from employee where company_id = {0} order by emp_name";
        ...
        {
            Response.Redirect("PrintReport.aspx?QS=empsalaryreport~empcode|" + cmbEmp.Value + "~compid|" + compid);
        }
    }
}