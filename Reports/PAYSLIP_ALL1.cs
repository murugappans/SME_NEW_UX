...
namespace SMEPayroll.Reports {
    ...
    public class PAYSLIP_ALL1 : ReportClass {
    ...
    public class CachedPAYSLIP_ALL1 : Component, ICachedReport {
        
        public CachedPAYSLIP_ALL1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PAYSLIP_ALL1 rpt = new PAYSLIP_ALL1();
            rpt.Site = this.Site;
            return rpt;
        }
