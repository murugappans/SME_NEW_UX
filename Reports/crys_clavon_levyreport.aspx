<%@ Page Language="C#" AutoEventWireup="true" Codebehind="crys_clavon_levyreport.aspx.cs"
    Inherits="SMEPayroll.Reports.crys_clavon_levyreport" %>
                ...
                <tr>
                    <td>
                        <table cellspacing="2" cellpadding="2" width="100%">
                            <tr>
                                <td bgcolor="<% =sHeadingColor %>" colspan="2">
                                    <b><font class="colheading">&nbsp;&nbsp;LEVY REPORT</font></b>
                                </td>
                            </tr>
                            <tr bgcolor="<% =sOddRowColor %>" align="center">
                                <td valign="middle">
                                    ...
                                    <asp:Button ID="bnsubmit" runat="server" class="textfields" Text="Generate" Style="height: 22px;
                                        width: 90px" OnClick="bnsubmit_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
