...
namespace SMEPayroll.Reports {
    ...
    public class PAYSLIP_ALL_TimeSheet : ReportClass {
        
        public PAYSLIP_ALL_TimeSheet() {
        }
        
        public override string ResourceName {
            get {
                return "PAYSLIP_ALL_TimeSheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPAYSLIP_ALL_TimeSheet : Component, ICachedReport {
        
        public CachedPAYSLIP_ALL_TimeSheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PAYSLIP_ALL_TimeSheet rpt = new PAYSLIP_ALL_TimeSheet();
            rpt.Site = this.Site;
            return rpt;
        }
