...
{
    public partial class Girofile_MidSalary : System.Web.UI.Page
    {
        ...
        {
            Session["ROWYEAR"] = cmbYear.SelectedValue != "-1" ? cmbYear.SelectedValue : DateTime.Now.Year.ToString();
            bindMonth();
        ...
        protected void btngenerate_Click(object sender, EventArgs e)
        {
            ...
            if (PayrollProcesed.Length > 0)
            {
                ...
                _actionMessage = "Warning|Payroll is already Processed";
