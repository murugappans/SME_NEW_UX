<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonReportView.aspx.cs" Inherits="SMEPayroll.Reports.CommonReportView" %>
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b> <asp:Label ID="lblReportName" runat="server" ></asp:Label></b></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
