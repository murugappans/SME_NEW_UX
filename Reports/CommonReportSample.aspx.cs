...
{
    public partial class CommonReportSample : System.Web.UI.Page
    {
        int compid;
        ...
        {
            ExportToExcel(sqlRptDs, 0, Response, "CommonReports");
            empResults.ExportSettings.ExportOnlyData = true;
            empResults.ExportSettings.IgnorePaging = true;
            empResults.ExportSettings.OpenInNewWindow = true;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            lblReportName.Text = Session["TemplateName"].ToString();
            lblTitleReportName.Text = "CommonReports";
