<%@ Page Language="C#" AutoEventWireup="true" Codebehind="GirofileMC.aspx.cs" Inherits="SMEPayroll.Reports.GirofileMC" %>
...
<body style="margin-left: auto">
    <form id="form1" runat="server">
            ...
            <tr>
                <td>
                    <radG:RadGrid AllowPaging="false" Width="99%" AllowFilteringByColumn="True" ID="RadGrid1"
                        ...
                        <mastertableview autogeneratecolumns="False" datakeynames="emp_id" 
                            ...
                            <Columns>
                                ...
                                <radG:GridBoundColumn DataField="GrossPay" HeaderText="GrossPay" CurrentFilterFunction="StartsWith"
                                ...
                                <radG:GridBoundColumn DataField="netpay" HeaderText="Trns Amt" CurrentFilterFunction="StartsWith"
                                    AutoPostBackOnFilter="True"  UniqueName="netpay">
                                </radG:GridBoundColumn>
                                
                                <radG:GridBoundColumn DataField="PaymentType"  Visible="false" HeaderText="PaymentType" 
                                    AutoPostBackOnFilter="True" SortExpression="PaymentType" UniqueName="PaymentType">
                                </radG:GridBoundColumn>
                                <radG:GridBoundColumn DataField="CurrencyBank" Visible="true" HeaderText="CurrencyBank" 
                                    AutoPostBackOnFilter="True"  UniqueName="CurrencyBank">
                                </radG:GridBoundColumn>
                                <radG:GridBoundColumn DataField="PaymentPart" HeaderText="PaymentPart"  Visible="false"
                                    AutoPostBackOnFilter="True"  UniqueName="PaymentPart">
                                </radG:GridBoundColumn>
                                
                                <radG:GridBoundColumn DataField="SD" HeaderText="SD" Visible="false"
                                    AutoPostBackOnFilter="True"  UniqueName="SD">
                                </radG:GridBoundColumn>
                                <radG:GridBoundColumn DataField="ED" HeaderText="ED" Visible="false"
                                    AutoPostBackOnFilter="True"  UniqueName="ED">
                                </radG:GridBoundColumn>
                                
                                <radG:GridBoundColumn DataField="created_on" HeaderText="created_on"  Visible="false"
                                    AutoPostBackOnFilter="True"  UniqueName="created_on">
                                </radG:GridBoundColumn>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="sp_get_giro_emp_MC"
