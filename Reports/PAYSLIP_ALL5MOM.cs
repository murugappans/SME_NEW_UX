...
namespace SMEPayroll.Reports {
    ...
    public class PAYSLIP_ALL5MOM : ReportClass {
        
        public PAYSLIP_ALL5MOM() {
        }
        
        public override string ResourceName {
            get {
                return "PAYSLIP_ALL5MOM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPAYSLIP_ALL5MOM : Component, ICachedReport {
        
        public CachedPAYSLIP_ALL5MOM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PAYSLIP_ALL5MOM rpt = new PAYSLIP_ALL5MOM();
            rpt.Site = this.Site;
            return rpt;
        }
