...
{
    public partial class crys_empaddress_report : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("PrintReport.aspx?QS=empaddressreport~empcode|" + cmbEmp.Value + "~compid|" + compid);
        }
    }
}