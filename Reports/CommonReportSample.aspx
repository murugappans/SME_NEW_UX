<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonReportSample.aspx.cs" Inherits="SMEPayroll.Reports.CommonReportSample" %>
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Template Name:</b> <asp:Label ID="lblReportName" runat="server" ></asp:Label></font>
                            </td>
                        </tr>
                        <tr bgcolor="#E5E5E5">
                            ...
                            <td valign="middle" align="left" style="background-image: url(images/Reports/exporttowordl.jpg)">
                                ...
                                <asp:ImageButton ID="btnExportPdf" AlternateText="Export To PDF" OnClick="btnExportPdf_click"
                                    runat="server" ImageUrl="~/frames/images/Reports/exporttopdf.jpg" />
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    Report Name: <asp:Label ID="lblTitleReportName" Font-Size="Small"  runat="server" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    Report Period:<asp:Label ID="lblReportPeriod" Font-Size="Small" runat="server" />
                            </td>
