<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonReportsMain.aspx.cs" Inherits="SMEPayroll.Reports.CommonReportsMain" %>
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="tabbable-line margin-bottom-30">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="javascript:;" data-target="#Allreporttab" data-toggle="tab">All Reports</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Employeetab" data-toggle="tab">Employee</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Leavetab" data-toggle="tab">Leave</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#TStab" data-toggle="tab">Timesheet</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Additiontab" data-toggle="tab">Addition</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Deductiontab" data-toggle="tab">Deduction</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Claimtab" data-toggle="tab">Claim</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Payrolltab" data-toggle="tab">Payroll</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Costingtab" data-toggle="tab">Costing</a>
                                    </li>
                                     <li>
                                        <a href="javascript:;" data-target="#Groupingtab" data-toggle="tab">Grouping</a>
                                     </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Variancetab" data-toggle="tab">Variance</a>
                                     </li>
                                     <li>
                                        <a href="javascript:;" data-target="#Othertab" data-toggle="tab">Other</a>
                                    </li>
                                </ul>
                            </div>

                            <div class="tab-content">
                                <div class="tab-pane active" id="Allreporttab" runat ="server">
                                    
                                </div>
                                <div class="tab-pane" id="Employeetab" runat ="server">
                                </div>
                                 <div class="tab-pane" id="Leavetab" runat ="server">
                                </div>
                                <div class="tab-pane" id="TStab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Additiontab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Deductiontab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Claimtab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Payrolltab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Costingtab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Groupingtab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Variancetab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Othertab" runat ="server">
                                </div>
                            </div>
