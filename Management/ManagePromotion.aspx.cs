    ...
    public partial class ManagePromotion : System.Web.UI.Page
    {
        ...
        void RadGrid1_ItemCreated(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridEditableItem && e.Item.IsInEditMode)
            {
                ...
                GridTextBoxColumnEditor Designation = (GridTextBoxColumnEditor)item.EditManager.GetColumnEditor("HistoryDetails");
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                string sSQL = "DELETE FROM [EmpHistoryRecordMaster] WHERE [id] =" + id;

                int retVal = DataAccess.ExecuteStoreProc(sSQL);

                if (retVal == 1)
                {
                    RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>EmpHistoryRecord is Deleted Successfully."));

                }
                else
                {
                    RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the EmpHistoryRecord."));
                }
        ...
        protected void RadGrid1_ItemInserted(object source, GridInsertedEventArgs e)
        {
            ...
            {
                DisplayMessage("Employee History added successfully.");
            }
        }
        protected void RadGrid1_ItemUpdated(object source, GridUpdatedEventArgs e)
        {
            ...
            {
                DisplayMessage("Employee History updated successfully.");
            }
        }
