<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentAssignment.aspx.cs"
    Inherits="SMEPayroll.Management.DepartmentAssignment" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Department Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div class="search-box clearfix padding-tb-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList OnDataBound="drpSubProjectID_databound"
                                        ID="drpSubProjectID" DataTextField="DeptName" DataValueField="ID" DataSourceID="SqlDataSource3"
                            ...
                            <div class="row padding-tb-20">
                                                        ...
                                                        <MasterTableView AllowAutomaticUpdates="True" PagerStyle-AlwaysVisible="true" PagerStyle-Mode="NumericPages"
                                                            ...
                                                            <Columns>
                                                                <radG:GridBoundColumn Display="false" ReadOnly="True" DataField="Emp_Code" DataType="System.Int32"
                                                                    UniqueName="Emp_Code" Visible="true" ShowFilterIcon="false" FilterControlAltText="" SortExpression="Emp_Code" HeaderText="Emp_Code">
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                                ...
                                                                <radG:GridBoundColumn ReadOnly="True" DataField="Time_Card_NO" DataType="System.String"
                                                                    UniqueName="Time_Card_NO" Visible="true" ShowFilterIcon="false" FilterControlAltText="cleanstring" SortExpression="Time_Card_NO" HeaderText="Time Card NO" AllowFiltering ="true" AutoPostBackOnFilter ="true" >
                                                                </radG:GridBoundColumn>

                                                                <radG:GridBoundColumn DataField="Name" DataType="System.String" AllowFiltering="true"
                                                                    AutoPostBackOnFilter="true" UniqueName="Name" Visible="true" ShowFilterIcon="false" FilterControlAltText=" alphabetsonly" SortExpression="Name"
                                                                    HeaderText="Unassigned Employee Name">
                                                                    <ItemStyle HorizontalAlign="left" />
                                                                </radG:GridBoundColumn>
                                                                <radG:GridBoundColumn DataField="Trade" AllowFiltering="true"
                                                                    AutoPostBackOnFilter="true" UniqueName="Trade" Visible="true" ShowFilterIcon="false" FilterControlAltText="alphabetsonly" SortExpression="Trade"
                                                                    HeaderText="Trade">
                                                                    <ItemStyle HorizontalAlign="left" />
                                                                </radG:GridBoundColumn>
                                                            </Columns>
                                            ...
                                            Visible="true" ShowFilterIcon="false" FilterControlAltText="" SortExpression="Emp_Name" HeaderText="Employee Name">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="SELECT  Time_Card_No,EMP_CODE,EMP_NAME +' ' +EMP_LNAME AS NAME,(select trade from trade where id=Trade_id) as Trade FROM employee WHERE TERMINATION_DATE IS NULL AND (DEPT_ID IS NULL Or DEPT_ID=0) AND COMPANY_ID= @company_id  Order By Emp_Name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT  Time_Card_No,EMP_CODE,EMP_NAME +' ' +EMP_LNAME AS NAME,(select trade from trade where id=Trade_id) as Trade FROM employee WHERE TERMINATION_DATE IS NULL AND DEPT_ID=@deptId AND COMPANY_ID=@company_id  Order By Emp_Name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                            <asp:ControlParameter ControlID="drpSubProjectID" Name="deptId" PropertyName="SelectedValue"
                                                Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $("#buttonAdd").click(function () {
            if ($("#drpSubProjectID").val() == "-1")
            {
                WarningNotification("Select Department first");
                return false;
            }
            var _msg = "";
