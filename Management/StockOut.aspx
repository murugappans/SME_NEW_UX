<%@ Page Language="C#" AutoEventWireup="true" Codebehind="StockOut.aspx.cs" Inherits="SMEPayroll.Management.StockOut" %>
...
<body style="margin-left: auto">
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Stock Out</b></font>
                            </td>
                        </tr>
        ...
        <div>
                        ...
                        <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                            ...
                            <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="ID">
                                ...
                                <Columns>
                                    ...
                                    <radG:GridDropDownColumn EditFormColumnIndex="2" DropDownControlType="DropDownList"
                                    ...
                                    <radG:GridDropDownColumn EditFormColumnIndex="2" DropDownControlType="DropDownList"
                                        DataField="TypeofStock" DataSourceID="SqlDataSource5" HeaderText="Type" ListTextField="TypeDesc"
                                        ListValueField="Typeof" UniqueName="drpTypeOfStock">
                                        <ItemStyle Width="30%" HorizontalAlign="Left" />
                                    </radG:GridDropDownColumn>
                                ...
                                <EditFormSettings ColumnNumber="3">
                                    ...
                                    <EditColumn ButtonType="ImageButton" InsertText="Add New Stock Out" UpdateText="Update"
                                        UniqueName="EditCommandColumn1" CancelText="Cancel Edit">
                                    </EditColumn>
                                    <FormTableButtonRowStyle HorizontalAlign="Right" CssClass="EditFormButtonRow"></FormTableButtonRowStyle>
                                </EditFormSettings>
                                <CommandItemSettings AddNewRecordText="Add New Stock Out" />
                            </MasterTableView>
                            <ClientSettings>
            ...
            <center>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="Select SO.ID, Convert(varchar, TransactionDate,105) TransactionDate,TransactionDate TransactionDateCopy, SO.StoreID,SO.ItemID,SO.Quantity,SO.Emp_ID,SO.ProjectID,SO.Remarks, G.StoreName, I.ItemName,(E.Emp_Name + ' ' + E.Emp_Lname) EmpName,SP.Sub_Project_Name,SO.TypeofStock From StockOut SO  Inner Join Store G On SO.StoreID = G.ID Inner Join Item I On SO.ItemID = I.ID Left Outer Join Employee E On SO.Emp_ID=E.Emp_Code Left Outer Join SubProject SP On SO.ProjectID=SP.ID Where SO.Company_ID=@company_id">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="select   0 ID, '--Select--' ItemName Union ALL select ID,ItemName from [Item] where company_Id=@company_id">
                    <SelectParameters>
                        <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                    </SelectParameters>
                </asp:SqlDataSource>
