<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSetting.aspx.cs" Inherits="SMEPayroll.Management.ManageSetting" %>
                        ...
                        <form id="form2" runat="server">
                            ...
                            <div class="tabbable-line margin-bottom-30">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li>
                                        <a href="javascript:;" data-target="#Leavetab" data-toggle="tab">Leaves</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#TStab" data-toggle="tab">Timesheets</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Additiontab" data-toggle="tab">Additions</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Deductiontab" data-toggle="tab">Deductions</a>
                                    </li>
                                    <li>
                                        <a href="javascript:;" data-target="#Claimtab" data-toggle="tab">Claims</a>
                                    </li>
                                    <li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="report_tab_1">
                                    <div class="detail">
                                        <h3><a href="CommonReportsInner.aspx">Lorem ipsum dolor sit amet</a></h3>
                            ...
                            <%--<radG1:RadScriptManager ID="RadScriptManager2" runat="server">
