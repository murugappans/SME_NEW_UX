...
{
    public partial class GiroAssignment : System.Web.UI.Page
    {
        ...
        {
            drpSubProjectID.Items.Insert(0, new ListItem("-select-", "0"));
            drpSubProjectID.Items.Insert(1, new ListItem("Cash", "-1"));
            drpSubProjectID.Items.Insert(2, new ListItem("Cheque", "-2"));
                ...
                if (dr.Read())
                {
                    ...
                    else
                    {
                        ...
                        if (retVal >= 1)
                        {
                            ...
                            _actionMessage = "sc|Department Assigned is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                            RadGrid2.Rebind();
                            RadGrid1.Rebind();
                        }
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "0")
            {
                int i = 0;
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    parms[1] = new SqlParameter("@Paymode", Utility.ToInteger(drpSubProjectID.SelectedItem.Value));
                    ...
                    if (retVal >= 1)
                    {
                        ...
                        _actionMessage = "sc|Bank "+ strActionMsg + " Successfully.";
                        ViewState["actionMessage"] = _actionMessage;
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    }
                    ...
                    {
                        //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to " + strActionMsg + " Bank."));
                        _actionMessage = "Warning|Unable to "+ strAction + " Bank.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                }
                else
            ...
            {
                //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Please select  Bank."));
                _actionMessage = "Warning|Please select  Bank.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
    }
