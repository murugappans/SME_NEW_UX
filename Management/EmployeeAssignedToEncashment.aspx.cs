...
{
    public partial class EmployeeAssignedToEncashment : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            EncashType_dataSource.ConnectionString = Session["ConString"].ToString();
            FarmulaID_dataSource.ConnectionString = Session["ConString"].ToString();
            //SqlDataSource3.ConnectionString = Session["ConString"].ToString();

        }
        protected void drpTypeID_databound(object sender, EventArgs e)
        {
            FarmulaID.Items.Insert(0, new ListItem("-select-", "-1"));
        }
                ...
                if (dr.Read())
                {
                    ...
                    else
                    {
                        ...
                        if (retVal >= 1)
                        {
                            ...
                            _actionMessage = "sc|Project Assigned is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                            RadGrid2.Rebind();
                            RadGrid1.Rebind();
                        }
...
//ErrMsg = "<font color = 'Red'>Record can not be deleted becuase of REFERENCE constraint. This record is called in other tables</font>";
        ...
        protected void buttonSave_click(object sender, EventArgs e)
        {
            ...
            string strAction = ((Button)sender).Text;
                ...
                ViewState["actionMessage"] = "Success|Fixed amount for assigned employees saved successfully.";
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (EncashTypeID.SelectedItem.Value.ToString() != "-1")
            {
                int i = 0;
                ...
                foreach (GridItem item in rd.MasterTableView.Items)
                {
                    if (item is GridItem)
                    {
                        ...
                        if (chkBox.Checked == true)
                        {
                            ...
                            strEmployee = strEmployee + "," + labelId.Text.ToString().Trim();
                        }
                    }
                }
                ...
                if (strEmployee.Length > 0 && strEmployee  != "0")
                {
                    ...
                    parms[1] = new SqlParameter("@TypeID", Utility.ToInteger(EncashTypeID.SelectedItem.Value));
                    parms[2] = new SqlParameter("@FormulaID", Utility.ToInteger(FarmulaID.SelectedItem.Value));
