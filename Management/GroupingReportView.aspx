<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupingReportView.aspx.cs" Inherits="SMEPayroll.Management.GroupingReportView" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="../Management/GroupManagement.aspx">Manage Grouping Assignment</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>Grouping Report</span>
                        </li>
                    </ul>
                </div>
                <!-- END PAGE BAR -->
                        ...
                        <form id="employeeform" runat="server" method="post">
                            ...
                            <div class="clearfix">
                                ...
                                <div class="text-right col-md-6">
                                    <asp:ImageButton ID="btnExportWord" CssClass="btn" AlternateText="Export To Word" OnClick="btnExportWord_click"
                                        runat="server" ImageUrl="~/frames/images/Reports/exporttoWordl.jpg" />
                                    <asp:ImageButton ID="btnExportExcel" CssClass="btn" AlternateText="Export To Excel" OnClick="btnExportExcel_click"
                                        runat="server" ImageUrl="~/frames/images/Reports/exporttoexcel.jpg" />
                                    <asp:ImageButton ID="btnExportPdf" CssClass="btn" AlternateText="Export To PDF" OnClick="btnExportPdf_click"
