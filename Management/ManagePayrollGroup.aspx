            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Manage Workflow Group</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Payroll Group</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
...
<%--<div class="search-box clearfix">
            ...
            <radG:RadCodeBlock ID="RadCodeBlock1" runat="server">
                        ...
                        <radG:RadGrid ID="RadGrid1"  runat="server" AutoGenerateColumns="false" OnUpdateCommand="RadGrid1_UpdateCommand" OnItemCommand="RadGrid1_ItemCommand"
                            OnInsertCommand="RadGrid1_InsertCommand" OnDeleteCommand="RadGrid1_DeleteCommand"
                            PageSize="20"
                            DataSourceID="SqlDataSource1" 
                            GridLines="None" Skin="Outlook" PagerStyle-Mode="NextPrevAndNumeric" AllowSorting="true" >
                            
                            <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="id" CommandItemDisplay="Bottom" TableLayout="Auto" PagerStyle-Mode="Advanced">
                          ...
                          <ItemStyle Height="25px" VerticalAlign="middle" Wrap="false"  />
                                <Columns>
                                    ...
                                    <radG:GridBoundColumn DataField="GroupName" UniqueName="GroupName1"   SortExpression="GroupName"
                                        HeaderText="Group Name" >
                                        <%--<HeaderStyle Width="65%" />
                                        <ItemStyle Width="65%" HorizontalAlign="Left" />--%>
                                    </radG:GridBoundColumn>
                                                                   
                                     <radG:GridBoundColumn DataField="WorkflowtyprID" UniqueName="WorkflowtyprID1" SortExpression="WorkflowtyprID"
                                        HeaderText="Workflow Type"  >
                                        <%--<HeaderStyle Width="10%" />
                                        <ItemStyle Width="10%" HorizontalAlign="Left" />--%>
                                    </radG:GridBoundColumn>                
                              
                                    <radG:GridEditCommandColumn ButtonType="ImageButton" UniqueName="EditColumn" HeaderText="Edit" >
                                    ...
                                    <radG:GridButtonColumn  ConfirmDialogType="RadWindow"
                                        ...
                                        <ItemStyle Width="60px" HorizontalAlign="Center" CssClass="MyImageButton clsCnfrmButton" />
                                        <HeaderStyle Width="60px" HorizontalAlign="Center" />
                                    </radG:GridButtonColumn>
                                </Columns>
                                <EditFormSettings UserControlName="PayrollgroupMng.ascx" EditFormType="WebUserControl" >
                                </EditFormSettings>
 ...
 From PayrollGroup P Where P.Company_ID=@company_id">
                <SelectParameters>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $(".clsCnfrmButton").click(function () {
            ...
            GetConfirmation("Are you sure you want to delete this Payroll Group?", _id, "Confirm Delete", "Delete");
        });
