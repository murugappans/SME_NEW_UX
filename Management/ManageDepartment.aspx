                                    ...
                                    <EditFormSettings EditFormType="Template">
                                        <FormTemplate>
                                            <div class="clearfix form-style-inner">
                                                <div class="heading">
                                                   <%-- <span class="form-title">Add New Department</span>--%>
                                                    <asp:label ID="Department" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Department" : "Edit Department" %>'
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="form-body">
                                                            <div class="form-group clearfix">
                                                                ...
                                                                <asp:TextBox ID="TextBox1" CssClass="textfields form-control inline input-sm input-medium cleanstring custom-maxlength _txtdept" MaxLength="50" runat="server" Text='<%# Bind("DeptName") %>'></asp:TextBox>

                                                            </div>
                                                            <div class="form-group clearfix">
                                                            <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertdept" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    <script type="text/javascript">
        ...
        $(".clsCnfrmButton").click(function () {
            ...
            GetConfirmation("Are you sure you want to delete this Department?", _id, "Confirm Delete", "Delete");
        });
        ...
        function validatedept() {
            var _message = "";
            if ($.trim($("._txtdept").val()) === "")
                _message += "Please Input Department <br>";
            if (_message != "") {
