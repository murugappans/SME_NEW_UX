...
namespace SMEPayroll.Management
{
    ...
    public partial class EmployeeCeilingDetails : System.Web.UI.Page
    {
        int intValid = 0;
        int iSearch = 0;
        bool blnValid = false;
        ...
        {
            string strEmpceliling = "Select * from CeilingMaster Where CompanyID=" + compid;
            DataSet EmpCel = new DataSet();
            EmpCel = DataAccess.FetchRS(CommandType.Text, strEmpceliling, null);
            ...
            if (e.Item is GridHeaderItem)
            {
               GridHeaderItem headerItem = (GridHeaderItem)e.Item;
                ...
                foreach (DataRow dr in EmpCel.Tables[0].Rows)
                {
                    if (dr[4].ToString().Trim().ToUpper() == "C1")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[6].Text = dr[1].ToString().Trim().ToUpper() + "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[6].Text = dr[1].ToString().Trim().ToUpper() + "(Amount)";
                        }
                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C2")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[7].Text = dr[1].ToString().Trim().ToUpper() + "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[7].Text =dr[1].ToString().Trim().ToUpper() + "(Amount)";
                        }

                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C3")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[8].Text = dr[1].ToString().Trim().ToUpper()  +"(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[8].Text = dr[1].ToString().Trim().ToUpper()  + "(Amount)";
                        }
                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C4")
                    {

                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[9].Text = dr[1].ToString().Trim().ToUpper() +"(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[9].Text = dr[1].ToString().Trim().ToUpper() + "(Amount)";
                        }
                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C5")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[10].Text = dr[1].ToString().Trim().ToUpper() + "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[10].Text = dr[1].ToString().Trim().ToUpper()  +"(Amount)";
                        }
                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C6")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[11].Text = dr[1].ToString().Trim().ToUpper() + "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[11].Text = dr[1].ToString().Trim().ToUpper() +"(Amount)";
                        }

                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C7")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[12].Text = dr[1].ToString().Trim().ToUpper() +  "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[12].Text = dr[1].ToString().Trim().ToUpper() +   "(Amount)";
                        }
                    }
                    if (dr[4].ToString().Trim().ToUpper() == "C8")
                    {
                        if (dr[2].ToString() == "1")
                        {
                            headerItem.Cells[13].Text = dr[1].ToString().Trim().ToUpper() +  "(Hours)";
                        }
                        else
                        {
                            headerItem.Cells[13].Text = dr[1].ToString().Trim().ToUpper() +  "(Amount)";
                        }
                    }
                }
            }
            ...
            if (e.Item is GridDataItem)
            {
                ...
                TextBox txtNH = (TextBox)item["NH"].FindControl("txtNH");
                TextBox txtOT1 = (TextBox)item["OT1"].FindControl("txtOT1");
                TextBox txtOT2 = (TextBox)item["OT2"].FindControl("txtOT2");
                TextBox txtDays = (TextBox)item["Days"].FindControl("txtDays");
                TextBox txtV1 = (TextBox)item["V1"].FindControl("txtV1");
                TextBox txtV2 = (TextBox)item["V2"].FindControl("txtV2");
                TextBox txtV3 = (TextBox)item["V3"].FindControl("txtV3");
                TextBox txtV4 = (TextBox)item["V4"].FindControl("txtV4");
                ...
                string ceilingcolumns = "Select * from CeilingMaster Where CeilingType IN (1,2) AND CompanyID=" + compid;
                DataSet ceilColumns = new DataSet();
                ceilColumns = DataAccess.FetchRS(CommandType.Text, ceilingcolumns, null);
                string parameter = "";
                foreach (DataRow dr1 in ceilColumns.Tables[0].Rows)
                {
                    parameter = dr1[4].ToString();

                    if (parameter.Trim().ToUpper() == "C1")
                    {
                        txtNH.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C2")
                    {
                        txtOT1.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C3")
                    {
                        txtOT2.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C4")
                    {
                        txtDays.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C5")
                    {
                        txtV1.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C6")
                    {
                        txtV2.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C7")
                    {
                        txtV3.Enabled = true;
                    }
                    else if (parameter.Trim().ToUpper() == "C8")
                    {
                        txtV4.Enabled = true;
                    }
                }
                ...
                //foreach (DataRow dr in EmpCel.Tables[0].Rows)
                //{
                //    if (dr[1].ToString().Trim().ToUpper() == "NH")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[6].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[6].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "OT1")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[7].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[7].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "OT2")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[8].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[8].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "Days")
                //    {

                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[9].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[9].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "V1")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[10].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[10].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "V2")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[11].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[11].BackColor = Color.LightSlateGray;
                //        }

                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "V3")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[12].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[12].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //    if (dr[1].ToString().Trim().ToUpper() == "V4")
                //    {
                //        if (dr[2].ToString().Trim().ToUpper() == "1")
                //        {
                //            item.Cells[13].BackColor = Color.LightGray;
                //        }
                //        else
                //        {
                //            //item.Cells[13].BackColor = Color.LightSlateGray;
                //        }
                //    }
                //}
                ...
                //        {
                //            txtV1.Enabled = false;
                //            txtV1.BackColor = Color.LightLightGray;
                //        }

                //        if (strV2 == "V2") //|| strV2 == "V2" || strV3 == "V3" || strV4 == "V4")
                //        {
                //            txtV2.Enabled = false;
                //            txtV2.BackColor = Color.LightLightGray;
                //        }

                //        if (strV3 == "V3") //|| strV2 == "V2" || strV3 == "V3" || strV4 == "V4")
                //        {
                //            txtV3.Enabled = false;
                //            txtV3.BackColor = Color.LightLightGray;
                //        }

                //        if (strV4 == "V4") //|| strV2 == "V2" || strV3 == "V3" || strV4 == "V4")
                //        {
                //            txtV4.Enabled = false;
                //            txtV4.BackColor = Color.LightLightGray;
                //        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            AjaxPro.Utility.RegisterTypeForAjax(typeof(EmployeeCeilingDetails));
        ...
        void btnSubApprove_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               // lblMsg.Text = "TimeSheet Update/Approve Successfully.";
                ViewState["actionMessage"] = "Success|TimeSheet Update/Approve Successfully.";
            }
            catch(Exception ex)
            {
                lblMsg.Text = "";
               // lblMsg.Text = "Update/Approve Fails";
                ViewState["actionMessage"] = "Warning|Update/Approve Fails";
            }
        }
            ...
            if (Session["DS1"] != null)
            {
                ...
                try
                {
                    ...
                    if (intUpdate > 0 || intInsert > 0)
                    {
                        ...
                        ViewState["actionMessage"] = "Success|Data Unlock SuccessFully..";
                        Session["Unlock"] = "true";
                    }
                }
                catch (Exception ex)
                {
                    ...
                    ViewState["actionMessage"] = "Warning|Data Not Unlocked..";
        ...
        public void bindgrid()
        {
            ...
            {
                if (deptID.SelectedValue == "-1")
                {
                    sql = "Select *,EMPLOYEE.emp_name ,0.00 NH,0.00  OT1,0.00  OT2,0.00  Days,0.00  V1,0.00  V2,0.00  V3,0.00  V4,EMPLOYEE.time_card_no,department.DeptName     from CeilingEmployee INNER JOIN EMPLOYEE ON CeilingEmployee.EmpCode=EMPLOYEE.emp_code INNER JOIN department ON department.id=EMPLOYEE.dept_id   Where CompanyID=" + compid + " order by EMPLOYEE.emp_name Asc";
                }
                else
                {
                    sql = "Select *,EMPLOYEE.emp_name ,0.00 NH,0.00  OT1,0.00  OT2,0.00  Days,0.00  V1,0.00  V2,0.00  V3,0.00  V4,EMPLOYEE.time_card_no,department.DeptName   from CeilingEmployee INNER JOIN EMPLOYEE ON CeilingEmployee.EmpCode=EMPLOYEE.emp_code  INNER JOIN department ON department.id=EMPLOYEE.dept_id Where CompanyID=" + compid + " And  EMPLOYEE.dept_id=" + Convert.ToInt32(deptID.SelectedValue) + " order by EMPLOYEE.emp_name Asc";
                }
            }
            else
            {
                if (deptID.SelectedValue == "-1")
                {
                    sql = "Select *,EMPLOYEE.emp_name ,0.00 NH,0.00  OT1,0.00  OT2,0.00  Days,0.00  V1,0.00  V2,0.00  V3,0.00  V4,EMPLOYEE.time_card_no,department.DeptName     from CeilingEmployee INNER JOIN EMPLOYEE ON CeilingEmployee.EmpCode=EMPLOYEE.emp_code INNER JOIN department ON department.id=EMPLOYEE.dept_id   Where CompanyID=" + compid + " and EMPLOYEE.emp_code IN(SELECT EmployeeID FROM EmployeeAssignedToGroup WHERE GroupID=" + Utility.ToInteger(Session["EmpCode"]) + " AND ValidFrom<=GETDATE()) OR EMPLOYEE.emp_code IN(" + Utility.ToInteger(Session["EmpCode"]) + ") order by EMPLOYEE.emp_name Asc";
                }
                else
                {
                    sql = "Select *,EMPLOYEE.emp_name ,0.00 NH,0.00  OT1,0.00  OT2,0.00  Days,0.00  V1,0.00  V2,0.00  V3,0.00  V4,EMPLOYEE.time_card_no,department.DeptName   from CeilingEmployee INNER JOIN EMPLOYEE ON CeilingEmployee.EmpCode=EMPLOYEE.emp_code  INNER JOIN department ON department.id=EMPLOYEE.dept_id Where CompanyID=" + compid + " And  EMPLOYEE.dept_id=" + Convert.ToInt32(deptID.SelectedValue) + " and EMPLOYEE.emp_code IN(SELECT EmployeeID FROM EmployeeAssignedToGroup WHERE GroupID=" + Utility.ToInteger(Session["EmpCode"]) + " AND ValidFrom<=GETDATE()) OR EMPLOYEE.emp_code IN(" + Utility.ToInteger(Session["EmpCode"]) + ") order by EMPLOYEE.emp_name Asc";
                }
            }
            dsgrid = DataAccess.FetchRS(CommandType.Text, sql, null);
            ...
            string sqlErate = "Select * from dbo.EmployeeCeilingDetails Where EffDate ='" + dtselcdate.Year + "-" + dtselcdate.Month + "-" + dtselcdate.Day + "'";
            ...
            {
                int Emp_Code = Convert.ToInt32(dr["Emp_Code"].ToString());

                //DataRow dr = dsgrid.Tables[0].Rows.se
                DataRow[] dr1 = dsgrid.Tables[0].Select("EmpCode='" + Emp_Code + "'");

                if (dr1.Length == 1)
                {
                    if (dr["NH"].ToString() != "")
                    {
                        dr1[0]["NH"] = Convert.ToDecimal(dr["NH"].ToString());
                    }
                    else {
                        dr1[0]["NH"] = Convert.ToDecimal(0.00);
                    }


                    if (dr["OT1"].ToString() != "")
                    {
                        dr1[0]["OT1"] = Convert.ToDecimal(dr["OT1"].ToString());
                    }
                    else
                    {
                        dr1[0]["OT1"] = Convert.ToDecimal(0.00);
                    }


                    if (dr["OT2"].ToString() != "")
                    {
                        dr1[0]["OT2"] = Convert.ToDecimal(dr["OT2"].ToString());
                    }
                    else
                    {
                        dr1[0]["OT2"] = Convert.ToDecimal(0.00);
                    }


                    if (dr["Days"].ToString() != "")
                    {
                        dr1[0]["Days"] = Convert.ToDecimal(dr["Days"].ToString());
                    }
                    else
                    {
                        dr1[0]["Days"] = Convert.ToDecimal(0.00);
                    }


                    if (dr["V1"].ToString() != "")
                    {
                        dr1[0]["V1"] = Convert.ToDecimal(dr["V1"].ToString());
                    }
                    else
                    {
                        dr1[0]["V1"] = Convert.ToDecimal(0.00);
                    }

                    if (dr["V2"].ToString() != "")
                    {
                        dr1[0]["V2"] = Convert.ToDecimal(dr["V2"].ToString());
                    }
                    else
                    {
                        dr1[0]["V2"] = Convert.ToDecimal(0.00);
                    }

                    if (dr["V2"].ToString() != "")
                    {
                        dr1[0]["V3"] = Convert.ToDecimal(dr["V3"].ToString());
                    }
                    else
                    {
                        dr1[0]["V3"] = Convert.ToDecimal(0.00);
                    }
                    if (dr["V4"].ToString() != "")
                    {
                        dr1[0]["V4"] = Convert.ToDecimal(dr["V4"].ToString());
                    }
                    else
                    {
                        dr1[0]["V4"] = Convert.ToDecimal(0.00);
                    }
                ...
                if (Request.QueryString["PageType"] == null)
                {
                    ...
                    if (stremp == "0" || stremp == "")
                    {
                       ...
                       // lblMsg.Text = strMessage;// +"<br/> " + lblMsg.Text;
                        ViewState["actionMessage"] = "Warning|Please Select Employee.";
                        stremp = "-1";
                ...
                else
                {
                    ...
                    if (Request.QueryString["PageType"] == "2")
                    {
                        ...
                        if (cntOutIn <= 0)
                        {
                            ...
                            ViewState["actionMessage"] = "Warning|"+strMessage ;
                    ...
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (sgroupname == "Super Admin")
                            {
                                ...
                                {
                                    btnApprove.Enabled = false;
                                    //Commented btnApprove.Visible = false;
                                    ////btnUpdate.Enabled = false;
                                    //btnDelete.Enabled = false;
                                    //btnCopy.Enabled = false;
                                    btnUnlock.Enabled = false;
                                    //Commented btnUnlock.Visible = false;
                                }
                                ...
                                if ((Utility.AllowedAction1(Session["Username"].ToString(), "Submit Timesheet for All") == true))
                                {
                                    ...
                                    //btnDelete.Enabled = true;
                                    btnUnlock.Enabled = true;
                                    //Commented  btnUnlock.Visible = true;
                                ...
                                {
                                    btnApprove.Enabled = true;
                                    //Commented   btnApprove.Visible = true;
                                    ////btnUpdate.Enabled = true;
                                    btnUnlock.Enabled = true;
                                    //Commented  btnUnlock.Visible = true;
                                    //btnDelete.Enabled = true;
        ...
        protected void btnEmailApprove_Click(object sender, EventArgs e)
        {
            ...
            if (strMessage.Length > 0)
            {
               // ShowMessageBox(strMessage);
                ViewState["actionMessage"] = "Success|" + strMessage;
                strMessage = "";
        ...
        public void UpdateRec1()
        {
            ...
            if (EmailNeed)//if email is required
            {
                ...
                if (strMessage.Length > 0)
                {
                    ...
                    ViewState["actionMessage"] = "Fixed|Records Updated Successfully </br>  " + strMessage;
                    strMessage = "";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
           ...
           string sqlDelete = "Delete from EmployeeCeilingDetails Where EffDate = '" + dtselcdate.Year + "-" + dtselcdate.Month + "-" + dtselcdate.Day + "'";
           ...
           //Now Update the DataSet as per records exist and new records...
               ...
               foreach (GridItem item in this.RadGrid2.MasterTableView.Items)
               {
                    if (item is GridItem)
                   {
                       ...
                       {
                           int Emp_Code = 0;
                           Emp_Code = Utility.ToInteger(dataItem["EmpCode"].Text.ToString());
                           double NH = Convert.ToDouble(((TextBox)dataItem.FindControl("txtNH")).Text.ToString());
                           double Ot1 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtOt1")).Text.ToString());
                           double Ot2 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtOt2")).Text.ToString());
                           double days = Convert.ToDouble(((TextBox)dataItem.FindControl("txtDays")).Text.ToString());
                           double V1 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtV1")).Text.ToString());
                           double V2 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtV2")).Text.ToString());
                           double V3 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtV3")).Text.ToString());
                           double V4 = Convert.ToDouble(((TextBox)dataItem.FindControl("txtV4")).Text.ToString());

                           string date = dtselcdate.Year + "-" + dtselcdate.Month + "-" + dtselcdate.Day;

                           if (sqlInsert == "")
                           {
                               sqlInsert = "INSERT INTO EmployeeCeilingDetails (Emp_Code,EffDate,NH,OT1,OT2,Days,V1,V2,V3,V4)Values(" + Emp_Code + ",'" + date + "'," + NH + "," + Ot1 + "," + Ot2 + "," + days + "," + V1 + "," + V2 + "," + V3 + "," + V4 + ")";
                           }
                           else
                           {
                               sqlInsert = sqlInsert + ";" + "INSERT INTO EmployeeCeilingDetails (Emp_Code,EffDate,NH,OT1,OT2,Days,V1,V2,V3,V4)Values(" + Emp_Code + ",'" + date + "'," + NH + "," + Ot1 + "," + Ot2 + "," + days + "," + V1 + "," + V2 + "," + V3 + "," + V4 + ")";
                           }
            ...
            if (Session["DS1"] != null)
            {
                ...
                try
                {
                    ...
                    if (intUpdate > 0 || intInsert > 0 )
                    {
                        ...
                        ViewState["actionMessage"] = "Success|Data Approved SuccessFully..";
                        Session["Approve"] = "true";
                    }
                }
                catch (Exception ex)
                {
                   // lblMsg.Text = "Data Not Approved...";
                    ViewState["actionMessage"] = "Warning|Data Not Approved..";
                }
                //Again Rebind The grid ... ... ... 
                //bindgrid();
            }
                ...
                try
                {
                    ...
                    if (intUpdate > 0 || intInsert > 0)
                    {
                       // lblMsg.Text = "Data Updated SuccessFully...";
                        ViewState["actionMessage"] = "Success|Data Updated SuccessFully..";
                    }                    
                }
                catch(Exception ex)
                {
                    //lblMsg.Text = "Data Not Updated ...";
                    ViewState["actionMessage"] = "Warning|Data Not Updated ..";
                }
        ...
        void SaveRecord1(int intCommand)
        {
            ...
            if (strSuccess.ToString().Length <= 0 && blnexception == false && exception != "EX")
            {
                ...
                if (retVal >= 1)
                {
                   ...
                   // lblMsg.Text = strMessage + "<br/> " + lblMsg.Text;
                    ViewState["actionMessage"] = "Success|"+strMessage + "<br/> " + lblMsg.Text;
                ...
                else
                {
                    ...
                    ViewState["actionMessage"] = "Warning|Records updation failed";
                    this.RadGrid2.DataBind();
                }
            }
            else
        ...
        void SaveRecord(int intCommand)
        {
            ...
            if (rosterID == "-1")
            {
              ...
              //  lblMsg.Text = "Please Assign Roster To Employee";
                ViewState["actionMessage"] = "Warning|Please Assign Roster To Employee";
            }
            else
            {
                ...
                if (validate_Flag)
                {
                    ...
                    if (lblMsg.Text.Length > 0)
                    {
                       ...
                       // lblMsg.Text = "Records Update Successfully" + lblMsg.Text;
                        ViewState["actionMessage"] = "Success|Records Update Successfully" + lblMsg.Text;
                    }
                    else
                    {
                        lblMsg.Text = "";
                        lblMsg.Text = "Records Update Successfully";
                        ViewState["actionMessage"] = "Success|Records Update Successfully";
                    }
                ...
                else
                {
                    ...
                    {
                        lblMsg.Text = "";
                        ViewState["actionMessage"] = "Warning|Records Updation Fails." + strMessage + "<br> Please Assign Roster for dates " + strRosterMsg + "<br> Before Actatek Log .";
                       // lblMsg.Text = "Records Updation Fails." + strMessage + "<br> Please Assign Roster for dates " + strRosterMsg + "<br> Before Actatek Log .";
                    }
                    else
                    {
                        lblMsg.Text = "";
                        ViewState["actionMessage"] = "Warning|Records Updation Fails." + strMessage;
        ...
        void Page_PreRender(Object sender, EventArgs e)
        {
            ...
            if (sgroupname == "Super Admin")
            {
                ...
                if ((Utility.AllowedAction1(Session["Username"].ToString(), "Approve Timesheet for All") == true) || (Utility.AllowedAction1(Session["Username"].ToString(), "Approve Timesheet") == true))
                {
                    ...
                    //Commented      btnUnlock.Visible = true;
                    btnSubApprove.Enabled = true;
                    //Commented     btnSubApprove.Visible = true;
                    //btnDelete.Enabled = true;
                }
            ...
            if (sgroupname != "Super Admin")
            {
                ...
                if ((Utility.AllowedAction1(Session["Username"].ToString(), "Submit Timesheet for All") == true))
                {
                    ...
                    //Commented      btnUnlock.Visible = true;
                    btnDelete.Enabled = true;
                    //Commented     btnDelete.Visible = true;
                }
                if ((Utility.AllowedAction1(Session["Username"].ToString(), "Approve Timesheet for All") == true) || (Utility.AllowedAction1(Session["Username"].ToString(), "Approve Timesheet") == true))
                {
                    btnApprove.Enabled = true;
            ...
            if (Session["bind"] != null)
            {
                if (Session["bind"].ToString() == "true")
                {
                    ...
                    //Commented        btnUnlock.Visible = false;
                    btnSubApprove.Enabled = true;
                    //Commented       btnDelete.Visible = false;
                    Session["bind"] = null;
                }
            }
            ...
            if (Session["copy"] != null)
            {
                ...
                if (Session["copy"].ToString() == "true")
                {
                    ...
                    //Commented        btnSubApprove.Visible = false;
                    btnDelete.Enabled = false;
                    //Commented      btnDelete.Visible = false;
            ...
            if (strInsertDataF.Length > 0)
            {
                ...
                if (recd > 0)
                {
                   ...
                   // lblMsg.Text = "Records Approved SuccessFully.";
                    ViewState["actionMessage"] = "Success|Records Approved SuccessFully.";
                }
                DocUploaded(0);
            }
            ...
            if (Session["DS1"] != null)
            {
                ...
                try
                {
                    ...
                    if (intUpdate > 0 || intInsert > 0)
                    {
                        ...
                        ViewState["actionMessage"] = "Warning|Data Deleted SuccessFully..";
                        Session["Delete"] = "true";
                    }
                }
                catch (Exception ex)
                {
                    ...
                    ViewState["actionMessage"] = "Warning|Data Deleted Unlock..";
                }
                //Again Rebind The grid ... ... ... 
                //bindgrid();
            }
        ...
        protected void sendemail(StringBuilder strmail, string strename, string tsemail, int itype)
        {
            ...
            if (emailreq == "yes")
            {
                ...
                try
                {
                    ...
                    lblMsg.Text = "";
                  //  lblMsg.Text = strMessage;
                    ViewState["actionMessage"] = strMessage;
                }
                catch (Exception ex)
                {
                    strMessage = strMessage + "<br/>" + "Error Occured While Sending Mail.";
                    ViewState["actionMessage"] = "Warning|Error Occured While Sending Mail.";
                }
            }
