<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HrRate.aspx.cs" Inherits="SMEPayroll.Management.HrRate" %>
                                ...
                                <script type="text/javascript">
                                    function RowDblClick(sender, eventArgs) {
                                        sender.get_masterTableView().editItem(eventArgs.get_itemIndexHierarchical());
                                            ...
                                            <radG:RadGrid ID="RadGrid1"  runat="server" AllowFilteringByColumn="True" AllowPaging="true" OnItemCommand="RadGrid1_ItemCommand"
                                                ...
                                                <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Bottom"
                                                    CommandItemSettings-AddNewRecordText="Add New Hourly Rate">
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn DataField="FormulaName" UniqueName="FormulaName" CurrentFilterFunction="Contains" FilterControlAltText="cleanstring"
                                                            AutoPostBackOnFilter="True" ShowFilterIcon="false" SortExpression="FormulaName" HeaderText="Name">
                                                            <%--<ItemStyle Width="100px" />--%>
                                                        </radG:GridBoundColumn>
                                                        <radG:GridBoundColumn DataField="Value" UniqueName="Value" ShowFilterIcon="false" CurrentFilterFunction="Contains" FilterControlAltText="number-dot"
                                                            AutoPostBackOnFilter="True" SortExpression="Value" HeaderText="Value">
                                                            <ItemStyle Width="150px" />
                                                <HeaderStyle Width="150px"  />
                                                        </radG:GridBoundColumn>
                                                        <%--<radG:GridBoundColumn DataField="BasicRate" UniqueName="BasicRate" CurrentFilterFunction="Contains"
                                        AutoPostBackOnFilter="True" SortExpression="BankName" HeaderText="BasicRate">
                                    </radG:GridBoundColumn>--%>
                                                ...
                                                <HeaderStyle Width="30px" HorizontalAlign="Center" />
                                                    ...
                                                    <EditFormSettings UserControlName="HrEdit.ascx" EditFormType="WebUserControl">
