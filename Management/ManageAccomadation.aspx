    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Accomodation Management</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                                ...
                                <div class="col-IB-6">
                                    <div class="page-links">
                                        ...
                                        <div class="detail">
                                            ...
                                            <span>Manage Accommodation Addition,Deletion,Update.</span>
                                            <a href="../Management/AccomadationInfo.aspx" class="nav">View <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-IB-6">
                                    <div class="page-links">
                                        ...
                                        <div class="detail">
                                            ...
                                            <span>Assign / Un Assign Accommodation.</span>
                                            <a href="../Management/EmployeeAccomadationInfo.aspx" class="nav">View <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
