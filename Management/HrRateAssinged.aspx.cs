...
{
    public partial class HrRateAssinged : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string sSQL = "Select Id, FormulaName From HrRate Where ComapnyId={0}";
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (strRosterID != "-1")
            {
                   ...
                   parms[2] = new SqlParameter("@Action", Utility.ToString("0"));
                    ...
                    foreach (GridItem item in rd.MasterTableView.Items)
                    {
                        ...
                        if (item is GridItem)
                        {
                            ...
                            {
                            string sSQL = "Select hourly_rate_mode from employee where emp_code="+strempid;
                            ...
                            else
                            {
                             ...
                             string msg=   alert_msg.show_alert("007");
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    string sSQL = "sp_Hrtable_Assigned";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        //lblMsg.Text = "Employee " + strActionMsg + "  Successfully.";
                    ...
                    {
                        //lblMsg.Text = "Unable to " + strActionMsg + " Employees to Hrtable.";
                    _actionMessage = "Warning|Unable to "+ strActionMsg + " Employees to HR table.";
                    ViewState["actionMessage"] = _actionMessage;
                }
                }
                else
