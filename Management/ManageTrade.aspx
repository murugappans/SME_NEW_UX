    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Trade</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                                        ...
                                        sender.get_masterTableView().editItem(eventArgs.get_itemIndexHierarchical());
                                            ...
                                            <radG:RadGrid ID="RadGrid1"  OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="true"
                                                ...
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                              <%--          <span class="form-title">Add New Trade</span>--%>
                                                         <asp:label ID="Trade" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Trade" : "Edit Trade" %>'
                                                            ...
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                    <label>
                                                                        ...
                                                                        <asp:TextBox ID="TextBox1" CssClass="textfields form-control inline input-sm input-medium cleanstring custom-maxlength _txttrade" runat="server" Text='<%# Bind("Trade") %>'></asp:TextBox>
                                                                    
                                                                </div>
                                                                <div class="form-group clearfix">
                                                                <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 inserttrade" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $(".clsCnfrmButton").click(function () {
            ...
            GetConfirmation("Are you sure you want to delete this Trade?", _id, "Confirm Delete", "Delete");
        });
        ...
        function validatetrade() {
            var _message = "";
            if ($.trim($("._txttrade").val()) === "")
                _message += "Please Input Trade <br>";
            if (_message != "") {
