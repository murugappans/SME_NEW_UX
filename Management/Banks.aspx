    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">List of Banks</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                                ...
                                <radG:RadGrid ID="RadGrid1"  runat="server" AllowFilteringByColumn="True" AllowPaging="true"
                                                ...
                                                <MasterTableView AutoGenerateColumns="False" DataKeyNames="ID" CommandItemDisplay="Bottom"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <radG:GridBoundColumn DataField="bank_code" UniqueName="bank_code" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                            AutoPostBackOnFilter="True" SortExpression="bank_code" HeaderText="BankCode" FilterControlAltText="numericonly">
                                                            <ItemStyle Width="200px" />
                                                            <HeaderStyle Width="200px" />
                                                        </radG:GridBoundColumn>
                                                        <radG:GridBoundColumn DataField="desc" UniqueName="BankName" CurrentFilterFunction="Contains" ShowFilterIcon="false"
                                                            AutoPostBackOnFilter="True" SortExpression="desc" HeaderText="BankName" FilterControlAltText="cleanstring">
                                                        </radG:GridBoundColumn>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
       ...
       <%-- $("input[type='button']").removeAttr("style");
        $(".rgPagePrev").after("<i class='fa fa-caret-left'></i>");
        $(".rgPageNext").after("<i class='fa fa-caret-right'></i>");
        $(".rgPageFirst").after("<i class='fa fa-step-backward'></i>");
        $(".rgPageLast").after("<i class='fa fa-step-forward'></i>");--%>
