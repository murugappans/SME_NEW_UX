...
{
    public partial class DepartmentAssignment : System.Web.UI.Page
    {
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    parms[1] = new SqlParameter("@DEPT_ID", Utility.ToInteger(drpSubProjectID.SelectedItem.Value));
                    ...
                    string sSQL = "sp_Department_Assigned";
                    ...
                    if (retVal >= 1)
                    {
                        ...
                        _actionMessage = "Success|Department "+ strActionMsg + " Successfully.";
                        ViewState["actionMessage"] = _actionMessage;
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    }
                    else
                    {
                        ...
                        _actionMessage = "Warning|Unable to "+ strAction + " Departments.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                }
                else
