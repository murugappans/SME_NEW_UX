    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Parameter</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                                        ...
                                        function RowDblClick(sender, eventArgs) {
                                            ...
                                            <radG:RadGrid ID="RadGrid1"  runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn DataField="ParameterName" UniqueName="ParameterName" HeaderText="Parameter Name" ShowFilterIcon="false"
                                                            SortExpression="ParameterName" AllowFiltering="true" AutoPostBackOnFilter="true"  FilterControlAltText="cleanstring"
                                                ...
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                                       <%-- <span class="form-title">Add New Parameter</span>--%>
                                                                 <asp:Label ID="Parameter" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Parameter" : "Edit Parameter" %>'
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <asp:TextBox ID="TextBox1" CssClass="form-control input-sm inline input-medium cleanstring custom-maxlength _txtparameter" runat="server" Text='<%# Bind("ParameterName") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group clearfix">
                                                                <asp:Button ID="btnUpdate" CssClass="btn red insertparam margin-top-0" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $('.insertparam').click(function () {
            return validateparam();
        });
        $(".clsCnfrmButton").click(function () {
            var _elem = $(this).find('input[type=image]');
            var _id = _elem.attr('id');
            GetConfirmation("Are you sure you want to delete this Parameter?", _id, "Confirm Delete", "Delete");
        });
        ...
        function validateparam() {
            var _message = "";
            if ($.trim($("._txtparameter").val()) === "")
                _message += "Please Input Parameter Name <br>";
            if (_message != "") {
