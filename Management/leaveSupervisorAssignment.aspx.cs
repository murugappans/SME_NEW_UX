...
{
    public partial class leaveSupervisorAssignment : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    {
                        //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Leave Supervisor Assigned.This Leave Supervisor Assigned is in use."));
                        _actionMessage = "Warning|Unable to delete the Leave Supervisor Assigned.This Leave Supervisor Assigned is in use.";
                    ...
                    else
                    {
                        ...
                        if (retVal >= 1)
                        {
                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Leave Supervisor Assigned is Deleted Successfully."));
                            _actionMessage = "Success|Leave Supervisor Assigned is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                            RadGrid2.Rebind();
                            RadGrid1.Rebind();
                        }
                        ...
                        {
                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Leave Supervisor Assigned."));
                            _actionMessage = "Warning|Unable to delete the Leave Supervisor Assigned.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    parms[2] = new SqlParameter("@Remarks", Utility.ToString("NIL"));
                    ...
                    string sSQL = "SP_LeaveSupervisor_Assignment";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Leave Supervisor " + strActionMsg + " Successfully."));
                        _actionMessage = "sc|Leave Supervisor "+ strActionMsg + " Successfully.";
                        ViewState["actionMessage"] = _actionMessage;
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    }
                    ...
                    {
                        //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to " + strActionMsg + " Leave Supervisors."));
                        _actionMessage = "Warning|Unable to "+ strAction + " Leave Supervisors.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                }
                else
            ...
            {
                //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Please select  Leave Supervisors."));
                _actionMessage = "Warning|Please select  Leave Supervisors.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
    }
