<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComchestSetup.aspx.cs" Inherits="SMEPayroll.Management.ComchestSetup" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Setup Community Chest</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Community Chest</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <radG:RadGrid ID="RadGrid4"  runat="server" GridLines="None" Skin="Outlook" Width="95%" OnItemCommand ="RadGrid4_ItemCommand"
                                                    ...
                                                    <MasterTableView AutoGenerateColumns="False" DataKeyNames="id,CSN" CommandItemDisplay="Bottom">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <radG:GridBoundColumn DataField="AmtRound" HeaderText="Rounding Option" SortExpression="AmtRound">
                                                            </radG:GridBoundColumn>
                                                ...
                                                <HeaderStyle Width="30px" HorizontalAlign="Center" />
                                                        ...
                                                        <EditFormSettings UserControlName="ComchestSetup_edit.ascx" EditFormType="WebUserControl">
                                                        </EditFormSettings>
                                                    </MasterTableView>
