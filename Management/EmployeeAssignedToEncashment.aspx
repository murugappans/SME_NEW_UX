<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeAssignedToEncashment.aspx.cs"
    Inherits="SMEPayroll.Management.EmployeeAssignedToEncashment" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Employee Assigned as Encashment</li>
                        <li>
                            ...
                            <div class="search-box clearfix padding-tb-10">
                                <div class="form-inline col-sm-12">
                                    <div class="form-group">
                                        <label>Encash Type</label>
                                    <asp:DropDownList  ID="EncashTypeID"
                                        DataTextField="TypeName" DataValueField="ID" BackColor="white"
                                        CssClass="form-control input-sm" DataSourceID="EncashType_dataSource" runat="server" AutoPostBack="true">
                                    </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label>Formula Type</label>
                                    <asp:DropDownList  ID="FarmulaID" OnDataBound="drpTypeID_databound"
                                        DataTextField="TypeName" DataValueField="ID" BackColor="white"
                                        CssClass="form-control input-sm" DataSourceID="FarmulaID_dataSource" runat="server" AutoPostBack="true">
                                    </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                    <asp:Button ID="savebutton" runat="server" Text="Save" OnClick="buttonSave_click"
                                        CssClass="textfields btn  red" />
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-5">
                                            <radG:RadGrid ID="RadGrid2"  runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                                ...
                                                <MasterTableView AllowAutomaticUpdates="True" DataSourceID="SqlDataSource2" AutoGenerateColumns="False"
                                                    DataKeyNames="Emp_ID" AllowPaging="true" PageSize="50">
                                                    ...
                                                    <Columns>
                                                        <radG:GridTemplateColumn HeaderText="Emp_ID" HeaderStyle-HorizontalAlign="Center" Display="false"
                                                            UniqueName="Emp_ID" ItemStyle-Wrap="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Emp_ID" Width="100%" runat="server" CssClass="bodytxt" Text='<%# DataBinder.Eval(Container,"DataItem.Emp_ID")%>'></asp:Label>
                                                            </ItemTemplate>
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn ReadOnly="True" DataField="Time_Card_NO" DataType="System.String" AutoPostBackOnFilter="true"
                                                            UniqueName="Time_Card_NO" Visible="true" SortExpression="Time_Card_NO" HeaderText="Time Card NO"   ShowFilterIcon="false" FilterControlAltText="cleanstring"  >
                                                        ...
                                                        <radG:GridBoundColumn DataField="Trade" ShowFilterIcon="false"  FilterControlAltText="alphabetsonly" AllowFiltering="true"
                                        ...
                                        <div class="col-md-5">
                                            <radG:RadGrid ID="RadGrid1"  runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridTemplateColumn ItemStyle-HorizontalAlign="Left" DataField="FixedAmount" UniqueName="FixedAmount" ShowFilterIcon="false" FilterControlAltText ="number-dot"
                                                            HeaderText="FixedAmount">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="FixedAmount" CssClass="form-control input-sm number-dot" MaxLength="12" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.FixedAmount")%>'></asp:TextBox>
                                                            </ItemTemplate>
                                                           
                                                        </radG:GridTemplateColumn>


                                                        <radG:GridTemplateColumn ItemStyle-HorizontalAlign="Left" DataField="NoOfDays" UniqueName="NoOfDays" Display="false"
                                                            HeaderText="NoOfDays">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="NoOfDays" Width="50%" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.NoOfDays")%>'></asp:TextBox>
                                                            </ItemTemplate>
                                    ...
                                    <asp:SqlDataSource ID="EncashType_dataSource" runat="server" SelectCommand="Select 1 ID, 'Termination' TypeName union Select 2 ID, 'Leave Transfer' TypeName union Select 3 ID, 'PH Pay' TypeName"></asp:SqlDataSource>
                                    <asp:SqlDataSource ID="FarmulaID_dataSource" runat="server" SelectCommand="Select 1 ID, 'F1-FixedAmount' TypeName union Select 2 ID, 'F2-GrossPay(Last Month)' TypeName union Select 3 ID, 'F3-BasicPay' TypeName"></asp:SqlDataSource>


                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="Select distinct Emp_Code Emp_ID ,(select trade from trade where id=Trade_id) as Trade,Time_Card_No, (Emp_Name+' '+Emp_LName) Emp_Name,
'Assigned' = Case  When EC.FormulaType is null Then CAST(0 AS bit) Else CAST(1 AS bit) End From Employee EA 
Left Outer Join 
(	Select EA.EmpCode,EA.FormulaType,EA.EncashType From Encashment EA Inner Join Employee EM On EA.EmpCode = EM.Emp_Code Where EM.Company_ID=@company_id And EM.[StatusID]=1) EC On EA.Emp_Code = EC.EmpCode  
Where EA.emp_code not in(Select EA.empcode Emp_ID From Encashment EA Inner Join Employee EM On EA.empcode = EM.Emp_Code  where EM.Company_Id=@company_id and EA.EncashType= @EncashTypeID) and emp_name is not null and Company_Id= @company_id Order By Emp_Name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                            <asp:ControlParameter ControlID="EncashTypeID" Name="EncashTypeID" PropertyName="SelectedValue"
                                                Type="Int32" />
                                            <asp:ControlParameter ControlID="FarmulaID" Name="FarmulaID" PropertyName="SelectedValue"
                                                Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                                        SelectCommand="Select (select trade from trade where id=EM.Trade_id) as Trade,EA.ID ID, EA.FormulaType, EA.empcode Emp_ID,(EM.Emp_Name+' '+EM.emp_LName) EmpName, EM.Time_Card_NO ,EA.FixedAmount,EA.NoOfDays From Encashment EA Inner Join Employee EM On EA.empcode = EM.Emp_Code  where EM.Company_Id=@company_id  and EA.EncashType= @EncashTypeID and EA.FormulaType= @FarmulaID ">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                            <asp:ControlParameter ControlID="EncashTypeID" Name="EncashTypeID" PropertyName="SelectedValue"
                                                Type="Int32" />
