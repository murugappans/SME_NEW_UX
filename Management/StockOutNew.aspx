<%@ Page Language="C#" AutoEventWireup="true" Codebehind="StockOutNew.aspx.cs" Inherits="SMEPayroll.Management.StockOutNew" %>
    ...
    <form id="form1" runat="server">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Manage StockOut</b></font>
                            </td>
                        </tr>
        ...
        <div>
                    ...
                    <td>
                        <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                            ...
                            <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="TransId,TransDate" AutoGenerateColumns="false">
                                ...
                                <DetailTabl>
                                    <radG:GridTableView DataKeyNames="MasterTransID,TransSubId,StoreId,ItemId,EmpId,ProjectId" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <radG:GridBoundColumn EditFormColumnIndex="1" DataField="Employee" UniqueName="Employee"
                                                SortExpression="Employee" HeaderText="Employee Name">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                                            </radG:GridBoundColumn>
                                             <radG:GridBoundColumn EditFormColumnIndex="1"  DataField="EmpId" UniqueName="EmpId"
                                                SortExpression="EmpId" Display="false" HeaderText="EmpId">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                                            </radG:GridBoundColumn>
                                            <radG:GridBoundColumn EditFormColumnIndex="1" DataField="Project" UniqueName="Project"
                                                SortExpression="Project" HeaderText="Project Name">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                                            </radG:GridBoundColumn>
                                             <radG:GridBoundColumn EditFormColumnIndex="1"  DataField="ProjectId" UniqueName="ProjectId"
                                                SortExpression="ProjectId" Display="false" HeaderText="ProjectId">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                                            </radG:GridBoundColumn>
                                            ...
                                            <radG:GridDropDownColumn EditFormColumnIndex="0" DataField="StoreId" DataSourceID="SqlDataSource2"
                                                HeaderText="Store Name" ListTextField="Store" ListValueField="ID" UniqueName="storeId">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                                            </radG:GridDropDownColumn>
                                            <radG:GridBoundColumn EditFormColumnIndex="1" DataField="IssueType" UniqueName="IssueType"
                                                SortExpression="IssueType" HeaderText="Issue / Sell">
                                                <ItemStyle Width="3%" HorizontalAlign="Left" />
                                            </radG:GridBoundColumn>
                                        ...
                                        <EditFormSettings UserControlName="StockOutControl.ascx" EditFormType="WebUserControl">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="sp_getTransactionMaster"
                SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:Parameter Name="transType" Type="int16" DefaultValue="1" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
    </form>
