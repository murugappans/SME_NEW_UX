...
{
    public partial class PayrollGroupAssigned : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                radWF1.Visible = false;
                radWF1second.Visible = false;
        ...
        protected void drpPayrollGroupID_databound(object sender, EventArgs e)
        {
            drpPayrollGroupID.Items.Insert(0, new ListItem("-select-", "-1"));
        }
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpPayrollGroupID.SelectedItem.Value.ToString() != "-1")
            {
                int i = 0;
                ...
                if (strEmployee.Length > 0)
                {
                    ...
                    parms[1] = new SqlParameter("@PayrollGroupID", Utility.ToInteger(drpPayrollGroupID.SelectedItem.Value));
                    parms[2] = new SqlParameter("@Remarks", Utility.ToString(""));
                    parms[3] = new SqlParameter("@EmpID", Utility.ToString(strEmployee));
                    parms[4] = new SqlParameter("@WorkflowTypeID", Utility.ToInteger(drpType.SelectedItem.Value));
                    int Actioninsert = 0;
                    ...
                    if (strAction == "Un-Assign")
                    {
                        ...
                        parms[5] = new SqlParameter("@Action", Actiondelete.ToString());
                    }
                    parms[6] = new SqlParameter("@retval", SqlDbType.Int);
                    parms[6].Direction = ParameterDirection.Output;

                    string sSQL = "sp_PayrollGroup_Assigned";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        //RadGrid2.Controls.Add(new LiteralControl("<font color = 'Red'>Payroll Group Assigned Successfully."));
                        _actionMessage = "Success|" + strAction + "ed Successfully";
                    ...
                    {
                        RadGrid2.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to Assign Payroll Group."));
                    }
                }
                else
                {
                    RadGrid2.Controls.Add(new LiteralControl("<font color = 'Red'>Please Select Employee."));
                }

            }
            else
            {
                RadGrid2.Controls.Add(new LiteralControl("<font color = 'Red'>Please select Payroll Group."));
            }
        }
        ...
        void btnWF2ASsign_Click(object sender, EventArgs e)
        {
            ...
            if (drpWorkFlow.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0)
                {
                    ...
                    parms[1] = new SqlParameter("@WorkflowID", Utility.ToInteger(drpType.SelectedItem.Value));
                    parms[2] = new SqlParameter("@Remarks", Utility.ToString(""));
                    parms[3] = new SqlParameter("@EmpID", Utility.ToString(strEmployee));
                    if (strAction == "Assign")
                    {
                    ...
                    string sSQL = "sp_PayrollGroup_Assigned_WF2_SUpr";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        if (strAction == "Assign")
