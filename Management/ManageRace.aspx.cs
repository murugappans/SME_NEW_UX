...
namespace SMEPayroll.Management
{
    public partial class ManageRace : System.Web.UI.Page
    {
        ...
        {
            if ((Utility.AllowedAction1(Session["Username"].ToString(), "Race")) == false)
            {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (dr[0].ToString() != "0" || id == "1" || id == "2" || id == "3" || id == "4" || id == "5")
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the race.This race is in use.";
                    ...
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            ...
                            _actionMessage = "Success|Race Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                            ...
                            _actionMessage = "Warning|Unable to delete the race.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void RadGrid1_ItemInserted(object source, GridInsertedEventArgs e)
        {
            ...
            else
            {
                ...
                _actionMessage = "Success|Race added successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
        protected void RadGrid1_ItemUpdated(object source, GridUpdatedEventArgs e)
        {
            ...
            else
            {
                ...
                _actionMessage = "Success|Race updated successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
