    ...
    public partial class EmployeeWorkflow : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the Workflow which is in use.";
                    ...
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            ...
                            _actionMessage = "sc|Workflow is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                            ...
                            _actionMessage = "Warning|Unable to delete the Workflow.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void RadGrid1_ItemInserted(object source, GridInsertedEventArgs e)
        {
            ...
            else
            {
                ...
                _actionMessage = "sc|Workflow added successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
        protected void RadGrid1_ItemUpdated(object source, GridUpdatedEventArgs e)
        {
            ...
            else
            {
                ...
                _actionMessage = "sc|Workflow updated successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
