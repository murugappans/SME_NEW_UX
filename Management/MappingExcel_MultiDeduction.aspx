<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MappingExcel_MultiDeduction.aspx.cs" Inherits="SMEPayroll.Management.MappingExcel_MultiDeduction" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>MultiDeduction Mapping</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">MultiDeduction Mapping</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadGrid ID="RadGrid1" AllowPaging="true" AllowFilteringByColumn="true"
                                ...
                                <MasterTableView AutoGenerateColumns="False" DataKeyNames="Deductions_id,Aid" CommandItemDisplay="Bottom">
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="DeductionType" CurrentFilterFunction="StartsWith" AutoPostBackOnFilter="True" ShowFilterIcon="false"
                                            HeaderText="Deduction Type" SortExpression="DeductionType" UniqueName="DeductionType" FilterControlAltText="cleanstring">
                                    ...
                                    <EditFormSettings UserControlName="MultiDeductionMap_edit.ascx" EditFormType="WebUserControl">
                                    </EditFormSettings>
                                    <CommandItemSettings AddNewRecordText="Add New MultiDeduction Mapping" />
                                </MasterTableView>
