<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageDesignation.aspx.cs"
    Inherits="SMEPayroll.Management.ManageDesignation" %>
    ...
    <script type="text/javascript">
        ...
        function Validations(sender, args) {
            ...
            if (result == 'Update' || result == 'PerformInsert') {
                var sMsg = "";
                var message = "";
                message = MandatoryData(trim(Designation), "Designation Name");
                if (message != "")
                    sMsg += message + "\n";
                            ...
                            <radG:RadGrid ID="RadGrid1"  OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="true"
                                ...
                                <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="id"
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="Designation" UniqueName="Designation" SortExpression="Designation"
                                    ...
                                    <EditFormSettings EditFormType="Template">
                                        <FormTemplate>
                                            <div class="clearfix form-style-inner">
                                                <div class="heading">
                                                  <%--  <span class="form-title">Add New Designation</span>--%>
                                      <asp:Label ID="Designation" CssClass="form-title" runat="server" Text='<%# (Container as GridItem).OwnerTableView.IsItemInserted ? "Add Designation" : "Edit Designation" %>'></asp:Label>
                                                        ...
                                                        <div class="form-body">
                                                            <div class="form-group clearfix">
                                                                <label>
                                                                    ...
                                                                    <asp:TextBox ID="TextBox1" CssClass="textfields form-control inline input-sm input-medium cleanstring custom-maxlength _txtdesg" MaxLength="50" runat="server" Text='<%# Bind("Designation") %>'></asp:TextBox>
                                                                
                                                            </div>
                                                            <div class="form-group clearfix">
                                                            <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertdesg" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
                                    ...
                                    <CommandItemSettings AddNewRecordText="Add New Designation" />
                                </MasterTableView>
                             ...
                             <%--       <ClientEvents OnRowDblClick="RowDblClick" OnCommand="Validations" />--%>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [designation] ([Designation],Company_id) VALUES (@Designation,@company_id)"
                                    SelectCommand="SELECT [id], [Designation] FROM [designation] where company_id=@company_id order by 1"
                                    UpdateCommand="UPDATE [designation] SET [Designation] = @Designation WHERE [id] = @id">
                                    <SelectParameters>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    <script type="text/javascript">
        ...
        $('.insertdesg').click(function () {
            return validatedesg();
        });
        $(".clsCnfrmButton").click(function () {
            var _elem = $(this).find('input[type=image]');
            var _id = _elem.attr('id');
            GetConfirmation("Are you sure you want to delete this Designation?", _id, "Confirm Delete", "Delete");
        });
        ...
        function validatedesg() {
            var _message = "";
            if ($.trim($("._txtdesg").val()) === "")
                _message += "Please Input Designation <br>";
            if (_message != "") {
