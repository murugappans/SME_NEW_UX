...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadGrid ID="RadGrid1"  AllowPaging="true" OnDeleteCommand="RadGrid1_DeleteCommand" OnInsertCommand="RadGrid1_InsertCommand" OnUpdateCommand="RadGrid1_UpdateCommand"
                                PageSize="20" OnItemDataBound="RadGrid1_ItemDataBound" runat="server" DataSourceID="SqlDataSource1"
                                GridLines="None" Skin="Outlook" Width="93%" AllowAutomaticDeletes="false" AllowAutomaticInserts="false"
                                    ...
                                    <EditFormSettings EditFormType="Template">
                                        <FormTemplate>
                                            <div class="clearfix form-style-inner">
                                                <div class="heading">
                                                    <%--<span class="form-title">Add New Country</span>--%>
                                                     <asp:label ID="Country" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Country" : "Edit Country" %>'
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="form-body">
                                                            <div class="form-group clearfix">
                                                                ...
                                                                <asp:TextBox ID="TextBox1" CssClass="textfields form-control inline input-sm input-medium cleanstring custom-maxlength _txtcountry" MaxLength="50" runat="server" Text='<%# Bind("Country") %>'></asp:TextBox>
                                                                
                                                            </div>                                                        
                                                        <div class="form-group clearfix">
                                                            <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertcountry" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server"  SelectCommand="SELECT [id], [Country] FROM [country] order by 1" >
                               <%-- InsertCommand="INSERT INTO [country] ([Country]) VALUES (@Country)"--%>
                               
                                <%--UpdateCommand="UPDATE [country] SET [Country] = @Country WHERE [id] = @id">--%>
                              <%--  <UpdateParameters>
    ...
    <script type="text/javascript">
        ...
        $(".clsCnfrmButton").click(function () {
            ...
            GetConfirmation("Are you sure you want to delete this Country?", _id, "Confirm Delete", "Delete");
        });
        ...
        function validateCategory() {
            var _message = "";
            if ($.trim($("._txtcountry").val()) === "")
                _message += "Please Input Country Name <br>";
            if (_message != "") {
