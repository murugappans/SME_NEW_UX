    ...
    public partial class ManageDesignation : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (dr[0].ToString() != "0" || id == "13") // ID == 13 CONDITION IS ONLY FOR COFFEESHOP
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the designation.This designation is in use.";
                    ...
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            ...
                            _actionMessage = "Success|Designation Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                            ...
                            _actionMessage = "Warning|Unable to delete the designation.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void RadGrid1_ItemInserted(object source, GridInsertedEventArgs e)
        {
            if (e.Exception != null)
            {
                ...
                if (e.Exception.Message.Contains("Violation of PRIMARY KEY"))
                {
                   // DisplayMessage("<font color = 'red'> Designation can not be added. Reason: Designation already Exists.</font>");
                    _actionMessage = "Warning|Designation can not be added. Reason: Designation already Exists.";
                    ViewState["actionMessage"] = _actionMessage;
                }
                else
                {
                    //DisplayMessage("<font color = 'red'> Designation can not be added. Reason: " + e.Exception.Message + "</font>");
                    _actionMessage = "Warning|Designation can not be added. Reason: " + e.Exception.Message;
                    ViewState["actionMessage"] = _actionMessage;
                }
            }
            else
            {
                ...
                _actionMessage = "Success|Designation added successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
        protected void RadGrid1_ItemUpdated(object source, GridUpdatedEventArgs e)
        {
            if (e.Exception != null)
            {
                ...
                if (e.Exception.Message.Contains("Violation of PRIMARY KEY"))
                {
                    ...
                    _actionMessage = "Warning|Designation can not be updated. Reason: Designation already Exists.";
                    ViewState["actionMessage"] = _actionMessage;
                }
                else
                {
                    //DisplayMessage("<font color = 'red'> Designation can not be updated. Reason: " + e.Exception.Message + "</font>");
                    _actionMessage = "Warning|Designation can not be updated. Reason: " + e.Exception.Message;
                    ViewState["actionMessage"] = _actionMessage;
                }
            }
            else
            {
                ...
                _actionMessage = "Success|Designation updated successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
