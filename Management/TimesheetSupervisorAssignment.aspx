<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimesheetSupervisorAssignment.aspx.cs" Inherits="SMEPayroll.Management.TimesheetSupervisorAssignment" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Timesheet Supervisor Assignment</li>
                        <li>
                        ...
                        <li>
                            <span>Manage Timesheet Supervisor Assignment</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Timesheet Supervisor Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="SELECT  Time_Card_No,EMP_CODE,EMP_NAME + ' ' + EMP_LNAME AS Name,(select trade from trade where id=Trade_id) as Trade FROM EMPLOYEE WHERE TERMINATION_DATE IS NULL  AND (timesupervisor IS NULL OR timesupervisor = 0) AND COMPANY_ID = @company_id ORDER BY EMP_NAME ">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT Time_Card_No,EMP_CODE,EMP_NAME + ' ' + EMP_LNAME AS Name,(select trade from trade where id=Trade_id) as Trade FROM EMPLOYEE WHERE TERMINATION_DATE IS NULL  AND timesupervisor =@EMP_CODE AND COMPANY_ID =@company_id ORDER BY EMP_NAME ">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $("#buttonAdd").click(function () {
            ...
            {
                WarningNotification("Select Timeshet supervisor first");
                return false;
            }
            var _msg = "";
