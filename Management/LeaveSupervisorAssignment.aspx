<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leaveSupervisorAssignment.aspx.cs"
    Inherits="SMEPayroll.Management.leaveSupervisorAssignment" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Leave Supervisor Assignment</li>
                        <li>
                        ...
                        <li>
                            <span>Manage Leave Supervisor Assignment</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Leave Supervisor Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box clearfix padding-tb-10">
                                <div class="form-inline col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList BackColor="White" OnDataBound="drpSubProjectID_databound" ID="drpSubProjectID"
                                            DataTextField="Name" DataValueField="EMP_CODE" DataSourceID="SqlDataSource3"
                                ...
                                <div class="col-md-5">
                                    <radG:RadGrid ID="RadGrid2"  runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                        ...
                                        <MasterTableView AllowAutomaticUpdates="True" PagerStyle-AlwaysVisible="true" 
                                            PagerStyle-Mode="NumericPages" DataSourceID="SqlDataSource2" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <radG:GridBoundColumn ReadOnly="True" DataField="Time_Card_NO" DataType="System.String" AllowFiltering="true" ShowFilterIcon="false" FilterControlAltText="cleanstring"
                                                    UniqueName="Time_Card_NO" Visible="true" SortExpression="Time_Card_NO" HeaderText="Time Card NO" AutoPostBackOnFilter ="true" >
                                                </radG:GridBoundColumn>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="SELECT  Time_Card_No,EMP_CODE,EMP_NAME + ' ' + EMP_LNAME AS Name,(select trade from trade where id=Trade_id) as Trade FROM EMPLOYEE WHERE TERMINATION_DATE IS NULL  AND (EMP_SUPERVISOR IS NULL OR EMP_SUPERVISOR=0) AND COMPANY_ID = @company_id ORDER BY EMP_NAME">
                                <SelectParameters>
                                    <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT  Time_Card_No,EMP_CODE,EMP_NAME + ' ' + EMP_LNAME AS Name,(select trade from trade where id=Trade_id) as Trade FROM EMPLOYEE WHERE TERMINATION_DATE IS NULL  AND EMP_SUPERVISOR =@EMP_CODE AND COMPANY_ID =@company_id ORDER BY EMP_NAME">
                                <SelectParameters>
                                    <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $("#buttonAdd").click(function () {
            ...
            {
                WarningNotification("Select Leave supervisor first");
                return false;
            }
            var _msg = "";
