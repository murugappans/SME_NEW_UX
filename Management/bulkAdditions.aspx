<%@ Page Language="C#" AutoEventWireup="true" Codebehind="bulkAdditions.aspx.cs"
    Inherits="SMEPayroll.Management.bulkAdditions" %>
   ...
   <script language="javascript"  type="text/javascript"  src="../Frames/Script/CommonValidations.js" >
    ...
    <script language="javascript"> 
        ...
        function ValidateForm()
        {
            ...
            //Check Date Values             
            var strirmsg="";
            strirmsg = CompareDate(document.form1.RadDatePicker1.value,document.form1.RadDatePicker2.value,
                    "Bulk Additions - From Date Can not greater than To Date\n","");            
            if(strirmsg!="")
                strmsg+= strirmsg;
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Bulk Additions</b></font>
                            </td>
                        </tr>
                        ...
                        <table style="vertical-align: middle; width: 80%;" align="center" cellpadding="1"
                            ...
                            <tr>
                                ...
                                <td colspan="7" style="height: 24px">
                                    <asp:DropDownList ID="drpaddtype" AutoPostBack="true" OnSelectedIndexChanged="drpaddtype_SelectedIndexChanged" runat="server" OnDataBound="drpaddtype_databound"
                                        Width="90%">
                                    </asp:DropDownList></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="8" style="text-align: center">
                                    <asp:Button ID="CmdUpload" runat="server" OnClientClick="return ValidateForm()"
