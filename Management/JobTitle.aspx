<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobTitle.aspx.cs" Inherits="SMEPayroll.Management.JobTitle" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadCodeBlock ID="RadCodeBlock1" runat="server">
                                ...
                                <script type="text/javascript">
                                    function RowDblClick(sender, eventArgs) {
                                        sender.get_masterTableView().editItem(eventArgs.get_itemIndexHierarchical());
                                            ...
                                            <radG:RadGrid ID="RadGrid1"  OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" OnItemCommand ="RadGrid1_ItemCommand" AllowSorting="true"
                                                runat="server" PageSize="20" AllowPaging="true" DataSourceID="SqlDataSource1" GridLines="None" Skin="Outlook"
                                                Width="93%" OnInsertCommand="RadGrid1_InsertCommand"
                                                ...
                                                <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="id"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <radG:GridBoundColumn DataField="cat_title" UniqueName="cat_title" SortExpression="cat_title"
                                                    ...
                                                    <EditFormSettings UserControlName="JobTitleEdit.ascx" EditFormType="WebUserControl">
                                                        <EditColumn UniqueName="EditCommandColumn">
                                                        </EditColumn>
                                                    </EditFormSettings>
                                                    <CommandItemSettings AddNewRecordText="Add New Title" />
                                                </MasterTableView>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="SELECT [id],[cat_id], [cat_title] FROM [JobTitle] order by 1">
                                    <%-- InsertCommand="INSERT INTO [JobTitle] ([cat_id],[cat_title]) VALUES (@cat_id,@cat_title)"
                SelectCommand="SELECT [id],[cat_id], [cat_title] FROM [JobTitle] order by 1"
                UpdateCommand="UPDATE [JobTitle] SET [cat_title] = @cat_name ,[cat_id] = @cat_id WHERE [id] = @id">
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    <script type="text/javascript">
        ...
        $(".clsCnfrmButton").click(function () {
            ...
            GetConfirmation("Are you sure you want to delete this Job Title?", _id, "Confirm Delete", "Delete");
        });
