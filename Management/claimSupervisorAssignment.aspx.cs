...
{
    public partial class claimSupervisorAssignment : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    {
                        //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Claim Supervisor Assigned.This Claim Supervisor Assigned is in use."));
                        _actionMessage = "Warning|Unable to delete the Claim Supervisor Assigned.This Claim Supervisor Assigned is in use.";
                    ...
                    else
                    {
                        ...
                        if (retVal >= 1)
                        {
                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Claim Supervisor Assigned is Deleted Successfully."));
                            _actionMessage = "success|Claim Supervisor Assigned is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                            RadGrid2.Rebind();
                            RadGrid1.Rebind();
                        }
                        ...
                        {
                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Claim Supervisor Assigned."));
                            _actionMessage = "Warning|Unable to delete the Claim Supervisor Assigned.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    string sSQL = "SP_ClaimSupervisor_Assignment";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                        //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Claim Supervisor " ));
                        _actionMessage = "Success|Claim Supervisor "+ strActionMsg + " Successfully.";
                        ViewState["actionMessage"] = _actionMessage;
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    }
                    ...
                    {
                        //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to " + strActionMsg + " Claim Supervisor."));
                        _actionMessage = "Warning|Unable to "+ strAction + " Claim Supervisor.";
                        ViewState["actionMessage"] =_actionMessage ;
                    }
                }
                else
            ...
            {
                //rd.Controls.Add(new LiteralControl("<font color = 'Red'>Please select Claim Supervisor."));
                _actionMessage = "Warning|Please select Claim Supervisor.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
    }
