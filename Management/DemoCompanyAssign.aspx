            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Demo Company Assignment</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Demo Company Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="display-hide">
                                ...
                                <asp:DropDownList Width="200px" OnDataBound="drpSubProjectID_databound"
                                    ...
                                    <div class="row padding-tb-20 display-hide">
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-5">
                                            <radG:RadGrid ID="RadGrid3"  runat="server" DataSourceID="SqlDataSource5" GridLines="None"
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn DataField="Company_Name" DataType="System.String" AllowFiltering="true" ShowFilterIcon="false" FilterControlAltText="alphabetsonly"
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="select Company_ID,Company_Name  From Company"></asp:SqlDataSource>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" SelectCommand="SELECT  ep.EMP_CODE,ep.EMP_NAME +'' +ep.EMP_LNAME   AS NAME FROM employee ep  INNER JOIN Company c ON ep.Company_Id=c.Company_Id WHERE c.isMaster=1 Order By Emp_Name "></asp:SqlDataSource>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $("#buttonAdd1").click(function () {
            if ($("#drpEmployeeName").val() == "-1")
            {
                WarningNotification("Select employee name first.");
                return false;
            }
            var _msg = "";
            ...
            if (rowCount < 1)
                _msg += "No company records are found to assign.  <br/>";
            else
                if ($("#RadGrid3_ctl00 tbody tr td").find('input[type=checkbox]:checked').length < 1)
        ...
        $("#buttonDel1").click(function () {
            ...
            var rowCount = grid.get_masterTableView().get_dataItems().length;
            if (rowCount < 1)
                _msg += "No company records are found to unassign.  <br/>";
            else
                if ($("#RadGrid4_ctl00 tbody tr td").find('input[type=checkbox]:checked').length < 1)
