...
{
    public partial class TimesheetSupervisorAssignment : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_DeleteCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            try
            {
                ...
                if (dr.Read())
                {
                    ...
                    {
                        RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Timesheet Supervisor Assigned.This Timesheet Supervisor Assigned is in use."));
                    }
                    else
                    {
                        ...
                        if (retVal >= 1)
                        {
                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Timesheet Supervisor Assigned is Deleted Successfully."));
                            ViewState["actionMessage"] = "Success|Timesheet Supervisor Assigned is Deleted Successfully.";
                        ...
                        {
                            ViewState["actionMessage"] = "Warning|Unable to delete the Timesheet Supervisor Assigned.";

                            //RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Timesheet Supervisor Assigned."));
                        }
            ...
            catch (Exception ex)
            {
                ...
                ViewState["actionMessage"] = "Warning|Unable to delete record. Reason:"+ ErrMsg;
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0 && strEmployee != "0")
                {
                    ...
                    string sSQL = "SP_TimesheetSupervisor_Assignment";
                    int retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                    if (retVal >= 1)
                    {
                       // rd.Controls.Add(new LiteralControl("<font color = 'Red'>Timesheet Supervisor " + strActionMsg + " Successfully."));
                        ViewState["actionMessage"] = "Success|Timesheet Supervisor " + strActionMsg + " Successfully.";
                        RadGrid2.Rebind();
                        RadGrid1.Rebind();
                    }
                    else
                    {
                       // rd.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to " + strActionMsg + " Timesheet Supervisor."));
                        ViewState["actionMessage"] = "Warning|Unable to " + strAction + " Timesheet Supervisor.";
                    }
                }
                else
                {
            ...
            {
                rd.Controls.Add(new LiteralControl("<font color = 'Red'>Please select Timesheet Supervisor."));
            }
        }
    }
}
