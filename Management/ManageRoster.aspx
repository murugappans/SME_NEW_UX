<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageRoster.aspx.cs" Inherits="SMEPayroll.Management.ManageRoster" %>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box  clearfix display-none">
                ...
                <tr>
                    <td>--%>
                                ...
                                <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                                    ...
                                    <MasterTableView CommandItemDisplay="Bottom" AllowAutomaticUpdates="True" DataSourceID="SqlDataSource1"
                                        ...
                                        <Columns>
                                            ...
                                            <radG:GridBoundColumn DataField="Roster_Name" UniqueName="Roster_Name" HeaderText="Roster Name"
                                                SortExpression="Roster_Name" AllowFiltering="true" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring"
                                            ...
                                            <radG:GridButtonColumn ConfirmText="Delete this record?" ConfirmDialogType="RadWindow"
                                                ...
                                                <ItemStyle Width="35px" HorizontalAlign="Center" CssClass="MyImageButton" />
                                            <HeaderStyle Width="35px" />
                                        ...
                                        <EditFormSettings EditFormType="Template">
                                            <FormTemplate>
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                                        <span class="form-title">Add New Roster</span>
                                                    </div>
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <asp:TextBox ID="TextBox1" CssClass="form-control input-sm inline input-medium cleanstring" runat="server" Text='<%# Bind("Roster_Name") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group clearfix">
                                        ...
                                        <CommandItemSettings AddNewRecordText="Add New Roster" />
                                    </MasterTableView>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [Roster] (Company_ID, [Roster_Name]) VALUES (@company_id, @Roster_Name)"
                                    SelectCommand="SELECT [id], [Roster_Name] FROM [Roster]  WHERE [company_id] = @company_id"
                                    UpdateCommand="UPDATE [Roster] SET [Roster_Name] = @Roster_Name WHERE [id] = @id">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                    </SelectParameters>
                                    <UpdateParameters>
                                        <asp:Parameter Name="Roster_Name" Type="String" />
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        var _inputs = $('#RadGrid1_GridHeader thead tr td').find('input[type=text]');
