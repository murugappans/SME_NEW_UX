<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageSettings.aspx.cs" Inherits="SMEPayroll.Management.ManageSettings" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span class="reportsDashboard">Manage Settings</span>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="tabbable-line margin-bottom-30">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="active">
                                        <a href="javascript:;" data-target="#Admintab" data-toggle="tab">Admin</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="javascript:;" data-target="#Schedulertab" data-toggle="tab">Scheduler</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="javascript:;" data-target="#Reporttab" data-toggle="tab">Report</a>
                                    </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="Admintab" runat ="server">
                                ...
                                <div class="tab-pane" id="Schedulertab" runat ="server">
                                </div>
                                <div class="tab-pane" id="Reporttab" runat ="server">
                                </div>
                            </div>
