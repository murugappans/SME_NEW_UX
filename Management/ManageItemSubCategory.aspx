            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Manage Item Sub Category</li>
                        <li>
                        ...
                        <li>
                            <span>Manage Item Sub Category</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Item Sub-Category</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <radG:RadGrid ID="RadGrid1"  runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                                ...
                                <MasterTableView DataSourceID="SqlDataSource1" DataKeyNames="id">
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridDropDownColumn EditFormColumnIndex="0" DataField="Parent_ItemCategoryID" ShowFilterIcon="false"
                                            DataSourceID="SqlDataSource2" HeaderText="Item Category ID" ListTextField="ItemCategoryID" FilterControlAltText="cleanstring"
                                            ListValueField="ID" UniqueName="GridDropDownColumn">
                                            <%--<ItemStyle Width="30%" HorizontalAlign="Left" />--%>
                                        </radG:GridDropDownColumn>
                                        <radG:GridBoundColumn EditFormColumnIndex="1" DataField="ItemSubCategoryID" UniqueName="ItemSubCategoryID" FilterControlAltText="cleanstring" ShowFilterIcon="false"
                                            SortExpression="ItemSubCategoryID" HeaderText="Item Sub Category ID">
                                            <%--<ItemStyle Width="30%" HorizontalAlign="Left" />--%>
                                        </radG:GridBoundColumn>
                                        <radG:GridBoundColumn EditFormColumnIndex="2" DataField="ItemSubCategoryName" UniqueName="ItemSubCategoryName" FilterControlAltText="cleanstring" ShowFilterIcon="false"
                                    ...
                                    <EditFormSettings EditFormType="Template">
                                        <FormTemplate>
                                            <div class="clearfix form-style-inner">
                                                <div class="heading">
                                                  <%--  <span class="form-title">Add New Item Sub Category</span>--%>
                                                    <asp:Label ID="ItemSubCategory" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Item Sub Category" : "Edit Item Sub Category" %>'
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="form-body">
                                                            <div class="form-group clearfix">
                                                                ...
                                                                <asp:DropDownList ID="drplocname" runat="server" CssClass="form-control input-inline input-sm input-medium" 
                                                                    SelectedValue='<%# Bind("Parent_ItemCategoryID") %>'
                                            DataTextField="ItemCategoryID" DataValueField="id"   AppendDataBoundItems="True" DataSourceID="SqlDataSource2">
                                                                ...
                                                                <%--<asp:DropDownList ID="ddlcat" runat="server" CssClass="form-control input-sm inline input-medium" SelectedValue='<%# Bind("Parent_ItemCategoryID") %>'
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <label class="control-label">Item Sub Category ID</label>
                                                                <asp:TextBox ID="TextBox2" CssClass="form-control input-sm inline input-medium cleanstring custom-maxlength _txtitemsubcat" MaxLength="50" TabIndex="1" runat="server" Text='<%# Bind("ItemSubCategoryID") %>'></asp:TextBox>
                                                            </div>
                                                            <div class="form-group clearfix">
                                                                <label class="control-label">Item Sub Category Name</label>
                                                                <asp:TextBox ID="TextBox3" CssClass="form-control input-sm inline input-medium cleanstring custom-maxlength _txtitemsubcatname" MaxLength="50" TabIndex="2" runat="server" Text='<%# Bind("ItemSubCategoryName") %>'></asp:TextBox>
                                                            </div>
                                                            <div class="form-group clearfix">
                                                                <label class="control-label">&nbsp;</label>
                                                            <asp:Button ID="btnUpdate" CssClass="btn red insertitemsubcat margin-top-0" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
     ...
     <script type="text/javascript">
        ...
        $('.insertitemsubcat').click(function () {
            return validateitemsubcat();
        });
        $(".clsCnfrmButton").click(function () {
            var _elem = $(this).find('input[type=image]');
            var _id = _elem.attr('id');
            GetConfirmation("Are you sure you want to delete this Item Sub Category?", _id, "Confirm Delete", "Delete");
        });
        window.onload = function () {
         ...
         function validateitemsubcat() {
             var _message = "";
             if ($.trim($("#RadGrid1_ctl00_ctl02_ctl02_drplocname option:selected").text()) === "Select")
                 _message += "Please Select Item Category ID <br>";
            if ($.trim($("._txtitemsubcat").val()) === "")
                _message += "Please Input Item Sub Category ID <br>";
            if ($.trim($("._txtitemsubcatname").val()) === "")
                _message += "Please Input Item Sub Category Name <br>";
            if (_message != "") {
