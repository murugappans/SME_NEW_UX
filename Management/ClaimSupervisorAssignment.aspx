            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Claim Supervisor Assignment</li>
                        <li>
                        ...
                        <li>
                            <span>Manage Claim Supervisor Assignment</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Claim Supervisor Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                                ...
                                <radG:RadGrid ID="RadGrid2"  runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                    ...
                                    <MasterTableView AllowAutomaticUpdates="True" PagerStyle-AlwaysVisible="true" PagerStyle-Mode="NumericPages"
                                        ...
                                        <Columns>
                                            ...
                                            <radG:GridBoundColumn ReadOnly="True" DataField="Time_Card_NO" FilterControlAltText="cleanstring" DataType="System.String" 
                                               ShowFilterIcon="false" UniqueName="Time_Card_NO" Visible="true" SortExpression="Time_Card_NO" HeaderText="Time Card NO">
                                            </radG:GridBoundColumn>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $("#buttonAdd").click(function () {
            ...
            {
                WarningNotification("Select Claim supervisor first");
                return false;
            }
            var _msg = "";
