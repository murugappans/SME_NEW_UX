<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiCurrency.aspx.cs" Inherits="SMEPayroll.Management.MultiCurrency" %>
                            ...
                            <div class="row margin-top-20">
                                ...
                                <div class="col-IB-6">
                                    <div class="page-links">
                                        ...
                                        <div class="detail">
                                            <h3>Currency</h3>
                                            <a href="../Management/CurrencyMaster.aspx">View <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <%}
                                ...
                                <div class="col-IB-6">
                                    <div class="page-links">
                                        ...
                                        <div class="detail">
                                            ...
                                            <a href="../Management/Currency.aspx">View <i class="fa fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <%} %>
