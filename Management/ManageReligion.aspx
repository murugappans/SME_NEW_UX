<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageReligion.aspx.cs"
    Inherits="SMEPayroll.Management.ManageReligion" %>
...
<uc_css:bundle_css ID="bundle_css" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function Validations(sender, args) {
            ...
            if (Religion == "" && changedFlage == "false") {
            ...
            if (result == 'Update' || result == 'PerformInsert') {
                var sMsg = "";
                var message = "";
                message = MandatoryData(trim(Religion), "Religion Name");
                if (message != "")
                    sMsg += message + "\n";
        ...
        function OnFocusLost_Religion(val) {
            var Object = document.getElementById(val);
            Religion = GetDataFromHtml(Object);
            changedFlage = "true";
        }
    </script>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Religion</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadCodeBlock ID="RadCodeBlock1" runat="server">
                                    ...
                                    function RowDblClick(sender, eventArgs) {
                                        sender.get_masterTableView().editItem(eventArgs.get_itemIndexHierarchical());
                                            ...
                                            <radG:RadGrid ID="RadGrid1"  runat="server" OnDeleteCommand="RadGrid1_DeleteCommand"
                                                ...
                                                Skin="Outlook" Width="93%" OnItemInserted="RadGrid1_ItemInserted" OnItemUpdated="RadGrid1_ItemUpdated" AllowSorting="true">
                                                <MasterTableView AllowAutomaticUpdates="True" DataSourceID="SqlDataSource1" CommandItemDisplay="Bottom"
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn DataField="Religion" UniqueName="Religion" SortExpression="Religion"
                                                            HeaderText="Religion">
                                                            <%--<ItemStyle Width="93%"></ItemStyle>--%>
                                                        </radG:GridBoundColumn>
                                            ...
                                            <ItemStyle Width="30px" HorizontalAlign="Center" />
                                                ...
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                                        <span class="form-title">Add New Religion</span>
                                                    </div>
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                        ...
                                                                        <asp:TextBox ID="TextBox1" CssClass="form-control input-sm inline input-medium cleanstring custom-maxlength _txtreligion" MaxLength="50" runat="server" Text='<%# Bind("Religion") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="form-group clearfix">
                                                                <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertreligion" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
                                                    ...
                                                    <CommandItemSettings AddNewRecordText="Add New Religion" />
                                                </MasterTableView>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [religion] ([Religion]) VALUES (@Religion)"
                                    SelectCommand="SELECT [id], [Religion] FROM [religion] order by 1" UpdateCommand="UPDATE [religion] SET [Religion] = @Religion WHERE [id] = @id">
                                    <UpdateParameters>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function validateregion() {
            var _message = "";
            if ($.trim($("._txtreligion").val()) === "")
                _message += "Please Input Religion <br>";
            if (_message != "") {
