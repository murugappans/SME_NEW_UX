...
{
    public partial class ProjectAssigned : System.Web.UI.Page
    {
        ...
        protected void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (drpSubProjectID.SelectedItem.Value.ToString() != "-1")
            {
                ...
                if (strEmployee.Length > 0 && strEmployee  != "0")
                {
                    ...
                    parms[1] = new SqlParameter("@Sub_Project_ID", Utility.ToInteger(drpSubProjectID.SelectedItem.Value));
                    ...
                    string sSQL = "sp_Project_Assigned";
                    ...
                    {
                        rd.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to " + strActionMsg + " Projects."));
                    }
                }
                else
                {
            ...
            {
                rd.Controls.Add(new LiteralControl("<font color = 'Red'>Please select Sub Projects."));
            }
        }
    }
}
