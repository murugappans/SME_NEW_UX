<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignComchest_Employee.aspx.cs" Inherits="SMEPayroll.Management.AssignAMC_Employee" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Community Chest Assignment</li>
                        <li>
                        ...
                        <li>
                            <span>Assign Employees to Community Chest</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Community Chest Assignment</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <%--<uc1:TopRightControl ID="TopRightControl3" runat="server" />--%>
                                ...
                                <div class="col-md-12 form-inline">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control input-sm" OnDataBound="drpSubProjectID_databound"
                                            ...
                                            runat="server" AutoPostBack="true" OnSelectedIndexChanged="csnChanged">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                            ...
                            <div>
                                <center>
                                    ...
                                    <div class="row padding-tb-20">
                                        <div class="col-md-5">
                                            <radG:RadGrid ID="RadGrid2"  runat="server" DataSourceID="SqlDataSource2" GridLines="None"
                                                ...
                                                OnPageIndexChanged="RadGrid2_PageIndexChanged" PagerStyle-Mode="NumericPages" OnItemDataBound="Radgrid2_databound" OnPreRender="RadGrid2_PreRender" AllowSorting="true">
                                        ...
                                        <div class="col-md-5">
                                            <radG:RadGrid ID="RadGrid1"  runat="server" DataSourceID="SqlDataSource1" GridLines="None"
                                                Skin="Outlook" Width="98%" AllowFilteringByColumn="true" AllowMultiRowSelection="true"
                                                PagerStyle-Mode="NumericPages" AllowSorting="true">
                                                <MasterTableView AllowAutomaticUpdates="True" PagerStyle-AlwaysVisible="true" PagerStyle-Mode="NumericPages"
                                                ...
                                                <HeaderStyle Width="35px" HorizontalAlign="Center" />
                                                        ...
                                                        <radG:GridBoundColumn DataField="Name" DataType="System.String" AllowFiltering="true"
                                                            AutoPostBackOnFilter="true" UniqueName="Name" Visible="true" SortExpression="Name" FilterControlAltText="alphabetsonly"
                                    ...
                                    <%--<asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="SELECT ID,CSN FROM ComchestSetup Where Comp_Id= @company_id">--%>
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" SelectCommand="SELECT ID,CSN FROM ComchestSetup Where Comp_Id= @company_id">
                                        <SelectParameters>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server">
                                        <%--SelectCommand="SELECT e.emp_code As EmpId,Emp_name + '' + Emp_lname as Name from employee E Left outer join AmcAssignedEmployee_Employee AE on e.emp_code=AE.EmpCode where (AE.AssignedAMCID IS NULL ) And e.Company_id=@company_id and (termination_date is Null OR MONTH(termination_date)=MONTH(getdate()))  Order By Emp_name"--%>
                        ...
                        <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server">
                                        <%--SelectCommand="SELECT e.emp_code As EmpId,Emp_name + '' + Emp_lname as Name from employee E Left outer join AmcAssignedEmployee_Employee AE on e.emp_code=AE.EmpCode where (AE.AssignedAMCID =@csnId )And e.Company_id=@company_id and termination_date is Null Order By Emp_name">--%>
                                        <%--<SelectParameters>
                        <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
