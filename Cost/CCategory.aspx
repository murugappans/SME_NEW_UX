<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CCategory.aspx.cs" Inherits="SMEPayroll.Cost.CCategory" %>
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div>
                                ...
                                <radG:RadGrid ID="RadGrid1" OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="true"
                                    runat="server" PageSize="20" AllowPaging="true" DataSourceID="SqlDataSource1" GridLines="None" Skin="Outlook" PagerStyle-AlwaysVisible="true"
                                        ...
                                        <EditFormSettings EditFormType="Template">
                                            <FormTemplate>
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                                        <%--<span class="form-title">Add New Cost Category</span>--%>
                                                        <asp:label ID="CostCategory" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Cost Category" : "Edit Cost Category" %>'
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                    ...
                                                                    <asp:TextBox ID="TextBox1" CssClass="form-control input-sm inline input-medium cleanstring custom-maxlength _txtcategory" MaxLength="50" runat="server" Text='<%# Bind("BusinessUnit") %>'></asp:TextBox>
                                                                </div>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server"   SelectCommand="SELECT [Bid],[BusinessUnit] FROM [Cost_Ccategory] where company_id=@company_id order by 1">
<%--                                    InsertCommand="INSERT INTO [Cost_Ccategory] ([BusinessUnit],Company_id) VALUES (@BusinessUnit,@company_id)"
                                   
                                    UpdateCommand="UPDATE [Cost_Ccategory] SET [BusinessUnit] = @BusinessUnit WHERE [Bid] = @Bid">--%>
                                    <SelectParameters>
