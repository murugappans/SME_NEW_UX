<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="SMEPayroll.Cost.Category" %>
    ...
    <script type="text/javascript">
        ...
        function Validations(sender, args) {
            ...
            if (result == 'Update' || result == 'PerformInsert') {
                var sMsg = "";
                var message = "";
                message = MandatoryData(trim(Trade), "Category");
                if (message != "")
                    sMsg += message + "\n";
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="true"
                                ...
                                <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="cid"
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn ReadOnly="True" DataField="Cid" DataType="System.Int32" UniqueName="Cid"
                                            Visible="false" SortExpression="Cid" HeaderText="Cid">
                                            <ItemStyle Width="100px" />
                                        </radG:GridBoundColumn>
                                        <radG:GridBoundColumn DataField="Category" UniqueName="Category" SortExpression="Category"
                                            HeaderText="Category">
                                            <ItemStyle Width="93%" />
                                        </radG:GridBoundColumn>
                                            ...
                                            <div class="clearfix form-style-inner">
                                                <div class="heading">
                                                   <%-- <span class="form-title">Add New Category</span>--%>
                                                    <asp:label ID="Trade" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Category" : "Edit Category" %>'
                                                    ...
                                                    <div class="form-inline">
                                                        <div class="form-body">
                                                            <div class="form-group clearfix">
                                                                ...
                                                                <asp:TextBox ID="TextBox1" CssClass="form-control inline input-sm input-medium cleanstring custom-maxlength _txtcatname" MaxLength="50" runat="server" Text='<%# Bind("Category") %>'></asp:TextBox>
                                                            </div>
                                                            <div class="form-group clearfix">
                                                            <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertcat" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
                                ...
                                <ClientSettings EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true">
                                    ...
                                    <%--OnCommand="Validations"--%>
                                </ClientSettings>
                            </radG:RadGrid>

                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [Cost_Category] ([Category],Company_id) VALUES (@Category,@company_id)"
                                SelectCommand="SELECT [cid], [Category] FROM [Cost_Category] where company_id=@company_id order by 1"
                                UpdateCommand="UPDATE [Cost_Category] SET [Category] = @Category WHERE [cid] = @cid">
                                <SelectParameters>
