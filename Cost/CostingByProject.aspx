<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingByProject.aspx.cs"
    Inherits="SMEPayroll.Cost.CostingByProject" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
    ...
    <div class="page-container">
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box padding-tb-10 clearfix">
                                <div class="form-inline col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>View History</label>
                                        <asp:DropDownList ID="drphistorydate" runat="server" CssClass="form-control input-sm">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                    ...
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <asp:Button ID="btnTemplate" runat="server" Text="Generate Template(.XLS)" OnClick="btnTemplate_Click" Visible="false" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" ShowStatusBar="false"
                                ...
                                <MasterTableView DataKeyNames="Emp_Code, Time_Card_No" ShowFooter="true" TableLayout="Auto">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="FullName" UniqueName="FullName" SortExpression="FullName" HeaderText="FullName"
                                            ItemStyle-Wrap="false">
                                            <%--<HeaderStyle Width="200px" />--%>
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn DataField="Time_Card_No" UniqueName="Time_Card_No" SortExpression="Time_Card_No" HeaderText="Time_Card_No">
                                        ...
                                        <%------------------------------------- End new column --%>
                                        <telerik:GridTemplateColumn UniqueName="Total" HeaderText="Total %" ItemStyle-Width="30px"
                                            HeaderStyle-Width="70px">
                                            <ItemTemplate>
                                ...
                                <ClientSettings Selecting-AllowRowSelect="true" EnableRowHoverStyle="true" AllowColumnsReorder="true" ReorderColumnsOnClient="true">
        ...
        <asp:Button ID="btnSubmit" CssClass="btn red" runat="server" Text="Submit " OnClick="btnSubmit_Click"
            Enabled="false" OnClientClick="return Validate();" />
                                </div>
                        </form>
