<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessUnit.aspx.cs" Inherits="SMEPayroll.Cost.BusinessUnit" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <%--<h3 class="page-title">Manage Business Unit</h3>--%>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                            ...
                            <div>
                                ...
                                <radG:RadGrid ID="RadGrid1"  OnDeleteCommand="RadGrid1_DeleteCommand" OnItemDataBound="RadGrid1_ItemDataBound" AllowSorting="true"
                                    ...
                                    <MasterTableView DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="Bid"
                                        ...
                                        <EditFormSettings EditFormType="Template">
                                            <FormTemplate>
                                                <div class="clearfix form-style-inner">
                                                    <div class="heading">
                                                       <%-- <span class="form-title">Add New Business Unit</span>--%>
                                                         <asp:label ID="BusinessUnit" CssClass="form-title" Text='<%# (Container is GridEditFormInsertItem) ? "Add Business Unit" : "Edit Business Unit" %>'
                                                        ...
                                                        <div class="form-inline">
                                                            <div class="form-body">
                                                                <div class="form-group clearfix">
                                                                        ...
                                                                        <asp:TextBox ID="TextBox1" CssClass="form-control input-sm inline input-medium custom-maxlength _txtbunit" MaxLength ="50" runat="server" Text='<%# Bind("BusinessUnit") %>'></asp:TextBox>
                                                                </div>                                                            
                                                            <div class="form-group clearfix">
                                                                <asp:Button ID="btnUpdate" CssClass="btn red margin-top-0 insertbunit" Text='<%# (Container is GridEditFormInsertItem) ? "Insert" : "Update" %>'
                                        ...
                                        <CommandItemSettings AddNewRecordText="Add New Business Unit" />
                                    </MasterTableView>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [Cost_BusinessUnit] ([BusinessUnit],Company_id) VALUES (@BusinessUnit,@company_id)"
                                    SelectCommand="SELECT [Bid],[BusinessUnit] FROM [Cost_BusinessUnit] where company_id=@company_id order by 1"
                                    UpdateCommand="UPDATE [Cost_BusinessUnit] SET [BusinessUnit] = @BusinessUnit WHERE [Bid] = @Bid">
                                    <SelectParameters>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $('.insertbunit').click(function () {
            return validateBunit();
        });
        $(".clsCnfrmButton").click(function () {
            var _elem = $(this).find('input[type=image]');
            var _id = _elem.attr('id');
            GetConfirmation("Are you sure you want to delete this Business Unit?", _id, "Confirm Delete", "Delete");
        });
        window.onload = function () {
             CallNotification('<%=ViewState["actionMessage"].ToString() %>');
  
        }
        function validateBunit() {
            var _message = "";
            if ($.trim($("._txtbunit").val()) === "")
                _message += "Please Input Business Unit <br>";
            if (_message != "") {
