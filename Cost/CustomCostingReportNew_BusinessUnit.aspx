<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomCostingReportNew_BusinessUnit.aspx.cs" Inherits="SMEPayroll.Cost.CustomCostingReportNew_BusinessUnit" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="../Reports/CustomReportMainPage.aspx">Custom Reports</a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>Report</span>
                        ...
                        <form id="employeeform" runat="server" method="post">
                            ...
                            <%--OnGroupsChanging="RadGrid1_GroupsChanging"--%>
                                                    <radG:RadGrid ID="RadGrid1" CssClass="radGrid-single" runat="server" GridLines="Both" OnColumnCreated="RadGrid1_ColumnCreated"
                                                        Skin="Outlook" AutoGenerateColumns="True" ClientSettings-AllowDragToGroup="false" ShowGroupPanel="false" OnItemDataBound="RadGrid1_ItemDataBound">
