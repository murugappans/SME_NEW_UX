<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingByRegionReport.aspx.cs" Inherits="SMEPayroll.Cost.CostingByRegionReport" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Costing By Region Report</li>
                        <li>
                        ...
                        <li>
                            <span>Costing By Region Report</span>
                        </li>
                    </ul>
                                    ...
                                    <radG:RadGrid ID="RadGrid2" runat="server" GridLines="None" Skin="Outlook" Width="100%"
                                        ...
                                        <MasterTableView AllowAutomaticUpdates="True" AutoGenerateColumns="False" DataKeyNames="Bid">
                                            ...
                                            <Columns>
                                                ...
                                                <radG:GridBoundColumn DataField="BusinessUnit" AutoPostBackOnFilter="True" UniqueName="Region" FilterControlAltText="cleanstring" ShowFilterIcon="false"
                                                    SortExpression="BusinessUnit" HeaderText="Region">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </radG:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        $('#generateRpt').click(function () {
            return validatecostingbyregion();
        });
        ...
        function validatecostingbyregion() {
            var _message = "";
            ...
            if ($("#RadGrid2_ctl00 tbody tr td").find('input[type=checkbox]:checked').length < 1)
                _message += "Please Select at least one Region <br>";
            if ($("#dtp1").val() == "")
