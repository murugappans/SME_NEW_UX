<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingByBusinessUnit.aspx.cs" Inherits="SMEPayroll.Cost.CostingByBusinessUnit" %>
                        ...
                        <form id="form1" runat="server">
                            ...
                            <div class="search-box padding-tb-10 clearfix">
                                <div class="form-inline col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label>View History</label>
                                        <asp:DropDownList ID="drphistorydate" CssClass="form-control input-sm" runat="server"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                    ...
                    <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="false" ShowStatusBar="false"
                        ...
                        <MasterTableView DataKeyNames="Emp_Code, Time_Card_No" ShowFooter="true" TableLayout="Auto">
                            ...
                            <Columns>
                                ...
                                <%------------------------------------- End new column --%>
                                <telerik:GridTemplateColumn UniqueName="Total" HeaderText="Total %" ItemStyle-Width="30px" HeaderStyle-Width="70px">
                                    <ItemTemplate>
