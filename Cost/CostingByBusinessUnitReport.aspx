<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CostingByBusinessUnitReport.aspx.cs" Inherits="SMEPayroll.Cost.CostingByBusinessUnitReport" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Costing By Business Unit Report</li>
                        <li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="CostingByBusinessunitIndex.aspx"><span>Costing By Business Unit</span></a>
                            <i class="fa fa-circle"></i>
                        </li>
                        <li>
                            <span>Costing By Business Unit Report</span>
                        </li>
                    </ul>
                                        ...
                                        <MasterTableView AllowAutomaticUpdates="True" AutoGenerateColumns="False" DataKeyNames="Bid">
                                            ...
                                            <Columns>
                                                ...
                                                <radG:GridBoundColumn DataField="BusinessUnit" AutoPostBackOnFilter="True" UniqueName="BusinessUnit" FilterControlAltText="cleanstring" ShowFilterIcon="false"
                                                    SortExpression="BusinessUnit" HeaderText="Business Unit">
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </radG:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
        ...
        window.onload = function () {
          <%--  CallNotification('<%=ViewState["actionMessage"].ToString() %>');--%>
            ...
            if ($("#RadGrid2_ctl00 tbody tr td").find('input[type=checkbox]:checked').length < 1)
                _message += "Please Select at least one Business Unit <br>";
            if ($("#dtp1").val() == "")
