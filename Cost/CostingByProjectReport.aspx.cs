...
{
    public partial class CostingByProjectReport : System.Web.UI.Page
    {
        ...
        private void LoadProject()
        {
            string sqlSelect;
            DataSet empDs;
            sqlSelect = "select SP.ID,Sub_Project_Name from SubProject SP inner join Project P on SP.Parent_Project_ID=P.ID where Company_ID=" + comp_id + "";
        ...
        protected void GenerateRpt_Click(object sender, EventArgs e)
        {
            ...
            string sSQL = "sp_CostingByProjectReport";
            ...
            parms[5] = new SqlParameter("@subproject", subprojectid);

            DataSet rptDs = new DataSet();
            rptDs = DataAccess.FetchRS(CommandType.StoredProcedure, sSQL, parms);

            Session["CostingDataset"] = rptDs;

            //Response.Redirect("../Cost/CustomCostingReport.aspx");
            Response.Redirect("../Cost/CustomCostingReportNew.aspx");
