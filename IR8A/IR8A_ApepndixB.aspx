<%@ Page Language="C#" AutoEventWireup="true" Codebehind="IR8A_ApepndixB.aspx.cs"
    Inherits="SMEPayroll.Reports.IR8A_ApepndixB" %>
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" bgcolor="<% =sBaseColor %>" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" colspan="4">
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>IR8A Appendix B Details</b></font>
                            </td>
                        </tr>
      ...
      { 
        ...
        <radG:RadGrid ID="RadGrid1" AllowPaging="true" PageSize="50" runat="server" GridLines="None"
            ...
            retirement_benefits_fundName,excess_voluntary_cpf_employer,excessvoluntarycpfemployeramt,pension_out_singapore,pension_out_singapore_amount,TransportAllowance,EntertainmentAllowance"
                ...
                <Columns>
                    ...
                    <radG:GridTemplateColumn Visible="false" UniqueName="PrintTemplateColumn" AllowFiltering="false">
                        <ItemTemplate>
        ...
        <center>
            <%if (Utility.AllowedAction1(Session["Username"].ToString(), "Generate or Submit Payroll"))
              {%>
            <asp:Button ID="btnPrintAllReport" Visible="false" runat="server" Text="Print Report" class="textfields"
                Style="width: 130px; height: 22px" OnClick="btnPrintAllReport_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnsubapprove" OnClick="btnsubapprove_click" runat="server" Text="Generate IR8A AppendixB  XML"
                class="textfields" Style="width: 150px; height: 22px" />
            &nbsp; &nbsp;
            <%}%>
        </center>
