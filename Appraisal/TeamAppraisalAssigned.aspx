<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamAppraisalAssigned.aspx.cs" Inherits="SMEPayroll.Appraisal.TeamAppraisalAssigned" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Team Assign for Appraisal</li>
                        <li>
                        ...
                        <li>
                            <span>Team Assign for Appraisal</span>
                        </li>
                    </ul>
                                    ...
                                    <div class="form-inline col-sm-8">
                                       ...
                                       <%-- <div class="form-group">
                                            ...
                                            <radG:RadDatePicker Calendar-ShowRowHeaders="false" MinDate="01-01-1900" ID="rdEmpPrjStart"
                                                runat="server">
                                                <DateInput Skin="" runat="server" DateFormat="dd/MM/yyyy">
                                                </DateInput>
                                            </radG:RadDatePicker>
                                        </div>--%>
                                    </div>
                                            ...
                                            <MasterTableView AllowAutomaticUpdates="True" DataSourceID="SqlDataSource2" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <radG:GridBoundColumn Display="false" ReadOnly="True" DataField="Emp_Code" DataType="System.Int32"
                                                        UniqueName="Emp_Code" Visible="true" SortExpression="Emp_Code" ShowFilterIcon="false"  HeaderText="Emp_Code">
                                                    ...
                                                    <radG:GridBoundColumn DataField="Emp_Name" DataType="System.String" AllowFiltering="true" AutoPostBackOnFilter="true" UniqueName="Emp_Name"
                                                        Visible="true" SortExpression="Emp_Name" ShowFilterIcon="false" FilterControlAltText="cleanstring" HeaderText="Employee Name">
                                            ...
                                            <MasterTableView CommandItemDisplay="None" AllowAutomaticUpdates="True" DataSourceID="SqlDataSource1"
                                                ...
                                                <Columns>
                                                    <radG:GridBoundColumn Display="false" ReadOnly="True" DataField="ID" DataType="System.Int32"
                                                        UniqueName="ID" Visible="true" SortExpression="ID" ShowFilterIcon="false" FilterControlAltText="" HeaderText="ID">
                                                        <ItemStyle Width="0px" />
                                                    </radG:GridBoundColumn>
                                                    <radG:GridClientSelectColumn UniqueName="Assigned">
                                                        <HeaderStyle Width="30px" HorizontalAlign="Center" />
                                                    ...
                                                    <radG:GridBoundColumn DataField="Emp_Name" DataType="System.String" UniqueName="Emp_Name"
                                                        Visible="true" SortExpression="Emp_Name" ShowFilterIcon="false" FilterControlAltText="cleanstring" HeaderText="Employee Name" AllowFiltering="true" AutoPostBackOnFilter="true">
                        ...
                        <td valign="top">
                            ...
                            &nbsp;</td>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server"
                                        SelectCommand="Select Emp_Code, (Emp_Name+' '+Emp_LName) Emp_Name,'Assigned' = Case  When EC.Team_ID is null Then CAST(0 AS bit) Else CAST(1 AS bit) End,EA.Time_Card_No From Employee EA Left Outer Join (Select EA.Emp_ID,EA.Team_ID From TeamAppraisalAssigned EA Inner Join Employee EM On EA.Emp_ID = EM.Emp_Code Where   EM.termination_date IS NULL AND EM.Company_ID=@company_id And EA.Team_ID=@RosterID  And EM.[StatusID]=1) EC On EA.Emp_Code = EC.Emp_ID Where EA.[StatusID]=1  And EA.Company_ID=@company_id And EC.Team_ID is null And @RosterID > -1 And (EA.Time_Card_No is not null  And EA.Time_Card_No !='') And EA.Emp_Code not in(Select Distinct EA.Emp_ID From TeamAppraisalAssigned EA  Where EA.Team_ID!=@RosterID) and EA.Emp_Code in(Select Distinct Ew.Emp_ID From [EmployeeAssignedToWorkersList] Ew WHERE EA.termination_date IS NULL)  Order By EA.Emp_name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" SelectCommand="Select EA.ID,EA.Team_ID,EA.Emp_ID,(Emp_Name+' '+Emp_LName) Emp_Name,EM.Time_Card_No From TeamAppraisalAssigned EA  Inner Join Employee EM On EA.Emp_ID = EM.Emp_Code Where EA.Team_ID=@RosterID And EM.StatusID=1  AND  EM.termination_date IS  NULL Order By Emp_Name">
                                        <SelectParameters>
                                            <asp:SessionParameter Name="company_id" SessionField="Compid" Type="Int32" />
                                            <asp:ControlParameter ControlID="ddlRoster" Name="RosterID" PropertyName="SelectedValue"
                                                Type="Int32" />
    ...
    <script type="text/javascript">
        ...
        window.onload = function () {
         ...
         $("#buttonAdd").click(function () {
             if ($("#ddlRoster").val() == "-1")
            {
                 WarningNotification("Select Team Name first");
                return false;
            }
            var _msg = "";
