<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ScheduleAppraisal.aspx.cs" Inherits="SMEPayroll.Appraisal.ScheduleAppraisal" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title">Scheduled Appraisal</h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
