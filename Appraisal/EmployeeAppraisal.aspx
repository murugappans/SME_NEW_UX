<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeAppraisal.aspx.cs" Inherits="SMEPayroll.Appraisal.EmployeeAppraisal" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <label id="txtMainLabel">Test</label>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table  class="table table-striped table-bordered table-hover  order-column layout-fixed appraisal" id="sample_3">
                                    <thead>
                                        <tr>
                                            <th class="rgHeader sno">SNo.</th>
                                            <th class="rgHeader obj">Objective</th>
                                            <th class="rgHeader rpl">Reply</th>
                                            <th class="rgHeader rmk">Remarks</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbvalues">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <input type="submit" value="Submit" id="btnSaveappraisal" class="btn red" />
                            </div>
                        </div>
    ...
    <script src="../Appraisal/AppraisalScripts/EmployeeAppraisal.js" type="text/javascript"></script>
