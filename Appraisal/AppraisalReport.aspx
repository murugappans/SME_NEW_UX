<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="true" CodeBehind="AppraisalReport.aspx.cs" Inherits="SMEPayroll.Appraisal.AppraisalReport" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form2" runat="server">
                            ...
                            <div class="search-box padding-tb-10 clearfix">
                                <div class="form-inline col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="cmbEmployee" OnDataBound="cmbEmployee_DataBound" class="textfields form-control input-sm" runat="server"
                            ...
                            <DateInput ID="DateInput1" runat="server" Skin="" CssClass="form-control input-sm" DateFormat="dd-MM-yyyy">
                                    ...
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <asp:ImageButton ID="imgbtnfetch" CssClass="btn"  runat="server" ImageUrl="~/frames/images/toolbar/go.ico" />
                                    </div>
                                </div>
...
<asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="List"
    ...
    Display="None" ErrorMessage="Appraisal Report - From Date Required!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="RadDatePickerTo"
    Display="None" ErrorMessage="Appraisal Report - From Date Required!" SetFocusOnError="True"></asp:RequiredFieldValidator>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
    Display="None" ErrorMessage="Appraisal Report - Employee Name Required!" InitialValue="-select-" ControlToValidate="cmbEmployee"></asp:RequiredFieldValidator>
                             <asp:CompareValidator ID="cmpEndDate" runat="server" ErrorMessage="Appraisal Report : To date cannot be less than start date" 
 ControlToCompare="RadDatePickerFrom" ControlToValidate="RadDatePickerTo" 
 Operator="GreaterThanEqual" Type="Date"> </asp:CompareValidator>


                          

         <asp:Panel ID="pnlreport" runat="server"> </asp:Panel>
