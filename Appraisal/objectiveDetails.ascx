<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="objectiveDetails.ascx.cs" Inherits="SMEPayroll.Appraisal.objectiveDetails" %>
...
<div class="clearfix form-style-inner">
    ...
    <div class="col-sm-12">
            ...
            <div class="form">
                <div class="form-body">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-10">
                            <radA:RadAjaxPanel ID="r1" runat="Server">
                                ...
                                <asp:Label ID="lblemployee_name" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.Employee")%>' Width="120px" CssClass="bodytxt"></asp:Label>
                            </radA:RadAjaxPanel>
                        </div>
                    </div>
                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-10">
                            <asp:DropDownList ID="drperformance" runat="server" CssClass="form-control input-inline input-sm input-medium">
        ...
        <div class="col-sm-6">
            <radG:RadGrid ID="RadGridremarks" runat="server" PageSize="10" DataSourceID="SqlDataSourceremarks" GridLines="None" Skin="Outlook" Width="100%" Height="100%" >
...
<script type="text/javascript">
    $("#btnRemarkUpdate").click(function () {
        if ($("#drstatus").val() == "Complete" && $("#drperformance").val() == "0") {
            alert("As Objectives has been marked Complete the performance of the employee should be rated.. ")
        }
    });
