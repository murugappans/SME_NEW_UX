<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraisalAllList.aspx.cs" Inherits="SMEPayroll.Appraisal.AppraisalAllList" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_3">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="rgHeader">Approved</th>
                                            <th class="rgHeader">Status</th>
                                            <%--<th class="rgHeader">Show</th>--%>
                                        </tr>
                                    </thead>
                                    <tbody id="tbvalues">
    ...
    <script src="../appraisal/AppraisalScripts/AllAppraisalList.js" type="text/javascript"></script>
