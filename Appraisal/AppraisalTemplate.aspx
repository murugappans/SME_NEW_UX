<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraisalTemplate.aspx.cs" Inherits="SMEPayroll.Appraisal.WebForm3" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet light portlet-fit bordered RadGrid">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="appraisalTemplates table table-striped table-hover table-bordered" id="sample_editable_1">
                                    <thead>
                                        <tr>
                                            <th class="rgHeader">Name </th>
                                            <th class="rgHeader">Active </th>
                                            <th style="display: none">Id </th>
                                            <th class="rgHeader width-50px">Edit </th>
                                            <th class="rgHeader width-50px">Delete </th>
                                            <th class="rgHeader width-50px">Mapping </th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbAppraisalTemplate">
                                        </tbody>
                                    <tfoot>
                                        <tr>
                                            <td colspan="5">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body RadGrid">
                ...
                <div class="modal-footer">
                    <button type="button" id="btnsavemodal" class="btn  red">Save</button>
    ...
    <script src="../Appraisal/AppraisalScripts/AppraisalTemplate.js" type="text/javascript"></script>
