<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraisalCategory.aspx.cs" Inherits="SMEPayroll.Appraisal.WebForm1" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="display:none" >Objective </th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbobjectives">                                     
                                   </tbody>
                                    <tfoot>
                                        <tr>
                                            <td colspan="5">
                           ...
                           <table class="table table-striped table-bordered table-hover table-checkable order-column " id="sample_2">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="rgHeader">Category </th>
                                                <th class="rgHeader">Objective Name </th>
    ...
    <script src="../Appraisal/AppraisalScripts/AppraisalCategory.js" type="text/javascript"></script>
