<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppraisalRequest.aspx.cs" Inherits="SMEPayroll.Appraisal.AppraisalRequest" %>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title">Appraisal Requests</h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form id="form2" runat="server">
                            ...
                            <radG:RadGrid ID="RadGrid1" runat="server" AllowSorting="True"
                                ...
                                <MasterTableView DataSourceID="SqlDataSource2" AllowAutomaticDeletes="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <radG:GridBoundColumn DataField="Employee" UniqueName="Employee" SortExpression="Employee"
                                            HeaderText="Employee">
                                            <ItemStyle Width="15%" />
                                        </radG:GridBoundColumn>
                            ...
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" SelectCommand="select eo.*,e.emp_name as Employee from Appraisal_Request eo inner join employee e on e.emp_code = eo.EmpId where eo.MgrId=@mgrId order by RequestDate desc">
                                <SelectParameters>
