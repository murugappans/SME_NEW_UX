$(document).ready(function () {
    ...
    $.ajax({
        type: "POST",
        url: "ManagerAppraisalList.aspx/GetAppraisals",
        async: false,
        ...
        success: function (response) {
            ...
            for (var i = 0; i < obj.datatb.length; i++) {
                ...
                str += '<tr><td>' + obj.datatb[i].AppraisalYear + '</td><td>' + obj.datatb[i].AppraisalName + '</td><td>' + obj.datatb[i].EmployeeName + '</td><td>' + obj.datatb[i].Designation + '</td>';
