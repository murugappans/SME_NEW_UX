<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTeamAppraisal.aspx.cs" Inherits="SMEPayroll.Appraisal.ManageTeamAppraisal" %>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        <li>Manage Team for Appraisal</li><!-- muru -->
                        <li>
                ...
                <tr>
                    <td>--%>
                                ...
                                <radG:RadGrid ID="RadGrid1" runat="server" OnDeleteCommand="RadGrid1_DeleteCommand" OnItemCommand="RadGrid1_ItemCommand"
                                    ...
                                    OnItemUpdated="RadGrid1_ItemUpdated" PageSize="10" PagerStyle-AlwaysVisible ="true" PagerStyle-Mode="NextPrevAndNumeric" AllowPaging="true">
                                    <MasterTableView CommandItemDisplay="Bottom" AllowAutomaticUpdates="True" DataSourceID="SqlDataSource1"
                                        ...
                                        <Columns>
                                            ...
                                            <radG:GridBoundColumn DataField="Team_Name" UniqueName="Team_Name" HeaderText="Team Name" FilterControlAltText="cleanstring"
                                                SortExpression="Team_Name" AllowFiltering="true" AutoPostBackOnFilter="true" ShowFilterIcon="false"
                                            ...
                                            <radG:GridButtonColumn ButtonType="ImageButton" CommandName="Delete" Text="Delete"
                                                ...
                                                <ItemStyle Width="35px" HorizontalAlign="Center" CssClass="MyImageButton cnfrmDelete" />
                                            <HeaderStyle Width="35px" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" InsertCommand="INSERT INTO [TeamAppraisal] (Company_ID, [Team_Name]) VALUES (@company_id, @Team_Name)"
                                    SelectCommand="SELECT [id], [Team_Name] FROM [TeamAppraisal]  WHERE [company_id] = @company_id"
                                    UpdateCommand="UPDATE [TeamAppraisal] SET [Team_Name] = @Team_Name WHERE [id] = @id">
                                    <SelectParameters>
