<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAppraisalList.aspx.cs" Inherits="SMEPayroll.Appraisal.Model.MyAppraisalList" %>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white page-md page-sidebar-closed" onload="ShowMsg();">
                                    ...
                                    <thead>
                                        <tr>
                                           ...
                                           <th class="rgHeader">Status</th>
                                            <th class="rgHeader">Rply to Appraisal</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tbvalues">
    ...
    <script src="../Appraisal/AppraisalScripts/MyAppraisalList.js" type="text/javascript"></script>
