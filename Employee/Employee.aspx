            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                        <li>Employment Management Form</li>
                        <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <form id="form1" runat="server">
                             ...
                             <div class="clearfix heading-box">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <radG:RadToolBar ID="tbRecord" runat="server" Width="100%" Skin="Office2007" UseFadeEffect="True"
                                                        OnButtonClick="tbRecord_ButtonClick" OnClientButtonClicking="PrintRadGrid" EnableImageSprites="True" BorderWidth="0px">
                                                        ...
                                                        <Items>
                                                            ...
                                                            <radG:RadToolBarButton runat="server" CommandName="Print"
                                                                Text="Print" ToolTip="Print" SpriteCssClass="fa fa-print">
                                                        ...
                                                        <%--    <radG:RadToolBarButton runat="server" CommandName="PDF" Text="PDF" ToolTip="PDF"></radG:RadToolBarButton>--%>
                            ...
                            <radG:RadGrid AllowMultiRowSelection="true" ID="RadGrid1" runat="server" EnableLinqExpressions="False"
                                        AutoGenerateColumns="False" Skin="Outlook" Width="100%" AllowPaging="true"
                                        ...
                                        <MasterTableView CommandItemDisplay="Bottom" DataKeyNames="emp_code" TableLayout="Auto" PagerStyle-Mode="Advanced">
                                            ...
                                            <Columns>
                                                <radG:GridBoundColumn ShowFilterIcon="False" CurrentFilterFunction="StartsWith" UniqueName="EmpCode" HeaderImageUrl="../frames/images/EMPLOYEE/Grid- employee.png"
                                                    HeaderText="Emp Code" DataField="emp_code" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring"
                                                    Display="false">
                                                </radG:GridBoundColumn>

                                                <radG:GridTemplateColumn AllowFiltering="False" UniqueName="TemplateColumn" HeaderText="" >
                                                    <ItemTemplate>
                                                ...
                                                <radG:GridBoundColumn ShowFilterIcon="False" UniqueName="emp_name" HeaderText="Employee Name"
                                                    DataField="emp_name" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="alphabetsonly">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                    <%--<HeaderStyle Width="300px" />--%>
                                                </radG:GridBoundColumn>
                                                <radG:GridBoundColumn ShowFilterIcon="False" UniqueName="emp_type" HeaderText="Pass Type"
                                                    DataField="emp_type" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                    <%--<HeaderStyle Width="90px" />--%>
                                                </radG:GridBoundColumn>
                                                <radG:GridBoundColumn ShowFilterIcon="False" UniqueName="ic_pp_number" HeaderText="IC/FIN Number"
                                                    DataField="ic_pp_number" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                                <radG:GridBoundColumn ShowFilterIcon="False" UniqueName="empgroupname" HeaderText="Type"
                                                    DataField="empgroupname" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                                ...
                                                <radG:GridBoundColumn Display="true" ShowFilterIcon="False" UniqueName="Designation"
                                                    ...
                                                    AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                                ...
                                                <radG:GridBoundColumn Display="false" ShowFilterIcon="False" UniqueName="hand_phone"
                                                    HeaderText="Mobile" DataField="hand_phone" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                                    ...
                                                    <ItemTemplate>
                                                        <tt class="bodytxt">
                                                            <asp:ImageButton ID="btnedit" ToolTip="Edit" CssClass="fa edit-icon" AlternateText=" "
                                                                runat="server" />
                                                            <%--<button ID="btnedit" AlternateText="Edit" runat="server" class="fa fa-pencil"></button>--%>
                                                            <%--<input type="image" ID="btnedit" AlternateText="Edit" runat="server"  />--%>
                                                    </ItemTemplate>
                                                ...
                                                <radG:GridBoundColumn Display="false" ShowFilterIcon="False" UniqueName="Nationality" HeaderText="Nationality"
                                                    DataField="Nationality" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                                <radG:GridBoundColumn Display="false" ShowFilterIcon="False" UniqueName="Trade" HeaderText="Trade"
                                                    DataField="Trade" CurrentFilterFunction="contains" AutoPostBackOnFilter="true" FilterControlAltText="cleanstring">
                                                    <HeaderStyle HorizontalAlign="left" />
                                                </radG:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
          window.onload = function () {
              CallNotification("<%=Session["Message"] %>");
           '<%Session["Message"] = ""; %>';
