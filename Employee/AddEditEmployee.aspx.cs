...
namespace SMEPayroll.employee
{
    public partial class AddEditEmployee : System.Web.UI.Page
    {
        ...
        protected void ddlHalfSal_SelectedIndexChanged(object o, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
        {
            if (ddlHalfSal.SelectedValue == "3")
            {
        ...
        {
            RadGrid4.MasterTableView.GetColumn("TemplateColumn").Visible = false;
            RadGrid4.MasterTableView.GetColumn("EditColumn").Visible = false;
            RadGrid4.MasterTableView.GetColumn("DeleteColumn").Visible = false;// UniqueName="DeleteColumn"
        }
        protected void tbRecord_ButtonClick(object sender, Telerik.Web.UI.RadToolBarEventArgs e)
        {
            ...
            obj2.ToolbarButtonClick(e, RadGrid4, Utility.ToString(Session["Username"]));

        }
        protected void HideGridColumnseCerificateExport()
        {
            ...
            RadGrid5.MasterTableView.GetColumn("DeleteColumn").Visible = false;// UniqueName="DeleteColumn"
        }
      
        protected void tbCertificateRecord_ButtonClick(object sender, Telerik.Web.UI.RadToolBarEventArgs e)
        {
            if (e.Item.Text == "Excel" || e.Item.Text == "Word")
            {
                HideGridColumnseCerificateExport();
            }

            GridSettingsPersister obj2 = new GridSettingsPersister();
            obj2.ToolbarButtonClick(e, RadGrid5, Utility.ToString(Session["Username"]));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["mobilescancode"] == null)
            {
           ...
           // }
            ...
            //    cmbclaimsupervisor.Disabled = true;
            //}
            ...
            if (emp_code != null)
            {
                ...
                tbsEmp.Tabs[0].Visible = false;
                tbsEmp12.PageViews[0].Visible=false;
                //tabQucikInfo.Visible = false;
              
                Page.ClientScript.RegisterStartupScript(GetType(), "field", "LoadSaveControlStatus();", true);
                rdTerminationDate.Enabled = true;
                txtterminreason.Disabled = false;
                
            }
            else
            {
                rdTerminationDate.Enabled = false;
                txtterminreason.Disabled = true;
            ...
            if (!IsPostBack)
            {
                ...
                LoadFormValues(Convert.ToInt32 (emp_code));
                drpCurrBank1.Enabled = false;
                drpCurrBank2.Enabled = false;
                ...
                if (rdPRDate.SelectedDate==null)
                {
                    rdPRDate.Enabled=false;
                }
                else
                {
                    rdPRDate.Enabled = true ;
                }
            }
            if (oHidden.Value == "Save" || oHidden.Value == "QuickSave")
            {
                EmpSave();
            }
            ...
            if (!IsPostBack)
            {
                RadGrid5.ExportSettings.FileName = "Certificate_Info";//muru
                RadGrid4.ExportSettings.FileName = "Family_Info";
                ...
                //GetEmployeeCPFStatus();
                //GetEmployerCPFStatus();
                //-----murugan
                string s = "select WorkFlowID,WFPAY,WFLEAVE,WFCLAIM,WFTimeSheet from company where company_id=" + compid;
                SqlDataReader dr10 = DataAccess.ExecuteReader(CommandType.Text, s, null);
                if (dr10.Read())
                {
                    if (dr10[0].ToString() == "1")
                    {
                        cmbLeaveApproval.Disabled = true;
                        cmbCliamApproval.Disabled = true;
                        cmbTimesheetApproval.Disabled = true;
                        cmbpayrollsupervisor.Disabled = true;
                        if (dr10["WFLEAVE"].ToString() == "1")
                        {
                            cmbLeaveApproval.Disabled = false;
                        }
                        if (dr10["WFCLAIM"].ToString() == "1")
                        {
                            cmbCliamApproval.Disabled = false;
                        }
                        if (dr10["WFTimeSheet"].ToString() == "1")
                        {
                            cmbTimesheetApproval.Disabled = false;
                        }

                     }                    
                    else if (dr10[0].ToString() == "2")
                    {
                        cmbLeaveApproval.Disabled = true;
                        cmbCliamApproval.Disabled = true;
                        cmbTimesheetApproval.Disabled = true;
                        cmbpayrollsupervisor.Disabled = false;
        ...
        protected List<DateTime> Load_Off_Days_FullandHalf(string R)//added by Sandi on 3/8/2014
        {
            ...
            {               
                ...
                {
                    //Response.Write("File Creation failed. Reason is as follows : " + i.ToString());
                    _actionMessage = "Warning|File Creation failed. Reason is as follows : " + i.ToString();
        ...
        protected void btnClearOff_Click(object sender, System.EventArgs e)//added by Sandi on 3/8/2014
        {
           ...
           // ShowMessageBox("Successfully clear off day from database for this month");
            _actionMessage = "success|Successfully clear off day from database for this month";
            ViewState["actionMessage"] = _actionMessage;
        }
        protected void btnsavecal_Click(object sender, System.EventArgs e)//added by Sandi on 3/8/2014
        {
            ...
            {      
               ...
               // ShowMessageBox("Successfully save in database");
                _actionMessage = "Success|Successfully saved in database";
                ViewState["actionMessage"] = _actionMessage;
            }
            catch (Exception ex) { }
        }
        ...
        private void LoadBankGrid()
        {
            if (emp_code.ToString().Length > 0)
            {
                ...
                string str = " Select E.ID,B1.[Desc] FromBank,G1.Bank_AccountNo FromBankAcNo, B2.[Desc] ToBank, E.Giro_Acct_Number,E.Giro_Branch,E.Giro_Acc_Name,E.Percentage,(Select Currency from Currency where id= E.CurrencyBank) Currency,E.Remarks  From EmployeeBankInfo E Inner Join GiroBanks G1 On E.Payment_From = G1.ID Inner Join Bank B1 On B1.ID = G1.Bank_ID Inner Join Bank B2 On E.Giro_Bank_ID = B2.ID Where E.Emp_ID=" + emp_code;
        ...
        private void LoadFormValues(int empCode)
        {
            ...
            if (txtEmpCode.Value.Contains("*") == false)
            {
               ...
               // Lateness
                Str += "IsLatenessManval,LatenessRate,";
                Str += "e.IsfulldayLeaveOnHalfDayWork,";

                Str += " c.Leave_Model,CONVERT(VARCHAR(11) ,e.joining_date, 106) joining_date_txt,c.mobileTimeSheet, CONVERT(VARCHAR(11), e.confirmation_date, 106) confirmation_date_txt,trade_id,e.payrollType,e.ComputeCPFFH,e.timesupervisor,e.ComputeFundFH,e.HalfSalary,e.CustomizedCal,e.PREmployeeFullCPF as PREmployeeFullCPF,e.PREmployerFullCPF as PREmployerFullCPF ,e.CliamsupervicerMulitilevel ,e.TimesupervicerMulitilevel,e.AppraisalsupervicerMulitilevel from employee e ";
                ...
                if (EmpSet.Tables[0].Rows[0]["wdays_per_week"] != DBNull.Value)
                {
                    if (EmpSet.Tables[0].Rows[0]["wdays_per_week"].ToString() == "5.5")
                    {
                        //FullDayLeaveDeductionID.Visible = true;
                        fullDay_span.Visible = true;
                    }
                    else
                    {
                        //FullDayLeaveDeductionID.Visible = false;
                        fullDay_span.Visible = false;
                      
                    }
                }
                txtEmpCode.Disabled = true;
                if (Utility.ToInteger(EmpSet.Tables[0].Rows[0]["IsfulldayLeaveOnHalfDayWork"]) == 1)
                {
                    FullDayLeaveDeductionID.Checked = true;  
                }
                ...
                this.LatenessTextBox.Text=Utility.ToString(EmpSet.Tables[0].Rows[0]["LatenessRate"]);

                string islatem=Utility.ToString(EmpSet.Tables[0].Rows[0]["IsLatenessManval"]);
                if (islatem=="True")
                {
                    this.latenesschkbox.Checked=true;
                }
                ...
                //forclime
                cmbCliamApproval.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["CliamsupervicerMulitilevel"]);


                cmbTimesheetApproval.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["TimesupervicerMulitilevel"]);
                cmbAppraisalApproval.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["AppraisalsupervicerMulitilevel"]);
                ...
                txtEmeConPerRem.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["eme_cont_per_rem"]);
                ...
                if (Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployeeFullCPF"]) == "True")
                {
                    rdoEmployeeYes.Checked = true;
                    rdoEmployeeYes.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployeeFullCPF"]);
                }
                else
                {
                    rdoEmployeeNo.Checked = true;
                    rdoEmployeeNo.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployeeFullCPF"]);
                }


                if (Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployerFullCPF"])=="True")
                {
                    rdoEmployerYes.Checked = true;
                    rdoEmployerYes.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployerFullCPF"]);
                }
                else
                {
                    rdoEmployerNo.Checked = true;
                    rdoEmployerNo.Value = Utility.ToString(EmpSet.Tables[0].Rows[0]["PREmployerFullCPF"]);
                }
                ...
                //rdbEmployee.DataSource = EmpSet.Tables[0];
                //rdbEmployee.DataBind();
                //rdbEmployer.DataSource = EmpSet.Tables[0];
                //rdbEmployer.DataBind();
                ...
                if (empCode != 0)
                {
                    tbsEmp.SelectedIndex = 1;
                    tbsEmp.SelectedTab.Enabled = true;
                    tbsEmp12.SelectedIndex = 1;
                }
                else
                {
            ...
            if (rdPRDate != null)
            {
                if (cmbEmpType.Value == "SPR")
                {
                    //resultValue = DateTime.Now.Year - Convert.ToDateTime(PRDate).Year;
                    int monthDiff = ((DateTime.Now.Year * 12) + DateTime.Now.Month) - ((Convert.ToDateTime(rdPRDate.SelectedDate).Year * 12) + Convert.ToDateTime(rdPRDate.SelectedDate).Month) + 1;
                    int years = (int)Math.Floor((decimal)(monthDiff / 12));
                    int months = monthDiff % 12;

                    if (years >= 2)
                    {
                        //tdEmployeeCPFText.Visible = false;
                        //tdEmployeeCPFValue.Visible = false;
                        //tdEmployerCPFText.Visible = false;
                        //tdEmployerCPFValue.Visible = false;
                        rdoEmployeeYes.Visible = false;
                        rdoEmployeeNo.Visible = false;
                        rdoEmployerYes.Visible = false;
                        rdoEmployerNo.Visible = false;
                    }
        ...
        void AddEmployee_DataBinding()
        {
            ...
            cmbLeaveApproval.Items.Insert(0, "-select-");
             ...
             ds_paysupervisor = getDataSet("Select WL.ID, WorkFlowName +' - L'+ + Cast(WL.RowID as varchar(5)) WorkFlowName  From( Select ID,WorkFlowName From EmployeeWorkFlow  Where ID IN (Select Distinct WorkFlowID From EmployeeWorkFlowLevel Where FlowType=3) And Company_ID=" + compid + " ) WF Inner Join EmployeeWorkFlowLevel WL On WF.ID=WL.WorkFlowID Order By WF.WorkFlowName, WL.RowID");
             cmbCliamApproval.DataSource = ds_paysupervisor.Tables[0];
             cmbCliamApproval.DataTextField = ds_paysupervisor.Tables[0].Columns["WorkFlowName"].ColumnName.ToString();
             cmbCliamApproval.DataValueField = ds_paysupervisor.Tables[0].Columns["ID"].ColumnName.ToString();
             cmbCliamApproval.DataBind();
             cmbCliamApproval.Items.Insert(0, "-select-");


             ds_paysupervisor = getDataSet("Select WL.ID, WorkFlowName +' - L'+ + Cast(WL.RowID as varchar(5)) WorkFlowName  From( Select ID,WorkFlowName From EmployeeWorkFlow  Where ID IN (Select Distinct WorkFlowID From EmployeeWorkFlowLevel Where FlowType=4) And Company_ID=" + compid + " ) WF Inner Join EmployeeWorkFlowLevel WL On WF.ID=WL.WorkFlowID Order By WF.WorkFlowName, WL.RowID");
             cmbTimesheetApproval.DataSource = ds_paysupervisor.Tables[0];
             cmbTimesheetApproval.DataTextField = ds_paysupervisor.Tables[0].Columns["WorkFlowName"].ColumnName.ToString();
             cmbTimesheetApproval.DataValueField = ds_paysupervisor.Tables[0].Columns["ID"].ColumnName.ToString();
             cmbTimesheetApproval.DataBind();
             cmbTimesheetApproval.Items.Insert(0, "-select-");

            // for appraisal
            ds_paysupervisor = getDataSet("Select WL.ID, WorkFlowName +' - L'+ + Cast(WL.RowID as varchar(5)) WorkFlowName  From( Select ID,WorkFlowName From EmployeeWorkFlow  Where ID IN (Select Distinct WorkFlowID From EmployeeWorkFlowLevel Where FlowType=5) And Company_ID=" + compid + " ) WF Inner Join EmployeeWorkFlowLevel WL On WF.ID=WL.WorkFlowID Order By WF.WorkFlowName, WL.RowID");
            cmbAppraisalApproval.DataSource = ds_paysupervisor.Tables[0];
            cmbAppraisalApproval.DataTextField = ds_paysupervisor.Tables[0].Columns["WorkFlowName"].ColumnName.ToString();
            cmbAppraisalApproval.DataValueField = ds_paysupervisor.Tables[0].Columns["ID"].ColumnName.ToString();
            cmbAppraisalApproval.DataBind();
            cmbAppraisalApproval.Items.Insert(0, "-select-");
            ...
            //Senthil added- 08/13/2015
            cmbQuickNationality.DataSource = ds_nationality.Tables[0];
            cmbQuickNationality.DataTextField = ds_nationality.Tables[0].Columns["Nationality"].ColumnName.ToString();
            cmbQuickNationality.DataValueField = ds_nationality.Tables[0].Columns["Nationality_ID"].ColumnName.ToString();
            cmbQuickNationality.DataBind();
            cmbQuickNationality.Items.Insert(0, "-select-");
            string nationalityQuickValue = Utility.ToString(DataBinder.Eval(Dataitem, "Nationality_ID"));
            if (nationalityQuickValue != "")
                cmbQuickNationality.Value = nationalityQuickValue.ToString();
            ...
            dtCPF = ds_CPF.Tables[0];
            if (dtCPF.Rows.Count > 0)
            {

                txtCPFNumber.Value = dtCPF.Rows[0]["CSN"].ToString();
                txtCPFNumber.Disabled = true;
            }
            ...
            //Senthil added- 08/13/2015
            cmbQuickRace.DataSource = ds_Race.Tables[0];
            cmbQuickRace.DataTextField = ds_Race.Tables[0].Columns["Race"].ColumnName.ToString();
            cmbQuickRace.DataValueField = ds_Race.Tables[0].Columns["Race_ID"].ColumnName.ToString();
            cmbQuickRace.DataBind();

            cmbQuickRace.Items.Insert(0, new ListItem("-select-", "-1"));
            string raceQuickValue = Utility.ToString(DataBinder.Eval(Dataitem, "Race_ID"));
            if (raceQuickValue != "")
            {
                cmbQuickRace.Value = raceQuickValue.ToString();
            }
            ...
            //Senthil added-08/13/2015
            //cmbQuickPaymode.DataSource = ds_paymode.Tables[0];
            //cmbQuickPaymode.DataTextField = ds_paymode.Tables[0].Columns["BANK"].ColumnName.ToString();
            //cmbQuickPaymode.DataValueField = ds_paymode.Tables[0].Columns["id"].ColumnName.ToString();
            //cmbQuickPaymode.EnableViewState = true;
            //cmbQuickPaymode.DataBind();
            //cmbQuickPaymode.Items.Add(new ListItem("Cash", "-1"));
            //cmbQuickPaymode.Items.Add(new ListItem("Cheque", "-2"));
            //cmbQuickPaymode.Items.Insert(0, "-select-");
            //cmbQuickPaymode.Value = "-1";
            //cmbQuickPaymode.Disabled = true;
            ...
            ds_empgroup = getDataSet("select id EmpGroup_id , EmpGroupName from emp_group where Company_id=" + compid + "  UNION ALL select '0' ,'-select-' Order By EmpGroup_id");
            ...
            cmbclaimsupervisor.Items.Insert(0, "-select-");
            ...
            cmbtimesheetsupervisor.Items.Insert(0, "-select-");
            ...
            if (s == 0)
            {
                 if (oHidden.Value == "Save")
                        ...
                        if ((HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMS") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSI") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSAMC") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSMC"))
                    {
                            ...
                            //Senthil Added-08/13/2015
                            string strchkTc = "";
                            strchkTc = "SELECT count(*) FROM employee ep WHERE ep.time_card_no='" + txttimecardno.Value + "'";
                            ...
                            if (intChkEmpTcExsist > 0)
                            {
                                ...
                                //Response.Write(sMsg);
                            _actionMessage = "Warning|Following Fields are missing: Personal Info - Time/Card/Swipe/Punch ID";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        if (EmpName != "" && EmpCode != "")
                        {
                            ...
                            string strtxtEmeConPerRem = txtEmeConPerRem.Value.ToString().Trim();
                            ...
                            if (IsCalculate)
                            {
                                if (chkoptfund.Checked)
                                    optout = 1;
                                if (chkcomputecpffh.Checked || (ddlHalfSal.SelectedValue =="3" && ddlPayrollType.SelectedValue =="2"))
                                    cpffh = 1;
                                if (chkFUNDRequired.Checked || (ddlHalfSal.SelectedValue == "3" && ddlPayrollType.SelectedValue == "2"))
                                    fundfh = 1;
                            ...
                            if (EmpAlias != "" || EmpAlias != null)
                            {
                                ...
                                _actionMessage = "Warning|Employee Alias already have in Users, please define another.";
                                ViewState["actionMessage"] = _actionMessage;
                                return;
                                }
                            }
                            ...
                            //}
                            //Senthil Start
                            bool PREmployeeCPF = false;

                            if (rdoEmployeeYes.Checked)
                            {
                                PREmployeeCPF = true;
                            }
                            else
                            ...
                            bool PREmployerCPF = false;
                            if (rdoEmployerYes.Checked)
                            {
                                PREmployerCPF = true;
                            }
                            else
                            ...
                            //Senthil Start
                            if (rdoEmployeeYes.Checked == true)
                            {
                                parms[i++] = new SqlParameter("@PREmployeeCPF", Utility.ToInteger(PREmployeeCPF));
                            }
                            else
                            {
                                parms[i++] = new SqlParameter("@PREmployeeCPF", Utility.ToInteger(PREmployeeCPF));
                            }
                            if (rdoEmployerYes.Checked == true)
                            {
                                parms[i++] = new SqlParameter("@PREmployerCPF", Utility.ToInteger(PREmployerCPF));
                            }
                            else
                            {
                                parms[i++] = new SqlParameter("@PREmployerCPF", Utility.ToInteger(PREmployerCPF));
                        ...
                        string cliam_supervisorMultilevel;

                        if (cmbCliamApproval.Value == "-select-")
                        {
                            cliam_supervisorMultilevel = "-1";
                        }
                        else
                        {

                            cliam_supervisorMultilevel = cmbCliamApproval.Value;

                        }


                        string time_supervisorMultilevel;

                        if (cmbTimesheetApproval.Value == "-select-")
                        {
                            time_supervisorMultilevel = "-1";
                        }
                        else
                        {

                            time_supervisorMultilevel = cmbTimesheetApproval.Value;

                        }

                        string Appraisal_supervisorMultilevel;


                        if (cmbAppraisalApproval.Value == "-select-")
                        {
                            Appraisal_supervisorMultilevel = "-1";
                        }
                        else
                        {

                            Appraisal_supervisorMultilevel = cmbAppraisalApproval.Value;

                        }
                       

                        parms[i++] = new SqlParameter("@CliamsupervicerMulitilevel", cliam_supervisorMultilevel);
                        parms[i++] = new SqlParameter("@TimesupervicerMulitilevel", time_supervisorMultilevel);
                        parms[i++] = new SqlParameter("@AppraisalsupervicerMulitilevel", Appraisal_supervisorMultilevel);
                            ...
                            try
                            {
                                ...
                                int ucode = Utility.ToInteger(parms[i].Value);
                                    ...
                                    //Senthil-Added Default Grouping For New Employee
                                    IFormatProvider format = new System.Globalization.CultureInfo("en-GB", true);
                                    SqlParameter[] parmsGroup = new SqlParameter[5];
                                    parmsGroup[0] = new SqlParameter("@GroupID", Utility.ToInteger(Session["EmpCode"].ToString()));
                                    parmsGroup[1] = new SqlParameter("@EmpID", Utility.ToString(strEmpCode));
                                    parmsGroup[4] = new SqlParameter("@ValidFrom", DateTime.Now.ToString("dd/MM/yyyy", format));
                                    parmsGroup[2] = new SqlParameter("@Action", Utility.ToString("0"));
                                    parmsGroup[3] = new SqlParameter("@retval", SqlDbType.Int);
                                    parmsGroup[3].Direction = ParameterDirection.Output;

                                    string sGroupSQL = "sp_Employee_Assigned_Group";
                                    DataAccess.ExecuteStoreProc(sGroupSQL, parmsGroup);
                                    ...
                                    _actionMessage = "Warning|Unable to create the password" ;
                                    ViewState["actionMessage"] = _actionMessage;
                                }
                                    else
                                    {
                                    ...
                                    Session["Message"] = "Success|Employee Added Successfully.";
                                    //lblerror.ForeColor = System.Drawing.Color.Green;
                                ...
                                else
                                {
                                    ...
                                    _actionMessage = "Warning|Employee Alias Name already exist in the company. Please choose a different Alias name" ;
                                    ViewState["Message"] = _actionMessage;
                                }
                                }
                            }
                            catch (Exception ex)
                            {
                               ...
                               // lblerror.ForeColor = System.Drawing.Color.Red;
                                ...
                                _actionMessage = "Warning|Username/Alias/Login ID/NRIC/FIN already Exist, Please Enter some other Username" ;
                                ViewState["Message"] = _actionMessage;
                            }
                                //lblerror.Text = ErrMsg;
                            }
                    ...
                    else if (oHidden.Value == "QuickSave") // Senthil-Added-08/13/2015
                    {
                        if ((HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMS") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSI") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSAMC") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSMC"))
                    {
                            ...
                            strchkTc = "SELECT count(*) FROM employee ep WHERE ep.time_card_no='" + txtTimeCardNumber.Value + "'";
                            ...
                            _actionMessage = "Warning|Following Fields are missing: Personal Info - Time/Card/Swipe/Punch ID";
                            ViewState["actionMessage"] = _actionMessage;
                            cmbQuickPassType.SelectedIndex = -1;
                            //Page.RegisterStartupScript("myScript", "<script language=JavaScript>msg();</script>");
                            return;
                            }
                        ...
                        EmpName = txtFirstName.Value.Trim();
                        if (EmpName != "" && EmpCode != "")
                        {
                            //New Logic Applied To Read Licese --Code is Not in Use now ....
                            //if (!SMEPayrollLicensing.CanAddNewEmployee())
                            ...
                            if (RadUpload1.UploadedFiles.Count != 0)
                            {
                                if (Directory.Exists(Server.MapPath(uploadpath)))
                                {
                                    ...
                                    _actionMessage = "Warning|File Already Exist";
                                    ViewState["actionMessage"] = _actionMessage;
                                    Session["Message"] = _actionMessage;
                                    return;
                                    }
                                    else
                                    {
                            ...
                            string Nationality = cmbQuickNationality.Value;
                            string companycode = compcode;
                            string emptype = cmbQuickPassType.Value;
                            string ICPPNumber = txtNRICNumber.Text;
                            string WPExpDate = "";
                            if (rdWPExpDate.IsEmpty == false)
                                WPExpDate = rdWPExpDate.SelectedDate.Value.ToString();
                            string PRDate = "";
                            if (rdQuickPRDate.IsEmpty == false)
                                PRDate = rdQuickPRDate.SelectedDate.Value.ToString();
                            string Phone = txtPhone.Value;
                            string HandPhone = txtHandPhone.Value;
                            string Address = txtAddress.Value;
                            string Country = cmbCountry.Value;
                            string PostalCode = txtPostalCode.Value;
                            string Email = txtEmail.Value;
                            string Sex = cmbQuickSex.Value;
                            string block = txtblock.Value;
                            string unit = txtunit.Value;
                            string level = txtlevel.Value;
                            string street = txtstreet.Value;
                            string Religion = cmbReligion.Value;
                            string Race = cmbQuickRace.Value;
                            string MaritalStatus = cmbMaritalStatus.Value;
                            string PlaceofBirth = cmbbirthplace.Value;


                            if (cmbQuickRefType.SelectedIndex == 0)
                            {
                                txtEmployeeCPFAcctNumber.Value = txtNRICNumber.Text;
                                txtIncomeTaxID.Value = txtNRICNumber.Text;
                            }
                            if (cmbQuickRefType.SelectedIndex == 1)
                            {
                                txtIncomeTaxID.Value = txtNRICNumber.Text;
                                txtEmployeeCPFAcctNumber.Value = "";
                            }
                            ...
                            string IncomeTaxID = txtIncomeTaxID.Value;
                            string DateofBirth = rdBirthDate.SelectedDate.Value.ToString();
                            string EmployeeCPFAcctNumber = txtEmployeeCPFAcctNumber.Value;
                            string EmployerCPFAcctNumber = txtCPFNumber.Value;
                            string GIROBank = txtgirobankname.Value;
                            string GIROCode = "0";
                            string GIROBranch = txtgirobranch.Value;
                            string GIROAccountNo = txtGIROAccountNo.Value;
                            ...
                            string Education = cmbeducation.Value;
                            string JoiningDate = "";
                            if (rdJointingDate.IsEmpty == false)
                                JoiningDate = rdJointingDate.SelectedDate.Value.ToString();
                            ...
                            string emplname = txtQuickLastName.Value;
                            string empcpfgroup = cmbempcpfgroup.Value;
                            string insurance = txtinsurance.Value;
                            string insurance_exp = "";
                            if (rdinsurance.IsEmpty == false)
                            ...
                            string foreignadd1 = txtforeign1.Value;
                            string foreignadd2 = txtforeign2.Value;
                            string TimeCardNo = txtTimeCardNumber.Value;
                            string fpostalcode = txtforeignpostalcode.Value;
                            //Added By Raja(24/11/2008)
                            string v1rate = txtv1rate.Text;
                            string v2rate = txtv2rate.Text;
                            ...
                            if (EmpAlias != "" || EmpAlias != null)
                            {
                                ...
                                {
                                   // ShowMessageBox("Employee Alias already have in Users, please define another.");
                                _actionMessage = "Warning|Employee Alias already have in Use, please define another.";
                                ViewState["actionMessage"] = _actionMessage;
                                Session["Message"]= _actionMessage;
                                return;
                                }
                            ...
                            string sqlCurr4 = "Select CurrencyId from girobanks Where id=-1";
                        ...
                        parms[i++] = new SqlParameter("@AppraisalsupervicerMulitilevel", Appraisal_supervisorMultilevel);
                            ...
                            try
                            {
                                ...
                                int ucode = Utility.ToInteger(parms[i].Value);
                                    ...
                                    string ssqlb1 = "Insert Into EmployeePayHistory (Emp_ID, FromDate, DepartmentID, DesignationID, TradeID, OT_Entitlement, CPF_Entitlement, OT1Rate, OT2Rate, Pay_Frequency, WDays_Per_Week, PayRate, Hourly_Rate_Mode, Hourly_Rate, Daily_Rate_Mode, Daily_Rate) Values ('" + strEmpCode + "','" + strrdFromDate + "','" + Department + "','" + Designation + "','" + Trade + "','" + OTEntitled + "','" + CPFEntitlement + "','" + ot1rate + "','" + ot2rate + "','" + PayFrequency + "'," + wday_per_week + ",EncryptByAsymKey(AsymKey_ID('AsymKey'),'" + PayRate + "'),'" + HourlyRateMode + "','" + HourlyRate + "','" + DailyRateMode + "','" + DailyRate + "')";
                                    DataAccess.FetchRS(CommandType.Text, ssqlb1, null);
                                _actionMessage = "Success|Information for employee Added Successfully.";
                                ViewState["actionMessage"] = _actionMessage;
                                //Added by Jammu Office
                                #region Audit

                                var oldEmp = new Employee_full();

                                string sSQLCheck = "SELECT MAX(emp_code) AS LargestId FROM employee ";  //Added by Jammu Office
                                int NeRecordId = DataAccess.ExecuteScalar(sSQLCheck, null);//Added by Jammu Office

                                var newemployee = new Employee_full()
                                {

                                    EmpCode = NeRecordId,
                                    EmpName = Utility.ToString(EmpName),
                                    EmpAlias = Utility.ToString(EmpAlias),
                                    NationalityId = Utility.ToInteger(Nationality),
                                    EmpType = Utility.ToString(emptype),
                                    ScanCode = Utility.ToString(_ScanCode),
                                    EmpLname = Utility.ToString(emplname),
                                    Empcpftype = Utility.ToInteger(empcpfgroup),
                                    InsuranceNumber = Utility.ToString(insurance),
                                    //InsuranceExpiry = Utility.Todatetime(insurance_exp),
                                    CsocNumber = Utility.ToString(csoc),
                                    //CsocExpiry = Utility.Todatetime(csoc_exp),
                                    Passport = Utility.ToString(passport),
                                    // PassportExpiry = Utility.Todatetime(passport_exp),
                                    IcPpNumber = Utility.ToString(ICPPNumber),
                                    // WpExpDate = Utility.Todatetime(WPExpDate),
                                    //PrDate = Utility.Todatetime(PRDate),
                                    Address = Utility.ToString(Address),
                                    CountryId = Utility.ToInteger(Country),
                                    PostalCode = Utility.ToString(PostalCode),
                                    Phone = Utility.ToString(Phone),
                                    HandPhone = Utility.ToString(HandPhone),
                                    Email = Utility.ToString(Email),
                                    Sex = Utility.ToString(Sex),
                                    ReligionId = Utility.ToInteger(Religion),
                                    RaceId = Utility.ToInteger(Race),
                                    MaritalStatus = Utility.ToString(MaritalStatus),
                                    PlaceOfBirth = Utility.ToString(PlaceofBirth),
                                    //DateOfBirth = Utility.Todatetime(DateofBirth),
                                    IncomeTaxid = Utility.ToString(IncomeTaxID),
                                    EmployeeCpfAcct = Utility.ToString(EmployeeCPFAcctNumber),
                                    EmployerCpfAcct = Utility.ToString(EmployerCPFAcctNumber),
                                    GiroBank = Utility.ToString(GIROBank),
                                    GiroCode = Utility.ToString(GIROCode),
                                    GiroBranch = Utility.ToString(GIROBranch),
                                    GiroAcctNumber = Utility.ToString(GIROAccountNo),
                                    CpfEntitlement = Utility.ToString(CPFEntitlement),
                                    //CpfEmployer = Utility.ToDecimal(EmployerCPF),
                                    DeptId = Utility.ToInteger(Department),
                                    //CpfEmployee = Utility.ToDecimal(EmployeeCPF),
                                    DesigId = Utility.ToInteger(Designation),
                                    TradeId = Utility.ToInteger(Trade),
                                    EmpSupervisor = Utility.ToInteger(supervisor),
                                    EmpClsupervisor = Utility.ToInteger(clsupervisor),
                                    Education = Utility.ToString(Education),
                                    // JoiningDate = Utility.Todatetime(JoiningDate),
                                    //ConfirmationDate = Utility.Todatetime(ConfirmationDate),
                                    EmpGroupId = Utility.ToInteger(EmployeeGroup),
                                    OtEntitlement = Utility.ToString(OTEntitled),
                                    //TerminationDate = Utility.Todatetime(TerminationDate),
                                    TerminationReason = Utility.ToString(terminreason),
                                    PayFrequency = Utility.ToString(PayFrequency),
                                    //// payrate = PayRate =
                                    PaymentMode = Utility.ToString(PayMode),
                                    HourlyRate = Utility.ToDouble(HourlyRate),
                                    HourlyRateMode = Utility.ToString(HourlyRateMode),
                                    DailyRateMode = Utility.ToString(DailyRateMode),
                                    DailyRate = Utility.ToDouble(DailyRate),
                                    WdaysPerWeek = Utility.ToDouble(wday_per_week),
                                    EmailPayslip = Utility.ToString(EmailPaySlip),
                                    FwCode = Utility.ToString(FWLCode),
                                    //  FwLevy = Utility.ToDecimal(MonthlyLevy),
                                    WhTaxPct = Utility.ToDouble(WithHoldTaxPct),
                                    //  WhTaxAmt = Utility.ToDecimal(WithHoldTaxAmt),
                                    SdfRequired = SDFRequired =
                                    CDAC = Utility.ToString(CDAC),
                                    //   MbmfFund = Utility.ToDecimal(MBMF),
                                    //   SindaFund = Utility.ToDecimal(SINDA),
                                    //    EcfFund = Utility.ToDecimal(ECF),
                                    //   CchestFund = Utility.ToDecimal(CCHEST),
                                    FundOptout = Utility.ToInteger(optout),
                                    Remarks = Utility.ToString(Remarks),
                                    Images = Utility.ToString(Img),
                                    ProbationPeriod = Utility.ToInteger(probation),
                                    LeaveCarryForward = 0.0,
                                    GiroAccName = Utility.ToString(giroaccname),
                                    GroupId = Utility.ToInteger(usergroupid),
                                    Localaddress2 = Utility.ToString(localadd2),
                                    BlockNo = Utility.ToString(block),
                                    UnitNo = Utility.ToString(unit),
                                    LevelNo = Utility.ToString(level),
                                    StreetName = Utility.ToString(street),
                                    Foreignaddress1 = Utility.ToString(foreignadd1),
                                    Foreignaddress2 = Utility.ToString(foreignadd2),
                                    TimeCardNo = Utility.ToString(TimeCardNo),
                                    Foreignpostalcode = Utility.ToString(fpostalcode),
                                    //    PpIssueDate = Utility.Todatetime(ppissuedate),
                                    LeavesRemaining = leaves_remainings,
                                    WorkerLevy = cmblevy.Value,
                                    ///    WpApplicationDate = Utility.Todatetime(wpappdate),
                                    //  emp_ref_type = Utility.ToInteger(emp_ref_type),
                                    EmpCategory = Utility.ToInteger(emp_category),
                                    V1Rate = Utility.ToDouble(v1rate),
                                    V2Rate = Utility.ToDouble(v2rate),
                                    V3Rate = Utility.ToDouble(v3rate),
                                    V4Rate = Utility.ToDouble(v4rate),
                                    BatchNo = Utility.ToInteger(batch_no),
                                    //    WpIssueDate = Utility.Todatetime(wp_issuedate),
                                    ShipyardQuota = Utility.ToString(shipyard_quota),
                                    PhotoNo = Utility.ToInteger(photo),
                                    WpNumber = Utility.ToString(wpNumber),
                                    //  tax_borne_employer = Utility.ToString(obj1_tax_borne_employer),
                                    //  tax = Utility.ToString(obj2_tax_borne_employer_options),
                                    //tax_borne_employer_amount = Utility.ToString(obj3_tax_borne_employer_amount),
                                    //pension_out_singapore = Utility.ToString(obj4_pension_out_singapore),
                                    //pension_out_singapore_amount = Utility.ToString(obj5_pension_out_singapore_amount),
                                    //excess_voluntary_cpf_employer = Utility.ToString(obj6_excess_voluntary_cpf_employer),
                                    //excess_voluntary_cpf_employer_amount = Utility.ToString(obj7_excess_voluntary_cpf_employer_amount),
                                    //stock_options = Utility.ToString(obj8_stock_options),
                                    //stock_options_amount = Utility.ToString(obj9_stock_options_amount),
                                    //benefits_in_kind = Utility.ToString(obj10_benefits_in_kind),
                                    //benefits_in_kind_amount = Utility.ToString(obj11_benefits_in_kind_amount),
                                    //retirement_benefits = Utility.ToString(obj12_retirement_benefits),
                                    //retirement_benefits_fundName = Utility.ToString(obj13_retirement_benefits_fundName),
                                    //retirement_benefits_amount = Utility.ToString(obj14_retirement_benefits_amount),
                                    //s45_tax_on_directorFee = Utility.ToString(obj15_s45_tax_on_directorFee),
                                    //cessation_provision = Utility.ToString(obj16_cessation_provision),
                                    //addr_type = Utility.ToString(obj17_addr_type),
                                    //dateofcessationconv = Utility.ToString(obj18_dateofcessationconv),
                                    //dateofcommencementconv = Utility.ToString(obj19_dateofcommencementconv),
                                    //ir8a_year = Utility.ToString(cmbIR8A_year.Value),

                                    Ot1Rate = Utility.ToDouble(ot1rate),
                                    Ot2Rate = Utility.ToDouble(ot2rate),
                                    EmeContPer = Utility.ToString(strtxtEmeConPer),
                                    EmeContPerRel = Utility.ToString(strtxtEmeConPerRel),
                                    EmeContPerPh1 = Utility.ToString(strtxtEmeConPerPh1),
                                    EmeContPerPh2 = Utility.ToString(strtxtEmeConPerPh2),
                                    EmeContPerAdd = Utility.ToString(strtxtEmeConPerAdd),
                                    EmeContPerRem = Utility.ToString(strtxtEmeConPerRem),
                                    Bloodgroup = Utility.ToString(strtxtBloodGroup),
                                    AgentId = Utility.ToInteger(stragent_id),
                                    MyeCertId = Utility.ToInteger(strmye_cert_id),
                                    //WpArrivalDate = Utility.Todatetime(wp_arrivaldate),
                                    PaySupervisor = Utility.ToInteger(pay_supervisor),
                                    Payrolltype = Utility.ToInteger(ddlPayrollType.SelectedValue.ToString()),
                                    ComputeCpffh = Utility.ToInteger(cpffh),
                                    //    tssupervisor = Utility.ToInteger(tssupervisor),
                                    ComputeFundFh = Utility.ToInteger(fundfh),
                                    HalfSalary = Utility.ToInteger(salhalf),
                                    LeaveSupervisor = Utility.ToInteger(leave_supervisor),
                                    PaymentType = Utility.ToInteger(radListPayType.SelectedValue),
                                    CurrencyBank = Utility.ToInteger(drpCurrBank1.SelectedValue),
                                    PaymentPart = Utility.ToInteger(drpPaymentMode.SelectedValue),
                                ...
                                AuditRepository.CreateAuditTrail(AuditActionType.Create, 305, NeRecordId, oldEmp, newemployee);
                                ...
                                if (returnval == 0)
                                    ...
                                    ViewState["actionMessage"] = "Success|Employee Added Successfully.";
                                    Session["Message"] = "Success|Employee Added Successfully.";
                                    Response.Redirect("Employee.aspx", false);
                                }
                                }
                            ...
                            {
                                string ErrMsg = "Warning|Some error Occured!!" ;
                                //lblerror.ForeColor = System.Drawing.Color.Red;
                                if (ex.Message.IndexOf("PRIMARY KEY constraint", 1) > 0)
                                {
                                //  ErrMsg = "<font color = 'Red'>Username/Alias/Login ID/NRIC/FIN already Exist, Please Enter some other Username</font>";
                                ErrMsg = "Warning|Username/Alias/Login ID/NRIC/FIN already Exist, Please Enter some other Username" ;
                               
                            }
                                _actionMessage = ErrMsg;
                                ViewState["actionMessage"] = _actionMessage;
                            Session["Message"] = _actionMessage;// lblerror.Text = ErrMsg;
                            }
                        }
                    }
            ...
            else
            {
                ...
                if ((HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMS") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSI") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSAMC") || (HttpContext.Current.Session["ANBPRODUCT"].ToString() == "WMSMC"))
                {
                    ...
                    else if (intChkEmpTcExsist_new.ToString() != txttimecardno.Value)
                    {
                        ...
                        if (intChkEmpTcExsist > 0)
                        {
                            ...
                            //Response.Write(sMsg);
                            _actionMessage = "Warning|Time/Card/Swipe/Punch ID Already Exist";
                            ViewState["actionMessage"] = _actionMessage;
                            Session["Message"] = _actionMessage;
                            return;
                        }
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0 && TerminationDate.ToString().Length > 1)
                    {
                        ...
                        ViewState["actionMessage"] = _actionMessage;
                        Session["Message"]  = _actionMessage;//strMsg + TerminateEmpMessage;
                    ...
                    else
                    {
                        if ((cmbclaimsupervisor.Value != "" && cmbsupervisor.Value != "" && cmbpayrollsupervisor.Value != "") && TerminationDate.ToString().Length > 1)
                        {
                            ...
                            Session["Message"] = _actionMessage;//strMsg;
                        ...
                        if (IsCalculate)
                        {
                            ...
                            string cliam_supervisor;

                            if (cmbclaimsupervisor.Value == "-select-")
                            {
                                cliam_supervisor = "-1";
                            }
                            else
                            {
                                ...
                                cliam_supervisor = cmbclaimsupervisor.Value;
                            ...
                            if (EmpAlias != "" || EmpAlias != null)
                            {
                                ...
                                if (foundRows.Length > 0)
                                {
                                   // ShowMessageBox("Employee Alias already have in Users, please define another name.");
                                    _actionMessage = "Warning|Employee Alias already have in Users, please define another name.";
                                    ViewState["actionMessage"] = _actionMessage;
                                    Session["Message"] =_actionMessage;
                                    return;
                                }
                            ...
                            //Senthil End
                            int i = 0;
                            SqlParameter[] parms = new SqlParameter[148];
                            ...
                            if (rdoEmployeeYes.Checked == true)
                            {
                                parms[i++] = new SqlParameter("@PREmployeeCPF", Convert.ToBoolean(PREmployeeCPF));
                            }
                            else
                            {
                                parms[i++] = new SqlParameter("@PREmployeeCPF", Convert.ToBoolean(PREmployeeCPF));
                            ...
                            if (rdoEmployerYes.Checked == true)
                            {
                                parms[i++] = new SqlParameter("@PREmployerCPF", Convert.ToBoolean(PREmployerCPF));
                            }
                            else
                            {
                                parms[i++] = new SqlParameter("@PREmployerCPF", Convert.ToBoolean(PREmployerCPF));
...
var oldEmp = EmployeeRepository.GetEmp_full(Utility.ToInteger(employeecode));
                            ...
                            var newemployee = new Employee_full()
                            {
                                ...
                                EmpCode = Utility.ToInteger(employeecode),
                                EmpName = Utility.ToString(EmpName),
                                EmpAlias = Utility.ToString(EmpAlias),
                                NationalityId = Utility.ToInteger(Nationality),
                                EmpType = Utility.ToString(emptype),
                            ...
                            var _emcode =Convert.ToInt32(employeecode);
                            AuditContext _context = new AuditContext();
                            var com = _context.Employees.Where(x => x.EmpCode == _emcode).SingleOrDefault();
                            var AuditRepository = new AuditRepository();

                              AuditRepository.CreateAuditTrail(AuditActionType.Update,305, oldEmp.EmpCode, oldEmp, newemployee);
                            ...
                            try
                            {
                                ...
                                if (activeSuperAdminCount > 1 && TerminationDate != "")
                                {
                                    ...
                                    if (retVal >= 1)
                                    {
                                        strMsg = "Success|Employee Information Updated Successfully.";
                                    }
                                }
                                else if (activeSuperAdminCount == 1 && TerminationDate != "")
                                {
                                    strMsg = "Warning|Termination Date cannot be updated for the ONLY SuperAdmin user in the system.";
                                }
                                else
                                {
                                    retVal = DataAccess.ExecuteStoreProc(sSQL, parms);
                                    ...
                                    else
                                    {
                                        ...
                                        strMsg = "Warning|Employee Alias already exists. Please choose a different alias name";
        ...
        public static bool EmployeeFullCPF(string employeeType, string PRDate)
        {
            ...
            if (PRDate != null)
            {
                ...
                {
                    //resultValue = DateTime.Now.Year - Convert.ToDateTime(PRDate).Year;
                    int monthDiff = ((DateTime.Now.Year * 12) + DateTime.Now.Month) - ((Convert.ToDateTime(PRDate).Year * 12) + Convert.ToDateTime(PRDate).Month) + 1;
                    //int years = (int)Math.Floor((decimal)(monthDiff / 12));
                    //int months = monthDiff % 12;
                    resultValue = monthDiff<=24;
                }                                          
            }
            return resultValue;
        }
        ...
        [System.Web.Services.WebMethod]
        public static string CalDailyRates(float payrate, float workingdays)
        {
            string valResult = "";
            string SQL = "select dbo.fn_GetDailyRate(" + payrate + "," + workingdays + ")";
            SqlDataReader dr = DataAccess.ExecuteReader(CommandType.Text, SQL, null);
        ...
        [System.Web.Services.WebMethod]
        public static string GetNRI_Check(string nricType, string nricVal)
        {
            nricVal = nricVal.ToUpper();
            string retVal = "no";
            if (nricType == "5")
            ...
            if (EmpCode != "")
            {
                ...
                if (dsauto.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow theRow in dsauto.Tables[0].Rows)
                    {
                        ...
                        if (rdoEmployeeYes.Checked == true)
                        {
                            parms[i++] = new SqlParameter("@PREmployeeCPF", Utility.ToInteger(rdoEmployeeYes.Value));
                        }
                        else
                        {
                            parms[i++] = new SqlParameter("@PREmployeeCPF", Utility.ToInteger(rdoEmployeeNo.Value));
                        }
                        if (rdoEmployerYes.Checked == true)
                        {
                            parms[i++] = new SqlParameter("@PREmployerCPF", Utility.ToInteger(rdoEmployerYes.Value));
                        }
                        else
                        {
                            parms[i++] = new SqlParameter("@PREmployerCPF", Utility.ToInteger(rdoEmployerNo.Value));
                        }

                        //Senthil End

                        parms[i++] = new SqlParameter("@ScanCode", "");
                       ...
                       parms[i].Direction = ParameterDirection.Output;
                        ...
                        try
                        {
                            ...
                            if (retVal >= 1)
                            {
                                ...
                                _actionMessage = "success|Employees Imported Successfully.";
                                ViewState["actionMessage"] = _actionMessage;
                                Session["Message"]= _actionMessage;
                                int ucode = Utility.ToInteger(parms[i].Value);
                                string password1 = companycode + "_" + ucode;
                        ...
                        catch (Exception ex)
                        {
                            ...
                            if (ErrMsg.IndexOf("PRIMARY KEY constraint", 1) > 0)
                            {
                                ...
                                _actionMessage = "Warning|Username already Exist, Please Enter some other Username";
                                ViewState["actionMessage"] = _actionMessage;
                                Session["Message"]= _actionMessage;
                            }
                          //  lblerror.Text = ErrMsg;
                    ...
                    if (iCountSuccess > 0)
                    {
                        ...
                        _actionMessage = "success|" +Convert.ToString(iCountSuccess.ToString()) + " Employees Imported Successfully.<br/>";
                    ...
                    if (iCountFail > 0)
                    {
                        ...
                        _actionMessage += Convert.ToString(iCountFail.ToString()) + " Employees Failed to Import.";
                       
                    }
                  //ShowMess(lblerror.Text);
                    ViewState["actionMessage"] = _actionMessage;
                    Session["Message"]= _actionMessage;
                    //if (iCountSuccess == 0)
                    //{
        ...
        protected void btnQuickBulkInsert_Click(object sender, EventArgs e)
        {
        ...
        {
            string sqlQry = "select * from EmployeeBankInfo where Giro_Acct_Number='" + txtSBGIROAccountNo.Value.ToString().Trim()+"'";

            SqlDataReader sqldr;
            sqldr = DataAccess.ExecuteReader(CommandType.Text, sqlQry, null);
            if (sqldr.Read())
            {
                ViewState["actionMessage"] = "Warning|Secondary bank information not saved. Bank Info already exists.";
            ...
            try
            {
              ...
              //  SqlDataReader sqldr;
                ...
                DataAccess.FetchRS(CommandType.Text, ssqlb, null);
                LoadBankGrid();
                _actionMessage = "Success|Secondary bank information saved successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
            catch (Exception ex)
            {
        ...
        protected void RadGrid4_GridExporting(object source, GridExportingArgs e)
        {
            ...
            //obj1.ExportGridFamilyHeader("112", Session["CompanyName"].ToString(), Session["Emp_Name"].ToString(),txtEmpCodeHdn.Value, e);

        }
        protected void RadGrid5_GridExporting(object source, GridExportingArgs e)
        {
        //    GridSettingsPersister obj1 = new GridSettingsPersister();
        //    obj1.ExportGridFamilyHeader("113", Session["CompanyName"].ToString(), Session["Emp_Name"].ToString(),txtEmpCodeHdn.Value, e);
        ...
        {
            string path = "../Documents/" + compid + "/" + emp_code + "/" + "Files";
            int retVal=0;
            try
            {
                ...
                SqlDataReader dr = DataAccess.ExecuteReader(CommandType.Text, "select FileName from  DocumentMappedToEmployee where id=" + id, null);
                if (dr.Read())
                {
                    string sSQL = "DELETE FROM [DocumentMappedToEmployee] WHERE [ID] =" + id;
                    retVal = DataAccess.ExecuteStoreProc(sSQL);
                    FileInfo file = new FileInfo(Server.MapPath(path + "/" + dr[0].ToString()));
                    if (file.Exists ==true )
                    {
                    File.Delete(Server.MapPath(path + "/" + dr[0].ToString()));
                    }
                ...
                if (retVal == 1)
                {
                    ...
                    _actionMessage = "success|Document is Deleted Successfully.";
                    ViewState["actionMessage"] = _actionMessage;
                ...
                else
                {
                   // RadGrid3.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Document."));
                    _actionMessage = "Warning|Unable to delete the Document.";
                    ViewState["actionMessage"] = _actionMessage;
                }
            ...
            if (file1.UploadedFiles.Count != 0)
            {
                if (Directory.Exists(Server.MapPath(uploadpath)))
                {
                    ...
                    else
                    {
                        ...
                        DataAccess.FetchRS(CommandType.Text, ssqlb, null);
                        ViewState["actionMessage"] = "Success| File uploaded successfully.";
        ...
        protected void RadGrid4_ItemUpdated(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    DataAccess.FetchRS(CommandType.Text, ssqlb, null);
                    RadGrid4.Rebind();
                    strMessage = "Success|Family Info updated Successfully.";
                    e.Item.Edit = false;
                    _actionMessage = strMessage;
                    ViewState["actionMessage"] = _actionMessage;
                }
        ...
        protected void RadGrid1_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataInsertItem && e.Item.OwnerTableView.IsItemInserted)
            {
                ...
                (insertItem["course_date"].Controls[0] as RadDatePicker).SelectedDate = DateTime.Today;
            }
        }
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                       // RadGrid1.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Training. This Training is in use."));
                        _actionMessage = "Warning|Unable to delete the Training. This Training is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            strMessage = strMessage + "<br/>" + "successs|Training is Deleted Successfully.";
                        }
                        else
                        {
                            strMessage = strMessage + "<br/>" + "Warning|Unable to delete the Training.";
                        }
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                       // RadGrid2.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Safety Pass. This Safety Pass is in use."));
                        _actionMessage = "Warning|Unable to delete the Safety Pass. This Safety Pass is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            strMessage = strMessage + "success|Safety Pass is Deleted Successfully.";
                        }
                        else
                        {
                            strMessage = strMessage  + "Warning|Unable to delete the Safety Pass.";
                        }
        ...
        {// if ((Utility.AllowedAction1(Session["Username"].ToString(), "Certificate Category")) == false)
         ...
         //--------------
            if (e.Item.ItemType == GridItemType.Item || e.Item.ItemType == GridItemType.AlternatingItem)
            {
                string empcode = txtEmpCodeHdn.Value;
                HyperLink h22 = (HyperLink)e.Item.FindControl("h22");
                if (h22.Text.ToString().Trim().Length > 0)
                {
                    h22.NavigateUrl = "../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "certificate" + "/" + h22.Text;
                    h22.ToolTip = "Open Document";
                    h22.Text = "Open Document";

                }
                else
                {
                    h22.Text = "No Document";
                }
            }
        }
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the Certificate. This Certificate is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            ...
                            _actionMessage = "sucsess|Certificate is Deleted Successfully";
                            ViewState["actionMessage"] = _actionMessage;
                        }
                        else
                        {
                            strMessage = strMessage + "<br/>" + "Unable to delete the Certificate.";
                            _actionMessage = "Warning|Unable to delete the Certificate.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void RadGrid5_ItemCommand(object source, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
            {
                if (e.CommandName == "PerformInsert")
                {
                        strMessage = "Warning|Certificate Added successfully.";
                }
                else
                {
                        strMessage = "success|Certificate updated successfully.";
                }
               // ShowMessageBox(strMessage);
                        _actionMessage = strMessage;
                        ViewState["actionMessage"] = _actionMessage;
        ...
        protected void RadGrid4_ItemInserted(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            {
                string sqlQry = "select * from Family where (Relation=" + drpRelation.SelectedValue + " and Emp_ID = " + emp_code + " and dateofbirth = " + strrdDOB + " and Name = '" + strtxtName + "')";
            
                sqlQry += " or (Relation=" + drpRelation.SelectedValue + " and Emp_ID = " + emp_code + " and Name = '" + strtxtName + "')";
                SqlDataReader sqldr;
                sqldr = DataAccess.ExecuteReader(CommandType.Text, sqlQry, null);
                if (sqldr.Read())
                {
                    ViewState["actionMessage"] = "Warning|Family information not saved. This Info already exists.";
                ...
                try
                {
                    ...
                    DataAccess.FetchRS(CommandType.Text, ssqlb, null);
                    RadGrid4.Rebind();
                    strMessage = "Success|Family Info added Successfully.";
                    _actionMessage =  strMessage;
                    ViewState["actionMessage"] = _actionMessage;
                }
                catch (Exception ee)
            ...
            else
            {
                ...
                foreach (GridItem item in RadGrid6.MasterTableView.Items)
                {
                    if (item is GridItem)
                    {
                        ...
                        DateTime  FromDate = Convert.ToDateTime (this.RadGrid6.Items[dataItem.ItemIndex]["FromDateCopy"].Text.ToString());
                        DateTime FromDate2 = Convert.ToDateTime(rdFrom.SelectedDate.ToString());
                        int result = DateTime.Compare(FromDate2, FromDate);
                        if (result>0)
                        {
                            DateTime d = Convert.ToDateTime(rdFrom.SelectedDate.ToString());
                            string ssqlb = " select * from (select max(end_period) m from prepare_payroll_detail,prepare_payroll_hdr where prepare_payroll_detail.trx_id=prepare_payroll_hdr.trx_id and status='G' and emp_id="+ emp_code+") a where a.m>= '" +d.ToString("yyyy-MM-dd") + "'";
                            SqlDataReader dr= DataAccess.ExecuteReader(CommandType.Text, ssqlb, null);
                            if (dr.Read())
                            {
                                strMessage = "Action is not allowed. There are Payroll Records processed for this effective month or later.";
                                //ShowMessageBox(strMessage);
                                _actionMessage = "Warning|"+strMessage;
                                ViewState["actionMessage"] = _actionMessage;
                                strMessage = "";
                        ...
                        {
                            strMessage = "Action is not allowed. There are Progression Info Records of same/later than this effective date.";
                            _actionMessage = "Warning|"+strMessage;
                            ViewState["actionMessage"] = _actionMessage;
                           // ShowMessageBox(strMessage);
                            strMessage = "";
              ...
              int  islatemu = 0;
                ...
                LoadFormValues(Convert.ToInt32 (emp_code));
                strMessage = strMessage + "" + "Pay Records Updated Successfully.";
              //  ShowMessageBox(strMessage);
                _actionMessage = " Success|"+strMessage;
                ViewState["actionMessage"] = _actionMessage;
                strMessage = "";
        ...
        {
            int updatevalue=0;
            if (this.FullDayLeaveDeductionID.Checked)
                updatevalue = 1;

            string sql = "update employee set IsfulldayLeaveOnHalfDayWork = " + updatevalue.ToString() + "where emp_code=" + emp_code;
                        ...
                        if (leaveallowed <= 0 && txtBoxValue1 >= 0)
                        {
                            ...
                            if (Convert.ToInt16(ds.Tables[0].Rows[0]["CntLeave"].ToString()) >= 1)
                            {
                                if (((TextBox)dataItem["LAColumn"].Controls[1]).Text.Trim().ToString().Length > 0)
                                {
                                    ...
                                    //strMessage = "Records Updated Successfully.";
                                    strMessage = "Success|Records Updated Successfully.";
                                }
                                else
                                {
                                    strssqlb = "Delete From EmployeeLeavesAllowed Where Emp_ID=" + emp_code + " And Leave_Type=" + leavetype + " And Leave_Year=" + year;
        ...
        protected void RadGrid7_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            ...
            if ((e.Item.ItemType == GridItemType.Item) || (e.Item.ItemType == GridItemType.AlternatingItem))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    _actionMessage = "Warning|Unable to view record. Reason:"+ ErrMsg;
                    ViewState["actionMessage"] = _actionMessage;
                    e.Canceled = true;
                }
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                       // RadGrid4.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Family which is in use."));
                        _actionMessage = "Warning|Unable to delete the Family which is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                           // RadGrid4.Controls.Add(new LiteralControl("<font color = 'Red'>Family History is Deleted Successfully."));
                            _actionMessage = "Success|Family History is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                           // RadGrid4.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Family History."));
                            _actionMessage = "Warning|>Unable to delete the Family History.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the Bank Info which is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                            ...
                            _actionMessage = "Success|Secondary bank info is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                            ...
                            _actionMessage = "Warning|Unable to delete the Secondary bank info.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                       // RadGrid6.Controls.Add(new LiteralControl("<font color = 'Red'>Unable to delete the Progression which is in use."));
                        _actionMessage = "Warning|Unable to delete the Progression which is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        DateTime d = Convert.ToDateTime(rdFrom.SelectedDate.ToString());
                        string ssqlb = " select * from (select max(end_period) m from prepare_payroll_detail,prepare_payroll_hdr where prepare_payroll_detail.trx_id=prepare_payroll_hdr.trx_id and status='G' and emp_id=" + emp_code + ") a where a.m>= '" + d.ToString("yyyy-MM-dd") + "'";
                        SqlDataReader drr = DataAccess.ExecuteReader(CommandType.Text, ssqlb, null);
                        if (drr.Read())
                        {
                            strMessage = "Action is not allowed. There are Payroll Records processed for this effective month or later.";
                            //ShowMessageBox(strMessage);
                        ...
                        {
                           //---murugan
                            string sql = "select * from [EmployeePayHistory] WHERE [id] =" + id;
                            dr1 = DataAccess.ExecuteReader(CommandType.Text,sql ,null);

                            if (dr1.Read())
                            {
                                sql = "update [EmployeePayHistory] set ToDate=NULL where CONVERT(VARCHAR(19),ToDate,103)='" + Convert.ToDateTime(dr1["FromDate"]).AddDays(-1).ToString("dd/MM/yyyy") + "'";
                            ...
                            if (retVal == 1)
                            {
                               ...
                               // RadGrid6.Controls.Add(new LiteralControl("<font color = 'Red'>Progression History is Deleted Successfully."));
                                _actionMessage = "success|Progression History is Deleted Successfully.";
                                ViewState["actionMessage"] = _actionMessage;
                            ...
                            else
                            {
                                ...
                                _actionMessage = "Warning|Unable to delete Progression History.";
                                ViewState["actionMessage"] = _actionMessage;
                            }
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    if (Convert.ToInt16(dr[0].ToString()) > 0)
                    {
                        ...
                        _actionMessage = "Warning|Unable to delete the Item Issued which is in use.";
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        ...
                        if (retVal == 1)
                        {
                           // radItemIssued.Controls.Add(new LiteralControl("<font color = 'Red'>Item Issued is Deleted Successfully."));
                            _actionMessage = "success|Item Issued is Deleted Successfully.";
                            ViewState["actionMessage"] = _actionMessage;
                        ...
                        else
                        {
                            ...
                            _actionMessage = "Warning|Unable to delete the Item Issued.";
                            ViewState["actionMessage"] = _actionMessage;
                        }
        ...
        protected void radItemIssued_ItemUpdated(object source, GridUpdatedEventArgs e)
        {
            ...
            else
            {
              //  DisplayMessage("Project updated successfully.");
                _actionMessage = "s|Item updated successfully.";
                ViewState["actionMessage"] = _actionMessage;
            }
        }
        ...
        public void GetEmployeeCPFStatus()
        {

            DataTable dtEmployee = new DataTable();
            string query = string.Format("SELECT PREmployeeFullCPF FROM Employee WHERE emp_code=", Session["EmpCode"].ToString());
            SqlCommand myComm = new SqlCommand(query, new SqlConnection(Session["ConString"].ToString()));
            myComm.Connection.Open();
            SqlDataReader reader=myComm.ExecuteReader();

            dtEmployee.Load(reader);
               //rdbEmployee.DataSource = dtEmployee;
               //rdbEmployee.DataBind();
            
        }
        public void GetEmployerCPFStatus()
        {

            DataTable dtEmployer = new DataTable();
            string query = string.Format("SELECT PREmployerFullCPF FROM Employee WHERE emp_code=", Session["EmpCode"].ToString());
            SqlCommand myComm = new SqlCommand(query, new SqlConnection(Session["ConString"].ToString()));
            myComm.Connection.Open();
            SqlDataReader reader = myComm.ExecuteReader();

            dtEmployer.Load(reader);
            //rdbEmployer.DataSource = dtEmployer;
            //rdbEmployer.DataBind();
        ...
        protected void sendemail()
        {
            ...
            if (emailreq == "yes")
            {
                ...
                try
                {
                    ...
                    {
                        _actionMessage = "Warning|An email has been sent to " + to ;
                        ViewState["actionMessage"] = _actionMessage;
                    }
                    else
                    {
                        _actionMessage = "Warning|An error occurred: Details are as follows <BR />" + sRetVal;
                        ViewState["actionMessage"] = _actionMessage;
                    }
        ...
        //muru
        protected void RadGrid5_InsertCommand(object source, GridCommandEventArgs e)
        {
            strMessage = "";
            string sSQL = "";
            string ecode = txtEmpCodeHdn.Value;
            ...
            string catno = (userControl.FindControl("drpcatname") as DropDownList).SelectedItem.Value;
            string cno = (userControl.FindControl("certificatenumber") as TextBox).Text.ToString();

            DateTime testdate = (DateTime)(userControl.FindControl("TestDate") as RadDatePicker).SelectedDate;
            DateTime issuedate = (DateTime)(userControl.FindControl("IssueDate") as RadDatePicker).SelectedDate;
            DateTime expirydate = (DateTime)(userControl.FindControl("ExpiryDate") as RadDatePicker).SelectedDate;
            string issuelocation = (userControl.FindControl("IssueLocation") as TextBox).Text.ToString();
            string issueby = (userControl.FindControl("IssuedBy") as TextBox).Text.ToString();
            string remarks = (userControl.FindControl("remarks") as TextBox).Text.ToString();


            string filename = (userControl.FindControl("FileUpload1") as FileUpload).FileName.ToString();

            FileUpload UploadFile = (userControl.FindControl("FileUpload1") as FileUpload);
            //validate
            if (cno.ToString().Length <= 0)
            {
            ...
            if (testdate != null && expirydate != null)
            {
            ...
            {
                sSQL = "insert into EmployeeCertificate(Emp_ID,CertificateCategoryID,CertificateNumber,TestDate,IssueDate,ExpiryDate,IssueLocation,IssuedBy,Remarks,filename)values";
                sSQL = sSQL + "(" + ecode + "," + catno + ",'" + cno + "','" + testdate.ToString("dd/MMM/yyyy") + "','" + issuedate.ToString("dd/MMM/yyyy") + "','" + expirydate.ToString("dd/MMM/yyyy") + "','";
                sSQL = sSQL + issuelocation + "','" + issueby + "','" + remarks + "','" + filename + "')";
                int retsuc = DataAccess.ExecuteNonQuery(sSQL, null);

                if (retsuc != 0)
                {
                    string strFileName = "";
                    string objFileName = "";
                    string uploadpath = "../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "certificate";

                    if (UploadFile.FileName.Length != 0)
                    {
                        if (Directory.Exists(Server.MapPath(uploadpath)))
                        {
                            if (File.Exists(Server.MapPath(uploadpath) + "/" + UploadFile.FileName.ToString()))
                            {
                                File.Delete(Server.MapPath(uploadpath) + "/" + UploadFile.FileName.ToString());
                                //objFileName = Server.MapPath(uploadpath) + "/" + file1.UploadedFiles[0].GetName();
                                objFileName = Server.MapPath(uploadpath) + "/" + UploadFile.FileName.ToString();
                                UploadFile.SaveAs(objFileName);
                    ...
                    strMessage = "Success|Certificate Added successfully.";
                ...
                else
                {
                    ...
                    strMessage = "Warning|Certificate Added Not successfully.";
        ...
        protected void RadGrid5_UpdateCommand(object source, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            else
            {
                ...
                if (filename == "")
                {
                    sSQL = "update [EmployeeCertificate] set [CertificateCategoryID]=" + catno + ",[CertificateNumber]='" + cno + "',[TestDate]='" + testdate.ToString("dd/MMM/yyyy") + "',[IssueDate]='" + issuedate.ToString("dd/MMM/yyyy") + "',[ExpiryDate]='" + expirydate.ToString("dd/MMM/yyyy") + "',[IssueLocation]='";
                    sSQL = sSQL + issuelocation + "',[IssuedBy]='" + issueby + "',[Remarks]='" + remarks + "' where id=" + tid;
                }
                else
                {
                    sSQL = "update [EmployeeCertificate] set [CertificateCategoryID]=" + catno + ",[CertificateNumber]='" + cno + "',[TestDate]='" + testdate.ToString("dd/MMM/yyyy") + "',[IssueDate]='" + issuedate.ToString("dd/MMM/yyyy") + "',[ExpiryDate]='" + expirydate.ToString("dd/MMM/yyyy") + "',[IssueLocation]='";
                    sSQL = sSQL + issuelocation + "',[IssuedBy]='" + issueby + "',[Remarks]='" + remarks + "',[filename]='" + filename + "' where id=" + tid;
                ...
                else
                {
                    ...
                    strMessage = "Warning|Certificate Updated Not successfully.";
        ...
        //{
        //    var fileName = "EmployeeProfilePic.jpg";
        //    string uploadpath = "../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "Picture";
        //    string varFileName = Server.MapPath(uploadpath) + "/" + fileName;
        //    string varFileNam = Server.MapPath(uploadpath) + "/" + fileName;
        ...
        //                FileUpload1.SaveAs(varFileNam);
        //                _actionMessage = "Success|Image Updated Successfully.";
        //                ViewState["actionMessage"] = _actionMessage;
        //                string filepath = Server.MapPath("../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "Picture" + "/EmployeeProfilePic.jpg");
        //                string imagepath = "../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "Picture" + "/EmployeeProfilePic.jpg";
        ...
        //            else
        //            {
        //                varFileName = Server.MapPath(uploadpath) + "/" + fileName;
        //                FileUpload1.SaveAs(varFileName);
        //                varFileName = fileName;
        //                _actionMessage = "Success|Image Uploaded Successfully.";
        //                ViewState["actionMessage"] = _actionMessage;
        //                string filepath = Server.MapPath("../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "Picture" + "/EmployeeProfilePic.jpg");
        //                string imagepath = "../" + "Documents" + "/" + compid + "/" + emp_code + "/" + "Picture" + "/EmployeeProfilePic.jpg";
        //                if (File.Exists(filepath))
        ...
        //    else
        //    {
        //        _actionMessage = "Warning|Please Choose File to Update Profile Picture";
        //        ViewState["actionMessage"] = _actionMessage;
