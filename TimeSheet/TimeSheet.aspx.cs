...
namespace SMEPayroll.TimeSheet
{
    public partial class TimeSheet : System.Web.UI.Page
    {
        ...
        private void BindTimeSheetGrid()
        {
            ...
            dt1 =  this.rdEmpPrjStart.SelectedDate.Value;
            dt2 = this.rdEmpPrjEnd.SelectedDate.Value;
             string stremp = this.RadComboBoxEmpPrj.SelectedValue;
            ...
            parms1[3] = new SqlParameter("@empid", stremp);
            parms1[4] = new SqlParameter("@subprojid", Convert.ToString(-1));
            parms1[5] = new SqlParameter("@sessid", "2");
            parms1[6] = new SqlParameter("@REPID", Utility.ToInteger(strRepType));
            parms1[7] = new SqlParameter("@subprojid_name ", "0");
            parms1[8] = new SqlParameter("@NightShift", "N");
            parms1[9] = new SqlParameter("@isEmpty", "NO");
            ds.Clear();
        ...
        void saveNew()
        {
            ...
            foreach (GridItem item in this.RadGrid2.MasterTableView.Items)
            {
                if (item is GridItem)
                {
                    ...
                    string ID = dataItem["PK"].Text.ToString();
                    DataRow[] dr1 = ds1.Tables[0].Select("PK='" + ID + "'");
                ...
                if (item is GridItem)
                {
                    ...
                    if (chkBox1.Checked == true)
                    {
                        ...
                        if (((TextBox)dataItem.FindControl("txtInTime")).Enabled == true)
                        {
                            ...
                            {
                                strInsertData = " INSERT INTO ApprovedTimeSheet(Roster_ID,Time_Card_No,Sub_Project_ID,TimeEntryStart,TimeEntryEnd,NH,OT1,OT2,TotalHrsWrk,SoftDelete,Remarks,Lateness,ack_in,ack_out,ros_in,ros_out) ";
            ...
            if (strInsertDataF.Length > 0)
            {
                ...
                if (recd > 0)
                {
                    ...
                    if (EmailNeed)//if email is required
                    {
                        ...
                        if (ename == "")
                        {
                            string sqlEmailEmp1 = "select e.emp_name + ' ' + e.emp_lname empname from employee e where e.time_card_no='" + strTimecardNo + "'";
            ...
            if (e.CommandName == "AddNew")
            {
                ...
                foreach (GridItem item in this.RadGrid2.MasterTableView.Items)
                {
                    if (item is GridItem)
                    {
                        ...
                        DataRow[] dr1 = dsAdd.Tables[0].Select("PK='" + id + "'");
                ...
                dsAdd.AcceptChanges();
                string strPK = e.Item.Cells[11].Text.ToString();
        ...
        //        strLeaves = strLeaves + " BETWEEN convert(DATETIME,'" + sDate + "',103) AND convert(DATETIME,'" + eDate + "',103) ";
        //        strLeaves = strLeaves + " AND convert(DATETIME,end_date,103) BETWEEN convert(DATETIME,'" + sDate + "',103) AND  convert(DATETIME,'" + eDate + "',103) AND status='Approved' and ed.halfday_leave != 1";
        ...
        //
        protected void appovemail(string strename, string tsemail, int itype)
        {
            string from = "";
            string to = "";
            string SMTPserver = "";
            ...
            while (dr3.Read())
            {
                ...
                to = Utility.ToString(dr3.GetValue(9));
                        ...
                        if (((TextBox)dataItem.FindControl("txtInTime")).Enabled == true)
                        {
                            ...
                            if (strEmail.ToString().Length > 0)
                            {
                                if (strInTime != "" && strOutTime != "")
                                {
                                    ...
                                    body = body.Replace("@tsdate", tsdate);
                                    body = body.Replace("@pname", pname);
                                    body = body.Replace("@strInTime", strInTime);
                                    body = body.Replace("@strOutTime", strOutTime);
            ...
            )
        {
            ...
            if (_roster.RosterType == "FLEXIBLE" && NewR == "Y")
            {
            ...
            if (_roster.RosterType == "FLEXIBLE")
            {
                ...
                if (string.IsNullOrEmpty(earlyin))
                {
                    earlyin = intime;
                    latein = intime;
                }
                ...
                DateTime _outtime = InTime.AddMinutes(_roster.FlexibleWorkinghr);
            ...
            outtimedate = _roster.InTime.AddHours(8).Date.ToString("dd/MM/yyyy");
            Orginalout = enddate;
