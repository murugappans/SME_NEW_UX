<%@ Page Language="C#" AutoEventWireup="true" Codebehind="ManualTimesheetDataEntry_Daily.aspx.cs" Inherits="SMEPayroll.TimeSheet.ManualTimesheetDataEntry_Daily" %>
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnUpdate">
                <UpdatedControls>                                          
                     ...
                     <telerik:AjaxUpdatedControl  ControlID="btnSubApprove" LoadingPanelID="RadAjaxLoadingPanel1" >
                     </telerik:AjaxUpdatedControl> 
                      ...
                      <telerik:AjaxUpdatedControl  ControlID="btnUnlock" LoadingPanelID="RadAjaxLoadingPanel1" >
                     </telerik:AjaxUpdatedControl>
          ...
          <script type="text/javascript" language="javascript">
              ...
              function isNumericKeyStrokeDecimal(evt) {
                  ...
                  return true;
                    ...
                    function ColumnCreated(sender, args) 
                    {
                        var column = args.get_column();
                        switch (column.get_uniqueName()) 
                        {
                            case "V1":
                                var lblV1 = document.getElementById('lblV1');
                                if (lblV1.innerText != '') 
                                {
                                    column.get_element().innerHTML = lblV1.innerText; // "Meal"; //setting new HeaderText
                                }
                                break;
                            case "V2":
                                var lblV2 = document.getElementById('lblV2');
                                if (lblV2.innerText != '') {
                                    column.get_element().innerHTML = lblV2.innerText; // "Meal"; //setting new HeaderText
                                }
                                break;

                            case "V3":
                                var lblV3 = document.getElementById('lblV3');
                                if (lblV3.innerText != '') {
                                    column.get_element().innerHTML = lblV3.innerText; // "Meal"; //setting new HeaderText
                                }
                                break;

                            case "V4":
                                var lblV4 = document.getElementById('lblV4');
                                if (lblV4.innerText != '') {
                                    column.get_element().innerHTML = lblV4.innerText; // "Meal"; //setting new HeaderText
                                }
                                break;
                           ...
                           //alert(document.getElementById("DeftxtOutTime").value);
                            ...
                            if (masterTableView != null) 
                            {
                                 //var gridItems = masterTableView.get_dataItems();
                                  var gridItems = masterTableView.get_selectedItems();  
                                 var i;
                    ...
                    function  Copy()
                    {
                           ...
                           //alert(document.getElementById("DeftxtOutTime").value);
                            ...
                            {  
                                    //alert(1);
                                    var rowInner= selectedRows[j];                                   
                                    var inTimeCell      = masterTableView.getCellByColumnUniqueName(rowInner, "NH");
                                    var outTimeCell     = masterTableView.getCellByColumnUniqueName(rowInner, "OT1");
                                    var outTimeCell1     = masterTableView.getCellByColumnUniqueName(rowInner, "OT2");
                                    ...
                                    else
                                    {
                                        inTimeCell.getElementsByTagName("input")[0].value=document.getElementById("DeftxtInTime").value;
                                        outTimeCell.getElementsByTagName("input")[0].value=document.getElementById("DeftxtOutTime").value;                        
                                        outTimeCell1.getElementsByTagName("input")[0].value=document.getElementById("txtOt2").value;                        
                                    }
                            }
                            Test(1);
                            return false;
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%" border="0">
                        <tr>
                            <td background="../frames/images/toolbar/backs.jpg" >
                                <font class="colheading">&nbsp;&nbsp;&nbsp;<b>Manual Timesheet (Daily)</b></font>
                            </td>
                        </tr>                       
                    </table>
                </td>
                                    ...
                                    <td style="margin-left: 1px;" >
                                        <table >
                                            <tr>
                                                     ...
                                                     <td class="bodytxt" valign="bottom"  align="Left" style="width:0%;visibility:hidden" >
                                                         NightShift 
                                                     </td> 
                                            ...
                                            <tr>
                                                ...
                                                AutoPostBack="true" EmptyMessage="All Employees" HighlightTemplatedItems="true"
                                                ...
                                                <ItemTemplate>
                                                 ...
                                                 <td   class="bodytxt" valign="top" align="left" style="vertical-align:top;visibility:hidden"  >
                    ...
                    <radG:RadCodeBlock ID="RadCodeBlock1" runat="server">
                     ...
                     <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional" >                     
                        ...
                        <MasterTableView  >
                            ...
                            <%--3--%>    
                                <radG:GridBoundColumn DataField="ID"  HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="ID"
                                    Display="false">
                             ...
                             <%--5--%>                                                                 
                               ...
                               <%--8--%>  
                               <radG:GridBoundColumn HeaderText="ProjectID"  DataField="ProjectID" HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="ProjectID" 
                                   Display="false">
                               </radG:GridBoundColumn>   
                               
                               <radG:GridBoundColumn HeaderText="Date"  DataField="SubmitDate"  HeaderStyle-HorizontalAlign="Center" UniqueName="SubmitDate" ItemStyle-Wrap="false"
                                   Display="true">
                                ...
                                <%--15--%> 
                                 ...
                                 <radG:GridBoundColumn HeaderText="NH1"  DataField="NH" HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="NH1" 
                                   Display="false">
                               </radG:GridBoundColumn> 
                               
                                <radG:GridBoundColumn HeaderText="OT11"  DataField="OT1" HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="OT11" 
                                   Display="false">
                               </radG:GridBoundColumn> 
                               
                                <radG:GridBoundColumn HeaderText="OT22"  DataField="OT2" HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="OT22" 
                                   Display="false">
                               </radG:GridBoundColumn> 
                                   
                                 <radG:GridTemplateColumn DataField="NH" UniqueName="NH" HeaderText="Normal Hr" HeaderStyle-HorizontalAlign="Center"
                                    AllowFiltering="false" Groupable="false" >
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.NH")%>' ID="txtNH" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="38px" ValidationGroup="vldSum" />
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtenderIn" runat="server" TargetControlID="txtNH"
                                                Mask="99:99" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError"
                                                MaskType="Time" AcceptAMPM="false" CultureName="en-US" />
                                            <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidatorIn" runat="server" ControlExtender="MaskedEditExtenderIn"
                                                ControlToValidate="txtNH" IsValidEmpty="False" InvalidValueMessage="*" ValidationGroup="vldSum"
                                                Display="Dynamic" />
                                        </div>
                                    </ItemTemplate>
                                ...
                                <radG:GridTemplateColumn DataField="OT1" UniqueName="OT1" HeaderText="OverTime1 Hr" HeaderStyle-HorizontalAlign="Center"
                                    AllowFiltering="false" Groupable="false" >
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OT1")%>' ID="txtOt1" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="38px" ValidationGroup="vldSum" />
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtenderIn1" runat="server" TargetControlID="txtOt1"
                                                Mask="99:99" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError"
                                                MaskType="Time" AcceptAMPM="false" CultureName="en-US" />
                                            <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidatorIn1" runat="server" ControlExtender="MaskedEditExtenderIn1"
                                                ControlToValidate="txtOt1" IsValidEmpty="False" InvalidValueMessage="*" ValidationGroup="vldSum"
                                                Display="Dynamic" />
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                ...
                                <radG:GridTemplateColumn DataField="OT2" UniqueName="OT2" HeaderText="OverrTime2 Hr" HeaderStyle-HorizontalAlign="Center"
                                    AllowFiltering="false" Groupable="false" >
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OT2")%>' ID="txtOT2" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="38px" ValidationGroup="vldSum" />
                                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtenderIn2" runat="server" TargetControlID="txtOT2"
                                                Mask="99:99" MessageValidatorTip="true" OnFocusCssClass="MaskedEditFocus" OnInvalidCssClass="MaskedEditError"
                                                MaskType="Time" AcceptAMPM="false" CultureName="en-US" />
                                            <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidatorIn2" runat="server" ControlExtender="MaskedEditExtenderIn2"
                                                ControlToValidate="txtOT2" IsValidEmpty="False" InvalidValueMessage="*" ValidationGroup="vldSum"
                                                Display="Dynamic" />
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                 ...
                                 <radG:GridTemplateColumn DataField="V1" UniqueName="V1" HeaderText="V1" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <telerik:RadNumericTextBox   runat="server" ValidationGroup="vldSum"  Width="50px" Text='<%# DataBinder.Eval(Container,"DataItem.V1")%>' ID="txtV1" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid">
                               ...
                               <radG:GridTemplateColumn DataField="V2" UniqueName="V2" HeaderText="V2" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <telerik:RadNumericTextBox Text='<%# DataBinder.Eval(Container,"DataItem.V2")%>' ID="txtV2" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="50px" ValidationGroup="vldSum" />                                            
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                    <ItemStyle Width="5%" HorizontalAlign="center" />
                                 ...
                                 <radG:GridTemplateColumn DataField="V3" UniqueName="V3" HeaderText="V3" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <telerik:RadNumericTextBox Text='<%# DataBinder.Eval(Container,"DataItem.V3")%>' ID="txtV3" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="50px" ValidationGroup="vldSum" />                                            
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                ...
                                <radG:GridTemplateColumn DataField="V4" UniqueName="V4" HeaderText="V4" HeaderStyle-HorizontalAlign="Center"
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <telerik:RadNumericTextBox Text='<%# DataBinder.Eval(Container,"DataItem.V4")%>' ID="txtV4" style="border-right: #cccccc 1px solid; table-layout: fixed;border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;border-bottom: #cccccc 1px solid"
                                                runat="server" Width="50px" ValidationGroup="vldSum" />                                            
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                ...
                                <radG:GridBoundColumn DataField="Shift"   HeaderStyle-ForeColor="black"   HeaderStyle-HorizontalAlign="Center" UniqueName="Shift" HeaderText="Shift"
                                    Display="false">
                                </radG:GridBoundColumn>
                                
                                
                                <radG:GridTemplateColumn DataField="Shift" UniqueName="Shift" HeaderText="Shift(Day/Night)" HeaderStyle-HorizontalAlign="Center"
                                    AllowFiltering="false" Groupable="false" >
                                    <ItemTemplate>
                                        <div>
                                             <asp:CheckBox ID="chkDN" runat="server"      CssClass="bodytxt"  Checked="false" />
                                        </div>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="center" />
                                    <ItemStyle Width="5%" HorizontalAlign="center" BackColor=LightSteelBlue />
                                </radG:GridTemplateColumn>
                                <radG:GridBoundColumn DataField="Status"   HeaderStyle-ForeColor="black"   HeaderStyle-HorizontalAlign="Center" UniqueName="Status" HeaderText="Status"
                                    Display="false">
                                    
                                </radG:GridBoundColumn>                              
                                <radG:GridBoundColumn DataField="time_card_no"   HeaderStyle-ForeColor="black"   HeaderStyle-HorizontalAlign="Center" UniqueName="time_card_no" HeaderText="time_card_no"
                                    Display="false">
                                </radG:GridBoundColumn>
                                
                                <radG:GridBoundColumn DataField="checked"  HeaderStyle-ForeColor="black"  HeaderStyle-HorizontalAlign="Center" UniqueName="checked"
                                    Display="False">
                                </radG:GridBoundColumn>
                            </Columns>
                        </MasterTableView>
                            ...
                            <ClientSettings>
                                <Selecting AllowRowSelect="true" />
                                    ...
                                    <ClientEvents OnGridCreated="GridCreated" OnColumnCreated="ColumnCreated" OnRowClick="RowClick" OnRowSelected="RowDblClick"   ></ClientEvents>
                                    <Selecting AllowRowSelect="true" /> 
                            </ClientSettings>
                        </radG:RadGrid>                    
                    </ContentTemplate>   
