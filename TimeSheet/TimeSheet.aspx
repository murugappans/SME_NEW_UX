<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimeSheet.aspx.cs" Inherits="SMEPayroll.TimeSheet.TimeSheet" %>
            ...
            function openWindow(value)
    {
      ...
      window.open(url);
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" class="bodytxt" style="vertical-align: middle">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:ImageButton ID="imgbtnfetchEmpPrj" OnClick="bindgrid"
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td colspan="4" valign="top" align="left">
                                            <table align="center" style="border-style: outset; border-color: blue; border-collapse: separate;
                                                border-top-width: 0px" border="1">
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btncalculate" runat="server" Visible="true" OnClientClick="GridCreated()"
                                                            Text="Calculate" />
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="btnSubApprove" runat="server" Visible="false" Enabled="false" Text="Submit/Approve" />
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnUnlock" runat="server" Visible="true" Text="Unlock" />
                                                    </td>
                                                    <td>
                                                        <asp:Button ID="btnDelete" runat="server" Visible="true" OnClick="btnDelete_Click"
                                                            Text="Delete" />
                                                    </td>
                                                </tr>
                                            </table>
            ...
            <tr>
                <td>
                    <table width="100%" style="border-style: groove; border-color: blue; border-collapse: separate;"
                        border="1">
                    </table>
                </td>
            </tr>
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                        <ContentTemplate>
                            <radG:RadGrid ID="RadGrid2" runat="server" OnItemDataBound="RadGrid2_ItemDataBound"
                                Width="90%" AllowFilteringByColumn="false" AllowSorting="true" Skin="Outlook"
                                ...
                                <MasterTableView>
                                    ...
                                    Display="false">
                                     <ItemStyle HorizontalAlign="Center"  Width="0%" />
                                        ...
                                        <%--3--%>
                                        <radG:GridBoundColumn DataField="ID" HeaderStyle-ForeColor="black" HeaderStyle-HorizontalAlign="Center"
                                  ...
                                  <ItemTemplate >  
                                      <asp:DropDownList  ID="drpEmp" Width="100%"  runat="server" CssClass="bodytxt" >
                                        ...
                                        <radG:GridTemplateColumn HeaderText="Date|Employee Name" HeaderStyle-HorizontalAlign="Center"
                                            UniqueName="Employee" ItemStyle-Wrap="false" Display="false">
                                            <ItemTemplate>
                                        ...
                                        <radG:GridTemplateColumn HeaderText="Project Name" HeaderStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <asp:DropDownList ID="drpProject" Width="100%" runat="server" CssClass="bodytxt"
                                                    Style="border-right: #cccccc 1px solid; table-layout: fixed; border-top: #cccccc 1px solid;
                                        ...
                                        <radG:GridTemplateColumn HeaderText="Start Date" HeaderStyle-HorizontalAlign="Center"
                                            UniqueName="SD">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="drpSD" runat="server" CssClass="bodytxt" Style="border-right: #cccccc 1px solid;
                                                    table-layout: fixed; border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;
                                        ...
                                        <radG:GridTemplateColumn HeaderText="End Date" HeaderStyle-HorizontalAlign="Center"
                                            UniqueName="ED">
                                            <ItemTemplate>
                                                <asp:DropDownList ID="drpED" runat="server" CssClass="bodytxt" Style="border-right: #cccccc 1px solid;
                                                    table-layout: fixed; border-top: #cccccc 1px solid; border-left: #cccccc 1px solid;
                                                    border-bottom: #cccccc 1px solid">
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        ...
                                        <radG:GridBoundColumn DataField="Time_card_no" HeaderStyle-ForeColor="black" HeaderStyle-HorizontalAlign="Center"
                                            UniqueName="Time_card_no" Display="false">
                                        </radG:GridBoundColumn>
                                        <%--11--%>
                                        ...
                                        <%--12--%>
                                        <radG:GridBoundColumn DataField="Tsdate" HeaderStyle-ForeColor="black" HeaderStyle-HorizontalAlign="Center" HeaderText="Date"
                                            UniqueName="Tsdate" Display="True">
                                        </radG:GridBoundColumn>
                                        <%--13--%>
                                            ...
                                            <ItemTemplate>
                                                <div>
                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.InShortTime")%>' ID="txtInTime"
                                                        Style="border-right: #cccccc 1px solid; table-layout: fixed; border-top: #cccccc 1px solid;
                                                        border-left: #cccccc 1px solid; border-bottom: #cccccc 1px solid" runat="server"
                                                        Width="38px" ValidationGroup="vldSum" />
                                            ...
                                            <ItemTemplate>
                                                <div>
                                                    <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.BreakTimeNH")%>' ID="txtBTNH"
                                                        AutoPostBack="true" OnTextChanged="ChangeBT" runat="server" Width="20px" />
                                                </div>
                                            </ItemTemplate>
                                        </radG:GridTemplateColumn>
