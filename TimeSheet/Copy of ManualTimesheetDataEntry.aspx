<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="~/TimeSheet/Copy of ManualTimesheetDataEntry.aspx" Inherits="SMEPayroll.TimeSheet.GManualTimesheetDataEntry" %>
                        ...
                        if(chkbox==false)
                        {
                            ...
                            {        
                                ...
                                { 
                                    ...
                                    var 
                                    _I          =  cell_ED_In.getElementsByTagName("SELECT")[0].value + ' ' + outTimeCell_In.getElementsByTagName("input")[0].value;
                                ...
                                <div class="form-inline col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <radG:RadComboBox ID="RadComboBoxEmpPrj" runat="server" BorderWidth="0px"
                                            ...
                                            <HeaderTemplate>
                                                <table class="bodytxt" cellspacing="0" cellpadding="0" style="width: 100%">
                                                    <tr>
                                    ...
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <asp:ImageButton ID="imgbtnfetchEmpPrj" CssClass="btn" OnClick="bindgrid" runat="server" ImageUrl="~/frames/images/toolbar/go.ico" />
                                    </div>
                                    <div class="form-group">
                                        <label>In Time</label>
                                        <asp:TextBox Visible="True" Text='' ID="DeftxtInTime" runat="server" CssClass="form-control input-sm input-xsmall"
                                            ValidationGroup="vldSum" />
                                    </div>
                                    <div class="form-group">
                                        <label>Out Time</label>
                                        <asp:TextBox Visible="True" Text='' ID="DeftxtOutTime" runat="server" CssClass="form-control input-sm input-xsmall"
                                            ValidationGroup="vldSum" />
                                    </div>
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                    ...
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <asp:Button ID="btncalculate" CssClass="btn btn-sm default" runat="server" Visible="true" OnClientClick="Calculate()" Text="Calculate" />
                                        <asp:Button ID="btnUpdate" CssClass="btn btn-sm default" runat="server" Text="Submit" OnClick="btnUpdate_Click" Enabled="true" />
                                        <asp:Button ID="btnApprove" CssClass="btn btn-sm default" runat="server" OnClick="btnApprove_Click" Text="Approve" />
                                        <asp:Button ID="btnSubApprove" CssClass="btn btn-sm default" runat="server" Visible="false" Enabled="false" Text="Submit/Approve" />
                                        <asp:Button ID="btnUnlock" CssClass="btn btn-sm default" runat="server" Visible="true" Text="Unlock" />
                                        <asp:Button ID="btnDelete" CssClass="btn btn-sm default" runat="server" Visible="true" OnClick="btnDelete_Click" Text="Delete" />
                                    </div>
                                </div>
                                  ...
                                  <ItemTemplate >  
                                      <asp:DropDownList  ID="drpEmp" Width="100%"  runat="server" CssClass="bodytxt" >
                                                ...
                                                <radG:GridTemplateColumn HeaderText="Project Name" HeaderStyle-HorizontalAlign="Center" UniqueName="Project">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="drpProject" runat="server" CssClass="form-control input-sm input-small">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </radG:GridTemplateColumn>
                                                ...
                                                <radG:GridTemplateColumn HeaderText="Start Date" HeaderStyle-HorizontalAlign="Center" UniqueName="SD">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="drpSD" runat="server" CssClass="form-control input-sm input-small">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </radG:GridTemplateColumn>
                                                ...
                                                <radG:GridTemplateColumn HeaderText="End Date" HeaderStyle-HorizontalAlign="Center" UniqueName="ED">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="drpED" runat="server" CssClass="form-control input-sm input-small">
                                                        </asp:DropDownList>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </radG:GridTemplateColumn>
                                                ...
                                                <radG:GridTemplateColumn DataField="InShortTime" UniqueName="InShortTime" HeaderText="In Time" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.InShortTime")%>' ID="txtInTime" CssClass="form-control input-sm input-xsmall"
                                                ...
                                                <radG:GridTemplateColumn DataField="OutShortTime" UniqueName="OutShortTime" HeaderText="Out Time" HeaderStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" HeaderStyle-Wrap="false"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OutShortTime")%>' ID="txtOutTime" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" ValidationGroup="vldSum" />
                                                ...
                                                <radG:GridBoundColumn DataField="NHA" DataType="System.Decimal" HeaderStyle-HorizontalAlign="Center" UniqueName="NHA" HeaderText="NH" FooterStyle-HorizontalAlign="Center"
                                                    ...
                                                    Display="True">
                                                    <ItemStyle HorizontalAlign="center" Font-Size="Small" BackColor="LightSteelBlue" />
                                                </radG:GridBoundColumn>
                                                ...
                                                <radG:GridTemplateColumn DataField="NHAT" DataType="System.string" HeaderStyle-HorizontalAlign="Center" UniqueName="NHAT" HeaderText="NHAT"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.NHAT")%>' ID="NHAT" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                ...
                                                <radG:GridTemplateColumn DataField="OT1AT" DataType="System.string" HeaderStyle-HorizontalAlign="Center" UniqueName="OT1AT" HeaderText="OT1T"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OT1AT")%>' ID="OT1AT" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                ...
                                                <radG:GridTemplateColumn DataField="OT2AT" DataType="System.string" HeaderStyle-HorizontalAlign="Center" UniqueName="OT2AT" HeaderText="OT2T"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.OT2AT")%>' ID="OT2AT" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                ...
                                                <radG:GridTemplateColumn DataField="TotalAT" HeaderStyle-ForeColor="black" DataType="System.string" HeaderStyle-HorizontalAlign="Center" UniqueName="TotalAT" HeaderText="TotalT"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.TotalAT")%>' ID="TotalAT" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                ...
                                                <radG:GridTemplateColumn Display="true" UniqueName="BreakTimeNH1" HeaderText="BTNH" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.BreakTimeNH")%>' ID="txtBTNH" CssClass="form-control input-sm input-xsmall" AutoPostBack="true" OnTextChanged="ChangeBT"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                </radG:GridTemplateColumn>
                                    ...
                                    Display="True">
                                                ...
                                                <radG:GridTemplateColumn Display="false" DataField="NHWHREM" UniqueName="NHWHREM" HeaderText="NHWHREM" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.NHWHREM")%>' ID="txtNHWHREM" CssClass="form-control input-sm input-xsmall"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                </radG:GridTemplateColumn>
                                                ...
                                                <radG:GridTemplateColumn Display="true" UniqueName="BreakTimeOt" HeaderText="BKOT" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <div>
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.BKOT1")%>' ID="txtBTOT" CssClass="form-control input-sm input-xsmall" AutoPostBack="true" OnTextChanged="ChangeBT"
                                                                runat="server" />
                                                        </div>
                                                    </ItemTemplate>
                                                </radG:GridTemplateColumn>
                                                    ...
                                                    <ItemTemplate>
                                                        <div align="justify" class="bodytxt">
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.Remarks")%>' ID="txtReamrks"
                                                                runat="server" CssClass="form-control input-sm input-small" TextMode="MultiLine" Height="30px" />
                                                        </div>
                                                    </ItemTemplate>
                                                </radG:GridTemplateColumn>
                                                ...
                                                <radG:GridTemplateColumn Display="false" DataField="NHWHM" UniqueName="NHWHM1" HeaderText="NHWHM1" HeaderStyle-HorizontalAlign="Center"
                                                    ...
                                                    <ItemTemplate>
                                                        <div align="justify" class="bodytxt">
                                                            <asp:TextBox Text='<%# DataBinder.Eval(Container,"DataItem.NHWHM")%>' ID="txtNHWHM" CssClass="form-control input-sm input-xsmall"
...
<uc_js:bundle_js ID="bundle_js" runat="server" />
    ...
    <script type="text/javascript">
        ...
        $(".RadPicker.RadPicker_Default, .rcTable, .rcInputCell").removeAttr("style");
